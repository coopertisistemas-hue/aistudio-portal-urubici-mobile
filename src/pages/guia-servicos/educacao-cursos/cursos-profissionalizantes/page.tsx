...
const FEATURED_ADS = [
  {
    title: "SENAI Urubici",
    subtitle: "Cursos técnicos e profissionalizantes de qualidade",
    image: "https://readdy.ai/api/search-image?query=Modern%20vocational%20training%20center%20in%20Urubici%20Santa%20Catarina%20Brazil%20with%20professional%20courses%2C%20technical%20education%2C%20students%20learning%20skills%20in%20mountain%20town%20setting&width=300&height=200&seq=course1&orientation=landscape",
    link: "#",
    isAd: true
  },
  {
    title: "Escola de Idiomas Serra",
    subtitle: "Aprenda inglês, espanhol e mais idiomas",
    image: "https://readdy.ai/api/search-image?query=Language%20school%20in%20Urubici%20Santa%20Catarina%20Brazil%20with%20students%20learning%20foreign%20languages%2C%20modern%20classroom%2C%20interactive%20education%20in%20mountain%20region&width=300&height=200&seq=course2&orientation=landscape",
    link: "#",
    isAd: true
  }
];
        ...
        <div className="px-4 mb-6">
          <div className="text-center">
            <h2 className="text-white font-bold text-xl mb-2 flex items-center justify-center gap-2">
              <i className="ri-graduation-cap-line text-purple-400" />
              Cursos Profissionalizantes
              <i className="ri-graduation-cap-line text-purple-400" />
            </h2>
            <p className="text-white/70 text-sm">Qualifique-se e conquiste novas oportunidades em Urubici</p>
          </div>
        </div>
        ...
        <div className="px-4 mb-6">
          {loading ? (
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg text-center mb-4">
              <i className="ri-information-line text-purple-400 text-4xl mb-3" />
              <h4 className="text-white font-bold text-lg mb-2">Ainda não há estabelecimentos cadastrados</h4>
              <p className="text-white/80 text-sm leading-relaxed">
                Estamos atualizando nossa base de dados. Em breve você encontrará os melhores cursos profissionalizantes de Urubici aqui!
              </p>
            </div>
          ) : (
            <>
