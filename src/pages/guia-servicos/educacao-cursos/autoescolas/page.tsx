...
const FEATURED_ADS = [
  {
    title: "Auto Escola Urubici",
    subtitle: "Sua habilitação com segurança e qualidade",
    image: "https://readdy.ai/api/search-image?query=Modern%20driving%20school%20in%20Urubici%20Santa%20Catarina%20Brazil%20with%20professional%20instructors%2C%20quality%20vehicles%20and%20safe%20learning%20environment%20in%20mountain%20town&width=300&height=200&seq=autoescola1&orientation=landscape",
    link: "#",
    isAd: true
  },
  {
    title: "CFC Serra Catarinense",
    subtitle: "Aprenda a dirigir com os melhores profissionais",
    image: "https://readdy.ai/api/search-image?query=Professional%20driving%20school%20center%20in%20Urubici%20Santa%20Catarina%20Brazil%20with%20modern%20facilities%2C%20training%20vehicles%20and%20certified%20instructors%20in%20mountain%20region&width=300&height=200&seq=autoescola2&orientation=landscape",
    link: "#",
    isAd: true
  }
];
        ...
        <div className="px-4 mb-6">
          <div className="text-center">
            <h2 className="text-white font-bold text-xl mb-2 flex items-center justify-center gap-2">
              <i className="ri-steering-2-line text-blue-400" />
              Autoescolas em Urubici
              <i className="ri-steering-2-line text-blue-400" />
            </h2>
            <p className="text-white/70 text-sm">Tire sua habilitação com segurança e qualidade</p>
          </div>
        </div>
        ...
        <div className="px-4 mb-6">
          {loading ? (
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg text-center mb-4">
              <i className="ri-information-line text-blue-400 text-4xl mb-3" />
              <h4 className="text-white font-bold text-lg mb-2">Ainda não há estabelecimentos cadastrados</h4>
              <p className="text-white/80 text-sm leading-relaxed">
                Estamos atualizando nossa base de dados. Em breve você encontrará as melhores autoescolas de Urubici aqui!
              </p>
            </div>
          ) : (
            <>
