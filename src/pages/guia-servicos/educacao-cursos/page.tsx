...
export default function EducacaoCursos() {
  ...
  const featuredAds = [
    {
      title: "Escola de Idiomas Urubici",
      subtitle: "Inglês, Espanhol e Alemão",
      image: "https://readdy.ai/api/search-image?query=Modern%20language%20school%20classroom%20in%20Urubici%20Santa%20Catarina%20Brazil%2C%20educational%20facility%20with%20students%20learning%20languages%2C%20professional%20teaching%20environment%20with%20mountain%20town%20setting&width=300&height=200&seq=lang1&orientation=landscape",
      link: "#",
      isAd: true
    },
    {
      title: "Autoescola Serra",
      subtitle: "Habilitação categoria A e B",
      image: "https://readdy.ai/api/search-image?query=Professional%20driving%20school%20building%20in%20Urubici%20Santa%20Catarina%20Brazil%2C%20autoescola%20facility%20with%20training%20vehicles%2C%20driver%20education%20center%20with%20mountain%20background&width=300&height=200&seq=drive1&orientation=landscape",
      link: "#",
      isAd: true
    },
    {
      ...
      image: "https://readdy.ai/api/search-image?query=Professional%20training%20center%20classroom%20in%20Urubici%20Santa%20Catarina%20Brazil%2C%20vocational%20education%20facility%2C%20technical%20courses%20learning%20environment%20with%20modern%20equipment&width=300&height=200&seq=prof1&orientation=landscape",
      link: "#",
      isAd: true
    }
  ];
  ...
  const subcategories = [
    {
      title: "Escolas de Idiomas e Profissionalizantes",
      description: "Cursos livres, escolas de idiomas e formação profissional.",
      icon: "ri-book-open-line",
      color: "cyan",
      link: "/guia-servicos/educacao-cursos/cursos-profissionalizantes"
    },
    {
      title: "Autoescolas e Cursos de Trânsito",
      description: "Centros de formação de condutores e aulas teóricas e práticas.",
      icon: "ri-steering-2-line",
      color: "cyan",
      link: "/guia-servicos/educacao-cursos/autoescolas"
    }
  ];
      ...
      <div className="relative z-10 max-w-md mx-auto">
        ...
        <div className="px-4 mb-6">
          <div className="text-center">
            <h2 className="text-white font-bold text-xl mb-2 flex items-center justify-center gap-2">
              <i className="ri-book-open-line text-violet-400"></i>
              Educação & Cursos
              <i className="ri-book-open-line text-violet-400"></i>
            </h2>
            <p className="text-white/70 text-sm">Cursos profissionalizantes e autoescolas em Urubici.</p>
          </div>
        </div>
        ...
        <div className="px-4 mb-6">
          <div className="mb-4">
            ...
            <p className="text-white/70 text-xs text-center mt-1">Explore as opções de educação e capacitação</p>
          </div>
        ...
        <div className="px-4 mb-6">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg">
            ...
            <p className="text-white/90 text-sm leading-relaxed text-center mb-4">
              Aqui você encontrará todas as oportunidades de estudo, capacitação e formação disponíveis em Urubici. 
              Desde escolas de idiomas e cursos profissionalizantes até autoescolas e centros de formação de condutores.
            </p>
            <p className="text-white/80 text-sm leading-relaxed text-center mb-4">
              Em breve, esta página apresentará uma lista completa de todas as instituições de ensino e cursos da cidade, 
              com informações de contato, horários e programas oferecidos.
            </p>
