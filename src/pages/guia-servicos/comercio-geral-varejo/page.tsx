...
export default function ComercioGeralVarejo() {
  ...
  const featuredAds = [
    {
      ...
      image: "https://readdy.ai/api/search-image?query=Modern%20supermarket%20grocery%20store%20exterior%20building%20in%20Urubici%20Santa%20Catarina%20Brazil%2C%20retail%20market%20facility%2C%20commercial%20shopping%20center%20with%20mountain%20background&width=300&height=200&seq=super1&orientation=landscape",
      link: "#",
      isAd: true
    },
    {
      title: "Loja de Roupas Serra",
      subtitle: "Moda para o frio da serra",
      image: "https://readdy.ai/api/search-image?query=Clothing%20store%20boutique%20exterior%20in%20Urubici%20Santa%20Catarina%20Brazil%2C%20fashion%20retail%20shop%2C%20winter%20clothing%20store%20with%20mountain%20town%20setting&width=300&height=200&seq=clothes1&orientation=landscape",
      link: "#",
      isAd: true
    },
    {
      title: "Artesanato Urubici",
      subtitle: "Lembranças e produtos regionais",
      image: "https://readdy.ai/api/search-image?query=Artisan%20craft%20shop%20souvenir%20store%20in%20Urubici%20Santa%20Catarina%20Brazil%2C%20handicraft%20retail%20store%2C%20regional%20products%20shop%20with%20rustic%20charm&width=300&height=200&seq=craft1&orientation=landscape",
      link: "#",
      isAd: true
    }
  ];
  ...
  const subcategories = [
    {
      ...
      description: "Locais para compra de alimentos, produtos básicos e itens de primeira necessidade.",
      icon: "ri-shopping-basket-line",
      color: "cyan",
      link: "/guia-servicos/comercio-geral-varejo/supermercados-mercearias"
    },
    {
      title: "Lojas de Roupas e Calçados",
      description: "Vestuário, calçados e acessórios para o dia a dia e para o frio da serra.",
      icon: "ri-shirt-line",
      color: "cyan",
      link: "/guia-servicos/comercio-geral-varejo/lojas-roupas-calcados"
    },
    {
      title: "Artesanato e Souvenirs",
      description: "Lojas de presentes, lembranças de Urubici e produtos regionais.",
      icon: "ri-gift-line",
      color: "cyan",
      link: "/guia-servicos/comercio-geral-varejo/artesanato-souvenirs"
    },
    {
      title: "Material de Construção e Casa",
      description: "Materiais de reforma, ferramentas, móveis e utilidades para o lar.",
      icon: "ri-hammer-line",
      color: "cyan",
      link: "/guia-servicos/comercio-geral-varejo/material-casa"
    }
  ];
      ...
      <div className="relative z-10 max-w-md mx-auto">
        ...
        <div className="px-4 mb-6">
          <div className="text-center">
            <h2 className="text-white font-bold text-xl mb-2 flex items-center justify-center gap-2">
              ...
              Comércio Geral & Varejo
              <i className="ri-shopping-cart-line text-emerald-400"></i>
            </h2>
            <p className="text-white/70 text-sm">Supermercados, lojas de roupas, artesanato e materiais para casa em Urubici.</p>
          </div>
        </div>
        ...
        <div className="px-4 mb-6">
          <div className="mb-4">
            ...
            <p className="text-white/70 text-xs text-center mt-1">Explore os diferentes tipos de comércio</p>
          </div>
        ...
        <div className="px-4 mb-6">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg">
            ...
            <p className="text-white/90 text-sm leading-relaxed text-center mb-4">
              Aqui você encontrará todos os estabelecimentos comerciais de Urubici organizados por tipo. 
              Desde supermercados e mercearias até lojas especializadas em artesanato e materiais de construção.
            </p>
            <p className="text-white/80 text-sm leading-relaxed text-center mb-4">
              Em breve, esta página apresentará uma lista completa de todos os comércios da cidade, 
              com informações de contato, horários de funcionamento e localização.
            </p>
