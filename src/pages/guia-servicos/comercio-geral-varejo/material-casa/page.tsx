...
const FEATURED_ADS = [
  {
    title: "Casa & Construção Urubici",
    subtitle: "Tudo para sua obra e reforma",
    image: "https://readdy.ai/api/search-image?query=Modern%20hardware%20store%20in%20Urubici%20Santa%20Catarina%20Brazil%20with%20construction%20materials%2C%20tools%2C%20organized%20shelves%20and%20quality%20products%20in%20mountain%20town%20setting&width=300&height=200&seq=hardware1&orientation=landscape",
    link: "#",
    isAd: true
  },
  {
    title: "Materiais da Serra",
    subtitle: "Qualidade e variedade em materiais de construção",
    image: "https://readdy.ai/api/search-image?query=Local%20building%20materials%20store%20in%20Urubici%20Santa%20Catarina%20Brazil%20with%20cement%2C%20paint%2C%20tools%2C%20quality%20construction%20products%20in%20mountain%20region&width=300&height=200&seq=hardware2&orientation=landscape",
    link: "#",
    isAd: true
  }
];
...
export default function MaterialCasa() {
        ...
        <div className="px-4 mb-6">
          <div className="text-center">
            <h2 className="text-white font-bold text-xl mb-2 flex items-center justify-center gap-2">
              <i className="ri-hammer-line text-amber-400" />
              Materiais de Construção e Casa
              <i className="ri-hammer-line text-amber-400" />
            </h2>
            <p className="text-white/70 text-sm">Tudo para sua obra e reforma em Urubici</p>
          </div>
        </div>
          ...
          {loading ? (
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg text-center mb-4">
              ...
              <p className="text-white/80 text-sm leading-relaxed">
                Estamos atualizando nossa base de dados. Em breve você encontrará as melhores lojas de materiais de construção de Urubici aqui!
              </p>
            </div>
          ) : (
            <>
