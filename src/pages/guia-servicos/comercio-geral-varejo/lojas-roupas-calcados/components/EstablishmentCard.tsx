      ...
      <div className="flex gap-4">
        <div className="w-20 h-20 rounded-xl overflow-hidden bg-white/20 flex-shrink-0">
          <img
            ...
            src={`https://readdy.ai/api/search-image?query=$%7BencodeURIComponent%28%60$%7Bestablishment.name%7D%20clothing%20shoes%20store%20in%20Urubici%20Santa%20Catarina%20Brazil%20with%20fashion%20apparel%20and%20quality%20products%60%29%7D&width=200&height=200&seq=${establishment.id}&orientation=squarish`}
          />
        </div>
        ...
        <div className="flex-1">
          <div className="flex items-start justify-between mb-2">
            ...
            <div className="flex flex-col gap-1.5 items-end ml-2">
              ...
              <div className="bg-teal-500/20 text-teal-200 border-teal-400/30 px-2 py-1 rounded-full text-xs font-medium whitespace-nowrap">
                {groupName && groupName.length > 0 ? groupName.slice(0, -1) : 'Loja'}
              </div>
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <button
              disabled
              className="col-span-2 inline-flex items-center justify-center gap-2 px-3 py-2.5 bg-indigo-600/50 cursor-not-allowed rounded-lg text-white text-xs font-medium opacity-50 whitespace-nowrap min-h-[44px]"
              title="Em breve"
            >
