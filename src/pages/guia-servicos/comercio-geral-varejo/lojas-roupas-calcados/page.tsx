...
const FEATURED_ADS = [
  {
    title: "Moda Serra Urubici",
    subtitle: "Estilo e conforto para toda a família",
    image: "https://readdy.ai/api/search-image?query=Modern%20clothing%20store%20in%20Urubici%20Santa%20Catarina%20Brazil%20with%20winter%20fashion%2C%20casual%20wear%2C%20organized%20displays%20and%20quality%20apparel%20in%20mountain%20town%20setting&width=300&height=200&seq=clothing1&orientation=landscape",
    link: "#",
    isAd: true
  },
  {
    title: "Calçados da Montanha",
    subtitle: "Conforto e qualidade para seus pés",
    image: "https://readdy.ai/api/search-image?query=Shoe%20store%20in%20Urubici%20Santa%20Catarina%20Brazil%20with%20boots%2C%20sneakers%2C%20winter%20footwear%20and%20quality%20shoes%20in%20mountain%20region%20setting&width=300&height=200&seq=clothing2&orientation=landscape",
    link: "#",
    isAd: true
  }
];
...
export default function LojasRoupasCalcados() {
        ...
        <div className="px-4 mb-6">
          <div className="text-center">
            <h2 className="text-white font-bold text-xl mb-2 flex items-center justify-center gap-2">
              <i className="ri-shopping-bag-3-line text-teal-400" />
              Lojas de Roupas e Calçados
              <i className="ri-shopping-bag-3-line text-teal-400" />
            </h2>
            <p className="text-white/70 text-sm">Encontre lojas de roupas, calçados e acessórios em Urubici para se vestir com conforto e estilo na Serra Catarinense</p>
          </div>
        </div>
          ...
          {loading ? (
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg text-center mb-4">
              ...
              <p className="text-white/80 text-sm leading-relaxed">
                Estamos atualizando nossa base de dados. Em breve você encontrará as melhores lojas de roupas e calçados de Urubici aqui!
              </p>
            </div>
          ) : (
            <>
