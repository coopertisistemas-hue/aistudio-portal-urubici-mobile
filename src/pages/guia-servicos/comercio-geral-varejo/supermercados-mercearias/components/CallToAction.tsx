    ...
    <div className="px-4 mb-8">
      <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg text-center">
        <div className="mb-4">
          ...
          <h3 className="text-white font-bold text-lg mb-2">Cadastre seu Supermercado ou Mercearia</h3>
          <p className="text-white/80 text-sm leading-relaxed mb-4">
            Você possui um supermercado ou mercearia em Urubici? Cadastre-se gratuitamente em nossa plataforma e alcance mais clientes!
          </p>
        </div>
