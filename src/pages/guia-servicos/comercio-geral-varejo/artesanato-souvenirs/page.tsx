...
const FEATURED_ADS = [
  {
    title: "Ateliê Arte da Serra",
    subtitle: "Artesanato autêntico de Urubici",
    image: "https://readdy.ai/api/search-image?query=Artisan%20workshop%20in%20Urubici%20Santa%20Catarina%20Brazil%20with%20handmade%20crafts%2C%20local%20souvenirs%2C%20authentic%20mountain%20region%20products%20and%20traditional%20craftsmanship&width=300&height=200&seq=artesanato1&orientation=landscape",
    link: "#",
    isAd: true
  },
  {
    title: "Galeria Souvenirs da Montanha",
    subtitle: "Lembranças especiais de Urubici",
    image: "https://readdy.ai/api/search-image?query=Souvenir%20shop%20in%20Urubici%20Santa%20Catarina%20Brazil%20with%20local%20crafts%2C%20mountain%20gifts%2C%20handmade%20products%20and%20regional%20souvenirs%20in%20cozy%20store%20setting&width=300&height=200&seq=artesanato2&orientation=landscape",
    link: "#",
    isAd: true
  }
];
...
export default function ArtesanatoSouvenirs() {
        ...
        <div className="px-4 mb-6">
          <div className="text-center">
            <h2 className="text-white font-bold text-xl mb-2 flex items-center justify-center gap-2">
              <i className="ri-palette-line text-amber-400" />
              Artesanato e Souvenirs
              <i className="ri-palette-line text-amber-400" />
            </h2>
            <p className="text-white/70 text-sm">Lembranças autênticas e artesanato local de Urubici</p>
          </div>
        </div>
          ...
          {loading ? (
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg text-center mb-4">
              ...
              <p className="text-white/80 text-sm leading-relaxed">
                Estamos atualizando nossa base de dados. Em breve você encontrará os melhores ateliês e lojas de artesanato de Urubici aqui!
              </p>
            </div>
          ) : (
            <>
