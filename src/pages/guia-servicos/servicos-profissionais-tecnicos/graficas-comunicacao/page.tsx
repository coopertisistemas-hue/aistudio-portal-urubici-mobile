...
export default function GraficasComunicacaoPage() {
  ...
  const establishments = [
    {
      name: "Gráfica Rápida Serra",
      description: "Impressão digital, cópias, encadernação, cartões de visita e materiais gráficos",
      address: "Rua Adolfo Konder, 345 - Centro",
      city: "Urubici – SC",
      phone: "(49) 3278-4321",
      whatsapp: "5549932784321"
    },
    {
      name: "Comunicação Visual Urubici",
      description: "Banners, faixas, adesivos, placas e sinalização para empresas e eventos",
      address: "Av. Nereu Ramos, 678 - Centro",
      city: "Urubici – SC",
      phone: "(49) 3278-8765",
      whatsapp: "5549932788765"
    },
    {
      name: "Copy Center Montanha",
      description: "Cópias coloridas e preto e branco, impressão de documentos e plastificação",
      address: "Rua São Joaquim, 234 - São Pedro",
      city: "Urubici – SC",
      phone: "(49) 3278-2109",
      whatsapp: "5549932782109"
    },
    {
      name: "Gráfica & Design Serra Azul",
      description: "Criação de artes gráficas, impressão offset e digital, materiais promocionais",
      address: "Rua Hercílio Luz, 567 - Centro",
      city: "Urubici – SC",
      phone: "(49) 3278-6543",
      whatsapp: "5549932786543"
    },
    {
      name: "Visual Print Urubici",
      description: "Impressão de grande formato, lonas, painéis e comunicação visual para fachadas",
      address: "Rua das Flores, 890 - Santa Terezinha",
      city: "Urubici – SC",
      phone: "(49) 3278-3210",
      whatsapp: "5549932783210"
    },
    {
      name: "Gráfica Express",
      description: "Serviços gráficos rápidos, convites, folders, panfletos e cartazes",
      address: "Av. Aristiliano Ramos, 432 - Centro",
      city: "Urubici – SC",
      phone: "(49) 3278-7654",
      whatsapp: "5549932787654"
    },
    {
      name: "Adesivos & Plotagem Serra",
      description: "Adesivos personalizados, envelopamento de veículos e plotagem de vitrines",
      address: "Rua Getúlio Vargas, 765 - Centro",
      city: "Urubici – SC",
      phone: "(49) 3278-1098",
      whatsapp: "5549932781098"
    },
    {
      name: "Gráfica Digital Urubici",
      description: "Impressão digital de alta qualidade, brindes personalizados e materiais corporativos",
      address: "Rua Tiradentes, 123 - São Pedro",
      city: "Urubici – SC",
      phone: "(49) 3278-5432",
      whatsapp: "5549932785432"
    }
  ];
    ...
    <div className="min-h-screen bg-black text-white">
        ...
        <div className="relative z-20 h-full flex flex-col justify-center max-w-md mx-auto px-4">
          <div className="flex items-center gap-3 mb-2">
            <div className="w-10 h-10 rounded-full bg-orange-500/20 backdrop-blur-sm flex items-center justify-center border border-orange-400/30">
              <i className="ri-printer-line text-xl text-orange-400"></i>
            </div>
            <h1 className="text-xl font-bold text-orange-400">Gráficas e Comunicação Visual em Urubici</h1>
          </div>
          <p className="text-sm text-white/90 ml-[52px]">Impressão, design gráfico e comunicação visual.</p>
        </div>
      </section>
      ...
      <nav className="max-w-md mx-auto px-4 py-3 text-xs">
        <div className="flex items-center gap-2 text-white/60">
          ...
          <i className="ri-arrow-right-s-line text-xs"></i>
          <span className="text-orange-400 font-medium">Gráficas e Comunicação Visual</span>
        </div>
      </nav>
      ...
      <section className="max-w-md mx-auto px-4 py-6">
            ...
            >
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 bg-cyan-500/30 rounded-full flex items-center justify-center flex-shrink-0 border border-cyan-400/40">
                  <i className="ri-printer-line text-cyan-300 text-xl"></i>
                </div>
        ...
        <div className="mt-6 bg-orange-500/10 backdrop-blur-sm border border-orange-400/30 rounded-xl p-4">
          ...
          <p className="text-white/90 text-sm leading-relaxed text-center mb-4">
            Esta página reúne as principais gráficas e serviços de comunicação visual de Urubici, 
            facilitando sua busca por impressões, materiais gráficos e soluções visuais para empresas e eventos.
          </p>
          <p className="text-white/80 text-sm leading-relaxed text-center mb-4">
            ...
            portfólio de serviços e formas de contato direto.
          </p>
