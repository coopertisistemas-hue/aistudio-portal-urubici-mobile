...
const FEATURED_ADS = [
  {
    title: "Salão Beauty Center",
    subtitle: "Cabelo, maquiagem e dia da noiva",
    image: "https://readdy.ai/api/search-image?query=Luxury%20beauty%20salon%20modern%20interior%20hair%20styling%20Urubici&width=300&height=200&seq=beauty01&orientation=landscape",
    link: "#",
    isAd: true
  },
  {
    title: "Barbearia do Mestre",
    subtitle: "Corte clássico, barba e bigode",
    image: "https://readdy.ai/api/search-image?query=Vintage%20barbershop%20men%20grooming%20beard%20trimming%20Urubici&width=300&height=200&seq=barber01&orientation=landscape",
    link: "#",
    isAd: true
  }
];
        ...
        <div className="px-4 mb-6">
          <div className="text-center">
            <h2 className="text-white font-bold text-xl mb-2 flex items-center justify-center gap-2">
              <i className="ri-scissors-2-line text-rose-400" />
              Beleza e Estética
              <i className="ri-scissors-2-line text-rose-400" />
            </h2>
            <p className="text-white/70 text-sm">Salões de beleza, barbearias e estética em Urubici</p>
          </div>
        </div>
          ...
          {loading ? (
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg text-center mb-4">
              ...
              <p className="text-white/80 text-sm leading-relaxed">
                Estamos atualizando nossa base de dados. Em breve você encontrará os melhores salões e clínicas de estética de Urubici aqui!
              </p>
            </div>
          ) : (
            <>
