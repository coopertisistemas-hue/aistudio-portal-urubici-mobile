...
export default function BelezaEsteticaPage() {
  ...
  const establishments = [
    {
      name: "Salão Beleza Serra",
      description: "Cortes femininos e masculinos, coloração, escova progressiva e tratamentos capilares",
    ...
    {
      name: "Barbearia Montanha",
      description: "Cortes masculinos, barba, design de sobrancelhas e tratamentos para cabelo e barba",
      address: "Av. Nereu Ramos, 567 - Centro",
      city: "Urubici – SC",
      phone: "(49) 3278-8901",
      whatsapp: "5549932788901"
    },
    {
      name: "Espaço Estética Urubici",
      description: "Estética facial e corporal, limpeza de pele, massagens e drenagem linfática",
      address: "Rua São Joaquim, 123 - São Pedro",
      city: "Urubici – SC",
      phone: "(49) 3278-2345",
      whatsapp: "5549932782345"
    },
    {
      name: "Studio de Beleza Ana Paula",
      description: "Manicure, pedicure, design de sobrancelhas, depilação e maquiagem",
      address: "Rua Hercílio Luz, 456 - Centro",
      city: "Urubici – SC",
      phone: "(49) 3278-6789",
      whatsapp: "5549932786789"
    },
    {
      name: "Clínica de Estética Avançada",
      description: "Tratamentos estéticos faciais e corporais, peeling, microagulhamento e radiofrequência",
      address: "Rua das Flores, 789 - Santa Terezinha",
      city: "Urubici – SC",
      phone: "(49) 3278-3456",
      whatsapp: "5549932783456"
    },
    {
      name: "Salão & Spa Serra Azul",
      description: "Salão completo com spa, massagens relaxantes, tratamentos capilares e estética",
      address: "Av. Aristiliano Ramos, 321 - Centro",
      city: "Urubici – SC",
      phone: "(49) 3278-7890",
    ...
    },
    {
      ...
      description: "Especializada em unhas decoradas, alongamento de unhas e nail art",
      address: "Rua Getúlio Vargas, 654 - Centro",
      city: "Urubici – SC",
      phone: "(49) 3278-1234",
      whatsapp: "5549932781234"
    },
    {
      name: "Barbearia & Salão Família",
      description: "Atendimento para toda a família, cortes infantis, femininos e masculinos",
      address: "Rua Tiradentes, 987 - São Pedro",
      city: "Urubici – SC",
      phone: "(49) 3278-5678",
    ...
    <div className="min-h-screen bg-black text-white">
        ...
        <div className="relative z-20 h-full flex flex-col justify-center max-w-md mx-auto px-4">
          <div className="flex items-center gap-3 mb-2">
            <div className="w-10 h-10 rounded-full bg-orange-500/20 backdrop-blur-sm flex items-center justify-center border border-orange-400/30">
              <i className="ri-scissors-cut-line text-xl text-orange-400"></i>
            </div>
            <h1 className="text-xl font-bold text-orange-400">Beleza e Estética em Urubici</h1>
          </div>
          <p className="text-sm text-white/90 ml-[52px]">Salões de beleza, barbearias e clínicas de estética.</p>
        </div>
      </section>
      ...
      <nav className="max-w-md mx-auto px-4 py-3 text-xs">
        <div className="flex items-center gap-2 text-white/60">
          ...
          <i className="ri-arrow-right-s-line text-xs"></i>
          <span className="text-orange-400 font-medium">Beleza e Estética</span>
        </div>
      </nav>
      ...
      <section className="max-w-md mx-auto px-4 py-6">
            ...
            >
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 bg-cyan-500/30 rounded-full flex items-center justify-center flex-shrink-0 border border-cyan-400/40">
                  <i className="ri-scissors-cut-line text-cyan-300 text-xl"></i>
                </div>
        ...
        <div className="mt-6 bg-orange-500/10 backdrop-blur-sm border border-orange-400/30 rounded-xl p-4">
          ...
          <p className="text-white/90 text-sm leading-relaxed text-center mb-4">
            Esta página reúne os principais salões de beleza, barbearias, manicures e centros de estética de Urubici, 
            facilitando sua busca por serviços de cuidados pessoais e bem-estar.
          </p>
