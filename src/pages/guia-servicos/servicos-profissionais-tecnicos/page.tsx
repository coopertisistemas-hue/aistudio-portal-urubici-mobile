...
export default function ServicosProfissionaisTecnicos() {
  ...
  const featuredAds = [
    {
      title: "Salão Beleza Serra",
      subtitle: "Cuidados com cabelo e estética",
      image: "https://readdy.ai/api/search-image?query=Modern%20beauty%20salon%20hair%20studio%20in%20Urubici%20Santa%20Catarina%20Brazil%2C%20professional%20hairdressing%20facility%2C%20elegant%20beauty%20parlor%20with%20contemporary%20interior%20design%20and%20mountain%20town%20atmosphere&width=300&height=200&seq=salon1&orientation=landscape",
      link: "#",
      isAd: true
    },
    {
      title: "Eletricista Urubici",
      subtitle: "Instalações e reparos elétricos",
      image: "https://readdy.ai/api/search-image?query=Professional%20electrician%20service%20workshop%20in%20Urubici%20Santa%20Catarina%20Brazil%2C%20electrical%20repair%20facility%2C%20technical%20service%20center%20with%20professional%20equipment%20and%20tools&width=300&height=200&seq=electric1&orientation=landscape",
      link: "#",
      isAd: true
    },
    {
      title: "Gráfica Rápida Serra",
      subtitle: "Impressões e comunicação visual",
      image: "https://readdy.ai/api/search-image?query=Modern%20print%20shop%20graphic%20design%20studio%20in%20Urubici%20Santa%20Catarina%20Brazil%2C%20printing%20service%20facility%2C%20professional%20graphics%20center%20with%20contemporary%20workspace&width=300&height=200&seq=print1&orientation=landscape",
      link: "#",
      isAd: true
    }
  ];
  ...
  const subcategories = [
    ...
    {
      title: "Eletricista, Encanador e Reparos",
      description: "Profissionais para reparos e instalações em residências e comércios.",
      icon: "ri-tools-line",
      color: "cyan",
      link: "/guia-servicos/servicos-profissionais-tecnicos/reparos-domiciliares"
    },
    {
      title: "Gráficas e Comunicação Visual",
      description: "Gráficas rápidas, copiadoras e serviços de comunicação visual.",
      icon: "ri-printer-line",
      color: "cyan",
      link: "/guia-servicos/servicos-profissionais-tecnicos/graficas-comunicacao"
    }
  ];
      ...
      <div className="relative z-10 max-w-md mx-auto">
        ...
        <div className="px-4 mb-6">
          <div className="text-center">
            <h2 className="text-white font-bold text-xl mb-2 flex items-center justify-center gap-2">
              <i className="ri-tools-line text-orange-400"></i>
              Serviços Profissionais & Técnicos
              <i className="ri-tools-line text-orange-400"></i>
            </h2>
            <p className="text-white/70 text-sm">Beleza, estética, reparos domiciliares e gráficas em Urubici.</p>
          </div>
        </div>
        ...
        <div className="px-4 mb-6">
          <div className="mb-4">
            ...
            <p className="text-white/70 text-xs text-center mt-1">Explore os diferentes tipos de serviços profissionais</p>
          </div>
