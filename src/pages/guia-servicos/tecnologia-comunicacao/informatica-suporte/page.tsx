...
const FEATURED_ADS = [
  {
    title: "InforTech Soluções",
    subtitle: "Manutenção de computadores e redes estruturadas",
    image: "https://readdy.ai/api/search-image?query=Computer%20repair%20shop%20modern%20technician%20working%20circuit%20board%20Urubici&width=300&height=200&seq=tech01&orientation=landscape",
    link: "#",
    isAd: true
  },
  {
    title: "Connect Fibra",
    subtitle: "Internet ultra-rápida para sua casa ou empresa",
    image: "https://readdy.ai/api/search-image?query=High%20speed%20fiber%20optic%20internet%20technology%20concept%20glowing%20cables&width=300&height=200&seq=tech02&orientation=landscape",
    link: "#",
    isAd: true
  }
];
...
export default function InformaticaSuportePage() {
  ...
  // Ordenar grupos alfabeticamente ou por prioridade, aqui vamos alfabético
  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className="relative z-10 max-w-md mx-auto">
        ...
        <div className="px-4 mb-6">
          <div className="text-center">
            <h2 className="text-white font-bold text-xl mb-2 flex items-center justify-center gap-2">
              <i className="ri-computer-line text-cyan-400" />
              Informática e Suporte
              <i className="ri-cpu-line text-cyan-400" />
            </h2>
            <p className="text-white/70 text-sm">
              Assistência técnica, internet, celulares e automação em Urubici
            </p>
          </div>
        </div>
        ...
        <div className="px-4 mb-6">
          {loading ? (
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg text-center mb-4">
              <i className="ri-information-line text-cyan-400 text-4xl mb-3" />
              <h4 className="text-white font-bold text-lg mb-2">Nenhum estabelecimento encontrado</h4>
              <p className="text-white/80 text-sm leading-relaxed">
                No momento não há serviços de informática cadastrados nesta categoria.
              </p>
            </div>
          ) : (
            <>
        ...
        <button
          onClick={scrollToTop}
          className="fixed bottom-6 left-6 z-50 w-14 h-14 bg-gradient-to-br from-cyan-500 to-cyan-600 hover:from-cyan-600 hover:to-cyan-700 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center backdrop-blur-sm border border-cyan-400/30 hover:scale-110 group"
