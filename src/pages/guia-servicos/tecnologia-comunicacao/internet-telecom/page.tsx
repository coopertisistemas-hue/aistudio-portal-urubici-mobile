...
export default function InternetTelecomPage() {
  ...
  const establishments = [
    {
      name: "Provedor Internet Serra",
      description: "Internet fibra óptica de alta velocidade, planos residenciais e empresariais",
      coverage: "Urubici e região",
      phone: "(49) 3278-1234",
      whatsapp: "5549932781234"
    },
    {
      name: "Conecta Urubici",
      description: "Internet via rádio, TV por assinatura e telefonia fixa",
      coverage: "Urubici e região",
      phone: "(49) 3278-2345",
    ...
    {
      name: "Fibra Montanha",
      description: "Fibra óptica até 500 Mbps, instalação gratuita e suporte 24h",
      coverage: "Urubici e região",
      phone: "(49) 3278-3456",
      whatsapp: "5549932783456"
    },
    {
      name: "Net Serra Telecom",
      description: "Internet, TV a cabo e telefonia, pacotes promocionais",
      coverage: "Urubici e região",
      phone: "(49) 3278-4567",
      whatsapp: "5549932784567"
    },
    {
      name: "Urubici Connect Internet",
      description: "Provedor local, internet via rádio e fibra, atendimento personalizado",
      coverage: "Urubici e região",
      phone: "(49) 3278-5678",
      whatsapp: "5549932785678"
    },
    {
      name: "Telecom Serra Catarinense",
      description: "Telefonia fixa e móvel, planos corporativos e residenciais",
      coverage: "Urubici e região",
      phone: "(49) 3278-6789",
      whatsapp: "5549932786789"
    },
    {
      name: "Rádio Link Urubici",
      description: "Internet via rádio de alta performance, cobertura em áreas rurais",
      coverage: "Urubici e região",
      phone: "(49) 3278-7890",
    ...
    {
      name: "Fibra Total",
      description: "Fibra óptica FTTH, velocidade simétrica e estabilidade garantida",
      coverage: "Urubici e região",
      phone: "(49) 3278-8901",
    ...
    <div className="min-h-screen bg-black text-white">
        ...
        <div className="relative z-20 h-full flex flex-col justify-center max-w-md mx-auto px-4">
          <div className="flex items-center gap-3 mb-2">
            <div className="w-10 h-10 rounded-full bg-cyan-500/20 backdrop-blur-sm flex items-center justify-center border border-cyan-400/30">
              <i className="ri-wifi-line text-xl text-cyan-400"></i>
            </div>
            <h1 className="text-xl font-bold text-cyan-400">Internet e Telecomunicações em Urubici</h1>
          </div>
          <p className="text-sm text-white/90 ml-[52px]">Provedores de internet, telefonia e TV por assinatura.</p>
        </div>
      </section>
      ...
      <nav className="max-w-md mx-auto px-4 py-3 text-xs">
        <div className="flex items-center gap-2 text-white/60">
          ...
          <i className="ri-arrow-right-s-line text-xs"></i>
          <span className="text-cyan-400 font-medium">Internet e Telecomunicações</span>
        </div>
      </nav>
      ...
      <section className="max-w-md mx-auto px-4 py-6">
            ...
            >
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 bg-cyan-500/30 rounded-full flex items-center justify-center flex-shrink-0 border border-cyan-400/40">
                  <i className="ri-wifi-line text-cyan-300 text-xl"></i>
                </div>
                <div className="flex-1">
                  ...
                  <div className="space-y-2 mb-4">
                    <div className="flex items-center gap-2 text-white/70 text-xs">
                      ...
                      <span>{establishment.coverage}</span>
                    </div>
                    <div className="flex items-center gap-2 text-white/70 text-xs">
        ...
        <div className="mt-6 bg-cyan-500/10 backdrop-blur-sm border border-cyan-400/30 rounded-xl p-4">
          ...
          <p className="text-white/90 text-sm leading-relaxed text-center mb-4">
            Esta página reúne as principais empresas responsáveis pela conectividade em Urubici, 
            facilitando sua busca por serviços de internet, telefonia e telecomunicação para residências e empresas da região.
          </p>
          <p className="text-white/80 text-sm leading-relaxed text-center mb-4">
            Em breve, esta lista será atualizada automaticamente com informações completas sobre planos, 
            cobertura, velocidades disponíveis e avaliações dos clientes.
          </p>
