...
export default function TecnologiaComunicacao() {
  ...
  const featuredAds = [
    {
      title: "Informática Urubici",
      subtitle: "Assistência técnica e vendas",
      image: "https://readdy.ai/api/search-image?query=Modern%20computer%20repair%20shop%20technology%20store%20in%20Urubici%20Santa%20Catarina%20Brazil%2C%20IT%20service%20center%2C%20electronics%20repair%20facility%20with%20professional%20workspace%20and%20mountain%20town%20atmosphere&width=300&height=200&seq=tech1&orientation=landscape",
      link: "#",
      isAd: true
    },
    {
      title: "Provedor Internet Serra",
      subtitle: "Internet de alta velocidade",
      image: "https://readdy.ai/api/search-image?query=Internet%20service%20provider%20office%20telecommunications%20facility%20in%20Urubici%20Santa%20Catarina%20Brazil%2C%20ISP%20company%20building%2C%20fiber%20optic%20network%20center%20with%20modern%20technology%20infrastructure&width=300&height=200&seq=isp1&orientation=landscape",
      link: "#",
      isAd: true
    },
    {
      title: "Cell Tech Urubici",
      subtitle: "Assistência técnica de celulares",
      image: "https://readdy.ai/api/search-image?query=Mobile%20phone%20repair%20shop%20smartphone%20service%20center%20in%20Urubici%20Santa%20Catarina%20Brazil%2C%20cell%20phone%20technical%20assistance%20facility%2C%20electronics%20repair%20workshop%20with%20professional%20equipment&width=300&height=200&seq=cell1&orientation=landscape",
      link: "#",
      isAd: true
    }
  ];
  ...
  const subcategories = [
    {
      title: "Informática e Suporte Técnico",
      description: "Lojas e assistência técnica de computadores, celulares e eletrônicos.",
      icon: "ri-computer-line",
      color: "cyan",
      link: "/guia-servicos/tecnologia-comunicacao/informatica-suporte"
    },
    {
      title: "Provedores de Internet e Telecom",
      description: "Empresas de internet, fibra, rádio e serviços de telefonia.",
      icon: "ri-wifi-line",
      color: "cyan",
      link: "/guia-servicos/tecnologia-comunicacao/internet-telecom"
    }
  ];
      ...
      <div className="relative z-10 max-w-md mx-auto">
        ...
        <div className="px-4 mb-6">
          <div className="text-center">
            <h2 className="text-white font-bold text-xl mb-2 flex items-center justify-center gap-2">
              <i className="ri-wifi-line text-cyan-400"></i>
              Tecnologia & Comunicação
              <i className="ri-wifi-line text-cyan-400"></i>
            </h2>
            <p className="text-white/70 text-sm">Informática, suporte técnico, internet e telecomunicações em Urubici.</p>
          </div>
        </div>
        ...
        <div className="px-4 mb-6">
          <div className="mb-4">
            ...
            <p className="text-white/70 text-xs text-center mt-1">Explore os diferentes tipos de serviços de tecnologia</p>
          </div>
        ...
        <div className="px-4 mb-6">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg">
            ...
            <p className="text-white/90 text-sm leading-relaxed text-center mb-4">
              Aqui você encontrará todos os serviços de tecnologia, conectividade e suporte técnico disponíveis em Urubici. 
              Desde lojas de informática e assistência técnica até provedores de internet e empresas de telecomunicação.
            </p>
            <p className="text-white/80 text-sm leading-relaxed text-center mb-4">
              Em breve, esta página apresentará uma lista completa de todos os estabelecimentos e profissionais da área de tecnologia, 
              com informações de contato, serviços oferecidos e horários de atendimento.
            </p>
