...
export default function CorreiosCartoriosPage() {
  ...
  const establishments = [
    {
      name: "Agência dos Correios Urubici",
      description: "Serviços postais completos, envio e recebimento de encomendas, SEDEX, PAC e serviços bancários",
      address: "Rua Adolfo Konder, 234 - Centro",
      city: "Urubici – SC",
      phone: "(49) 3278-4100",
      hours: "Segunda a sexta: 9h às 17h | Sábado: 9h às 12h"
    },
    {
      name: "Cartório de Registro Civil",
      description: "Registro de nascimento, casamento, óbito, certidões e documentos civis",
      address: "Rua Nereu Ramos, 156 - Centro",
      city: "Urubici – SC",
      phone: "(49) 3278-4200",
      hours: "Segunda a sexta: 8h30 às 12h e 13h30 às 17h"
    },
    {
      name: "Cartório de Notas e Protesto",
      description: "Reconhecimento de firma, autenticação de documentos, escrituras públicas e protestos",
      address: "Rua Hercílio Luz, 89 - Centro",
      city: "Urubici – SC",
      phone: "(49) 3278-4300",
      hours: "Segunda a sexta: 9h às 12h e 13h às 17h"
    },
    {
      name: "Cartório de Registro de Imóveis",
      description: "Registro de imóveis, matrículas, escrituras e certidões imobiliárias",
      address: "Av. São Joaquim, 345 - Centro",
      city: "Urubici – SC",
      phone: "(49) 3278-4400",
      hours: "Segunda a sexta: 8h às 12h e 13h30 às 17h30"
    },
    {
      name: "Cartório Eleitoral",
      description: "Alistamento eleitoral, transferência de título, certidões e serviços eleitorais",
      address: "Rua das Flores, 67 - Centro",
      city: "Urubici – SC",
      phone: "(49) 3278-4500",
      hours: "Segunda a sexta: 12h às 18h"
    }
  ];
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative h-48 overflow-hidden">
        ...
        <div className="relative z-20 h-full flex flex-col justify-center max-w-md mx-auto px-4">
          <div className="flex items-center gap-3 mb-2">
            <div className="w-10 h-10 rounded-full bg-indigo-500/20 backdrop-blur-sm flex items-center justify-center border border-indigo-400/30">
              <i className="ri-mail-line text-xl text-indigo-400"></i>
            </div>
            <h1 className="text-xl font-bold text-indigo-400">Correios e Cartórios em Urubici</h1>
          </div>
          <p className="text-sm text-white/90 ml-[52px]">Serviços postais e cartorários na região.</p>
        </div>
      </section>
      ...
      <nav className="max-w-md mx-auto px-4 py-3 text-xs">
        <div className="flex items-center gap-2 text-white/60">
          ...
          <button onClick={() => navigate('/guia-servicos')} className="hover:text-indigo-400 transition-colors">
            Guia de Serviços
          </button>
          <i className="ri-arrow-right-s-line text-xs"></i>
          <button onClick={() => navigate('/guia-servicos/utilidade-publica-governo')} className="hover:text-indigo-400 transition-colors">
            Utilidade Pública & Governo
          </button>
          <i className="ri-arrow-right-s-line text-xs"></i>
          <span className="text-indigo-400 font-medium">Correios e Cartórios</span>
        </div>
      </nav>
      ...
      <section className="max-w-md mx-auto px-4 py-6">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="text-lg font-semibold text-indigo-400">Estabelecimentos</h2>
        </div>
            ...
            >
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 bg-cyan-500/30 rounded-full flex items-center justify-center flex-shrink-0 border border-cyan-400/40">
                  <i className="ri-government-line text-cyan-300 text-xl"></i>
                </div>
                <div className="flex-1">
                  ...
                  <div className="space-y-2 mb-3">
                    ...
                    <div className="flex items-start gap-2 text-white/70 text-xs">
                      <i className="ri-time-line text-cyan-400 mt-0.5 flex-shrink-0"></i>
                  ...
                  <div className="flex gap-2 mt-3">
                    <a
                      ...
                      className="flex-1 bg-indigo-500 hover:bg-indigo-600 text-white text-xs font-medium py-2 px-3 rounded-lg transition-colors flex items-center justify-center gap-1.5"
                    >
                      <i className="ri-whatsapp-line text-sm"></i>
                      WhatsApp
                    </a>
                    <button className="flex-1 bg-white/10 hover:bg-white/20 text-white text-xs font-medium py-2 px-3 rounded-lg transition-colors flex items-center justify-center gap-1.5 border border-indigo-400/30">
                      <i className="ri-map-pin-line text-sm text-indigo-400"></i>
                      Ver Localização
                    </button>
                  </div>
                </div>
        ...
        {/* Info Badge */}
        <div className="mt-6 bg-indigo-500/10 backdrop-blur-sm border border-indigo-400/30 rounded-xl p-4">
          ...
          <p className="text-white/90 text-sm leading-relaxed text-center mb-4">
            Esta página reúne os serviços essenciais de correios e cartórios disponíveis em Urubici, 
            facilitando o acesso a informações sobre envio de correspondências, registros civis, 
          ...
          <p className="text-white/80 text-sm leading-relaxed text-center mb-4">
            ...
            horários de funcionamento atualizados e serviços específicos oferecidos por cada estabelecimento.
          </p>
