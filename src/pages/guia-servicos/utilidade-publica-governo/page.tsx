...
export default function UtilidadePublicaGoverno() {
  ...
  const featuredAds = [
    {
      ...
      subtitle: "Serviços postais e encomendas",
      image: "https://readdy.ai/api/search-image?query=Post%20office%20building%20Correios%20in%20Urubici%20Santa%20Catarina%20Brazil%2C%20postal%20service%20facility%20with%20professional%20staff%2C%20mail%20delivery%20center%20in%20mountain%20town%20setting%20with%20organized%20workspace%20and%20postal%20services&width=300&height=200&seq=correios1&orientation=landscape",
      link: "#",
      isAd: true
    },
    {
      title: "Cartório Urubici",
      subtitle: "Registro civil e autenticações",
      image: "https://readdy.ai/api/search-image?query=Notary%20office%20building%20cart%C3%B3rio%20in%20Urubici%20Santa%20Catarina%20Brazil%2C%20civil%20registry%20facility%20with%20professional%20atmosphere%2C%20document%20authentication%20center%20with%20organized%20workspace%20and%20official%20services&width=300&height=200&seq=cartorio1&orientation=landscape",
      link: "#",
      isAd: true
    },
    {
      title: "Prefeitura Municipal",
      subtitle: "Serviços públicos municipais",
      image: "https://readdy.ai/api/search-image?query=City%20hall%20building%20prefeitura%20municipal%20in%20Urubici%20Santa%20Catarina%20Brazil%2C%20government%20facility%20with%20modern%20architecture%2C%20public%20services%20center%20in%20mountain%20town%20setting%20with%20professional%20atmosphere&width=300&height=200&seq=prefeitura1&orientation=landscape",
      link: "#",
      isAd: true
    }
  ];
  ...
  const subcategories = [
    {
      title: "Correios e Cartórios",
      description: "Serviços postais, registro civil, autenticações e reconhecimento de firma.",
      icon: "ri-mail-line",
      color: "cyan",
      link: "/guia-servicos/utilidade-publica-governo/correios-cartorios"
    },
    {
      title: "Repartições Públicas",
      description: "Prefeitura, secretarias, delegacias, fórum e outros órgãos públicos.",
      icon: "ri-government-line",
      color: "cyan",
      link: "/guia-servicos/utilidade-publica-governo/reparticoes-publicas"
    }
  ];
      ...
      <div className="relative z-10 max-w-md mx-auto">
        ...
        <div className="px-4 mb-6">
          <div className="text-center">
            <h2 className="text-white font-bold text-xl mb-2 flex items-center justify-center gap-2">
              <i className="ri-government-line text-indigo-400"></i>
              Utilidade Pública & Governo
              <i className="ri-government-line text-indigo-400"></i>
            </h2>
            <p className="text-white/70 text-sm">Correios, cartórios e repartições públicas em Urubici.</p>
          </div>
        </div>
        ...
        <div className="px-4 mb-6">
          <div className="mb-4">
            ...
            <p className="text-white/70 text-xs text-center mt-1">Explore os diferentes serviços públicos disponíveis</p>
          </div>
        ...
        <div className="px-4 mb-6">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg">
            ...
            <p className="text-white/90 text-sm leading-relaxed text-center mb-4">
              Aqui você encontrará todos os serviços oficiais e de utilidade pública de Urubici. 
              Desde correios e cartórios até órgãos governamentais como prefeitura, secretarias, delegacias e outros serviços essenciais para a população.
            </p>
            <p className="text-white/80 text-sm leading-relaxed text-center mb-4">
              Em breve, esta página apresentará uma lista completa de todos os órgãos públicos e serviços de utilidade pública, 
              com informações de contato, endereços, horários de atendimento e serviços oferecidos.
            </p>
