...
export default function ReparticoesPublicasPage() {
  ...
  const establishments = [
    {
      name: "Prefeitura Municipal de Urubici",
      description: "Administração pública municipal, atendimento ao cidadão, serviços públicos e secretarias municipais",
      address: "Rua Adolfo Konder, 322 - Centro",
      city: "Urubici – SC",
      phone: "(49) 3278-4000",
    ...
    },
    {
      ...
      description: "Gestão da saúde pública municipal, programas de saúde e atendimento administrativo",
      address: "Rua Nereu Ramos, 245 - Centro",
      city: "Urubici – SC",
      phone: "(49) 3278-4050",
    ...
    },
    {
      ...
      description: "Gestão da educação pública, matrículas escolares e programas educacionais",
      address: "Av. São Joaquim, 178 - Centro",
      city: "Urubici – SC",
      phone: "(49) 3278-4080",
      hours: "Segunda a sexta: 8h às 12h e 13h30 às 17h30"
    },
    {
      ...
      description: "Registro de ocorrências, investigações criminais e atendimento policial",
      address: "Rua Hercílio Luz, 156 - Centro",
      city: "Urubici – SC",
      phone: "(49) 3278-4150",
      hours: "24 horas - Plantão permanente"
    },
    {
      name: "Fórum da Comarca de Urubici",
      description: "Poder Judiciário, processos judiciais, audiências e atendimento jurídico",
      address: "Rua das Flores, 89 - Centro",
      city: "Urubici – SC",
      phone: "(49) 3278-4200",
      hours: "Segunda a sexta: 12h às 19h"
    },
    {
      name: "Secretaria Municipal de Turismo",
      description: "Informações turísticas, eventos, promoção do turismo e atendimento ao visitante",
      address: "Rua Adolfo Konder, 322 - Centro",
      city: "Urubici – SC",
      phone: "(49) 3278-4100",
      hours: "Segunda a sexta: 8h às 12h e 13h30 às 17h30"
    },
    {
      ...
      description: "Gestão de obras públicas, infraestrutura urbana e serviços de engenharia",
      address: "Av. São Joaquim, 456 - Centro",
      city: "Urubici – SC",
      phone: "(49) 3278-4120",
      hours: "Segunda a sexta: 8h às 12h e 13h às 17h"
    },
    {
      ...
      description: "Benefícios previdenciários, aposentadorias, pensões e atendimento ao segurado",
      address: "Rua Nereu Ramos, 334 - Centro",
      city: "Urubici – SC",
      phone: "135",
      hours: "Segunda a sexta: 7h às 13h (Agendamento obrigatório)"
    }
  ];
    ...
    <div className="min-h-screen bg-black text-white">
        ...
        <div className="relative z-20 h-full flex flex-col justify-center max-w-md mx-auto px-4">
          <div className="flex items-center gap-3 mb-2">
            <div className="w-10 h-10 rounded-full bg-indigo-500/20 backdrop-blur-sm flex items-center justify-center border border-indigo-400/30">
              <i className="ri-government-line text-xl text-indigo-400"></i>
            </div>
            <h1 className="text-xl font-bold text-indigo-400">Repartições Públicas em Urubici</h1>
          </div>
          <p className="text-sm text-white/90 ml-[52px]">Órgãos públicos e serviços governamentais.</p>
        </div>
      </section>
      ...
      <nav className="max-w-md mx-auto px-4 py-3 text-xs">
        <div className="flex items-center gap-2 text-white/60">
          ...
          <i className="ri-arrow-right-s-line text-xs"></i>
          <span className="text-indigo-400 font-medium">Repartições Públicas</span>
        </div>
      </nav>
