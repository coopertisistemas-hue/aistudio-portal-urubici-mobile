...
function isOpenNow(businessHours: any): boolean | null {
  ...
  if (typeof businessHours.open_now === 'boolean') return businessHours.open_now;
  return null;
}
        ...
        <div className="flex-1">
          <div className="flex items-start justify-between mb-2">
            ...
            <div className="flex flex-col gap-1.5 items-end ml-2 flex-shrink-0">
              {/* Group chip */}
              {groupName && (
                <div className="bg-amber-500/20 text-amber-200 border-amber-400/30 px-2 py-1 rounded-full text-xs font-medium max-w-[120px] truncate whitespace-nowrap overflow-hidden">
                  {groupName.slice(0, -1)}
                </div>
              )}
