...
const FEATURED_ADS = [
  {
    title: "Escritório Contábil Urubici",
    subtitle: "Contabilidade completa para sua empresa",
    image: "https://readdy.ai/api/search-image?query=Modern%20accounting%20office%20in%20Urubici%20Santa%20Catarina%20Brazil%20with%20professional%20accountants%20organized%20workspace%20financial%20documents%20and%20quality%20service%20in%20mountain%20town%20setting&width=300&height=200&seq=accounting1&orientation=landscape",
    link: "#",
    isAd: true
  },
  {
    title: "Advocacia Serra Catarinense",
    subtitle: "Assessoria jurídica especializada",
    image: "https://readdy.ai/api/search-image?query=Professional%20law%20office%20in%20Urubici%20Santa%20Catarina%20Brazil%20with%20lawyers%20legal%20books%20consultation%20room%20and%20quality%20legal%20services%20in%20mountain%20region&width=300&height=200&seq=legal1&orientation=landscape",
    link: "#",
    isAd: true
  }
];
...
const PARTNERS = [
  {
    ...
    image: "https://readdy.ai/api/search-image?query=Luxury%20mountain%20hotel%20logo%20Urubici%20Park%20Hotel%20Santa%20Catarina%20Brazil%20hospitality%20brand%20identity%20elegant%20hotel%20branding&width=100&height=100&seq=logo1&orientation=squarish"
  },
  {
    name: "São Joaquim Park Hotel",
    description: "Experiência única na serra catarinense",
    image: "https://readdy.ai/api/search-image?query=Elegant%20mountain%20resort%20hotel%20logo%20S%C3%A3o%20Joaquim%20Park%20Hotel%20Santa%20Catarina%20Brazil%20luxury%20hospitality%20brand%20identity&width=100&height=100&seq=logo2&orientation=squarish"
  },
  {
    name: "Dany Lumertz",
...
export default function ContabilidadeLegal() {
  ...
  const goToServices = () => navigate('/guia-servicos');
        ...
        <div className="px-4 mb-6">
          <div className="text-center">
            <h2 className="text-white font-bold text-xl mb-2 flex items-center justify-center gap-2">
              <i className="ri-file-text-line text-amber-400" />
              Contabilidade e Serviços Legais
              <i className="ri-file-text-line text-amber-400" />
            </h2>
            <p className="text-white/70 text-sm">
              Assessoria contábil, jurídica e financeira para apoiar o seu negócio em Urubici
            </p>
          </div>
        </div>
          ...
          {loading ? (
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg text-center mb-4">
              ...
              <p className="text-white/80 text-sm leading-relaxed">
                Estamos atualizando nossa base de dados. Em breve você encontrará os melhores 
                escritórios de contabilidade e advocacia de Urubici aqui!
              </p>
            </div>
          ) : (
            <>
