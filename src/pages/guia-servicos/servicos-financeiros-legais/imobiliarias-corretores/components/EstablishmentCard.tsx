      ...
      <div className="flex gap-4">
        <div className="w-20 h-20 rounded-xl overflow-hidden bg-white/20 flex-shrink-0">
          <img
            ...
            src={`https://readdy.ai/api/search-image?query=$%7BencodeURIComponent%28%60$%7Bestablishment.name%7D%20real%20estate%20agency%20office%20in%20Urubici%20Santa%20Catarina%20Brazil%20professional%20service%60%29%7D&width=200&height=200&seq=${establishment.id}&orientation=squarish`}
          />
        </div>
        ...
        <div className="flex-1">
          <div className="flex items-start justify-between mb-2">
            ...
            <div className="flex flex-col gap-1.5 items-end ml-2">
              ...
              <div className="bg-amber-500/20 text-amber-200 border-amber-400/30 px-2 py-1 rounded-full text-xs font-medium whitespace-nowrap">
                {groupName === 'Imobiliárias' ? 'Imobiliária' : groupName === 'Corretores Autônomos' ? 'Corretor' : 'Administradora'}
              </div>
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <button
              ...
              title="Em breve"
            >
              <i className="ri-home-heart-line text-base" />
