...
const FEATURED_ADS = [
  {
    title: "Imobiliária Serra Azul",
    subtitle: "Compra, venda e locação de imóveis em Urubici",
    image: "https://readdy.ai/api/search-image?query=Modern%20real%20estate%20agency%20office%20in%20Urubici%20Santa%20Catarina%20Brazil%20with%20professional%20service%2C%20property%20listings%2C%20mountain%20region%20real%20estate%20business%20with%20clean%20interior%20and%20welcoming%20atmosphere&width=300&height=200&seq=realestate1&orientation=landscape",
    link: "#",
    isAd: true
  },
  {
    title: "Urubici Imóveis",
    subtitle: "Especialistas em imóveis rurais e casas de temporada",
    image: "https://readdy.ai/api/search-image?query=Professional%20real%20estate%20office%20in%20Urubici%20Santa%20Catarina%20Brazil%20with%20property%20photos%2C%20modern%20workspace%2C%20mountain%20town%20real%20estate%20agency%20with%20quality%20service%20and%20local%20expertise&width=300&height=200&seq=realestate2&orientation=landscape",
    link: "#",
    isAd: true
  }
];
...
export default function ImobiliariasCorretores() {
        ...
        <div className="px-4 mb-6">
          <div className="text-center">
            <h2 className="text-white font-bold text-xl mb-2 flex items-center justify-center gap-2">
              <i className="ri-building-line text-amber-400" />
              Imobiliárias e Corretores
              <i className="ri-building-line text-amber-400" />
            </h2>
            <p className="text-white/70 text-sm">Compra, venda e locação de imóveis em Urubici e região</p>
          </div>
        </div>
          ...
          {loading ? (
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg text-center mb-4">
              ...
              <p className="text-white/80 text-sm leading-relaxed">
                Estamos atualizando nossa base de dados. Em breve você encontrará as melhores imobiliárias e corretores de Urubici aqui!
              </p>
            </div>
          ) : (
            <>
