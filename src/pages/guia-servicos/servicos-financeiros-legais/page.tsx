...
export default function ServicosFinanceirosLegais() {
  ...
  const featuredAds = [
    {
      ...
      subtitle: "Agência completa com todos os serviços bancários",
      image: "https://readdy.ai/api/search-image?query=Modern%20bank%20branch%20building%20exterior%20in%20Urubici%20Santa%20Catarina%20Brazil%2C%20financial%20institution%20facade%2C%20banking%20services%20center%20with%20mountain%20background&width=300&height=200&seq=bank1&orientation=landscape",
      link: "#",
      isAd: true
    },
    {
      title: "Escritório Contábil Serra",
      subtitle: "Contabilidade e consultoria fiscal",
      image: "https://readdy.ai/api/search-image?query=Professional%20accounting%20office%20building%20in%20Urubici%20Santa%20Catarina%20Brazil%2C%20financial%20services%20office%2C%20business%20consultancy%20center%20with%20modern%20architecture&width=300&height=200&seq=account1&orientation=landscape",
      link: "#",
      isAd: true
    },
    {
      title: "Imobiliária Urubici",
      subtitle: "Compra, venda e aluguel de imóveis",
      image: "https://readdy.ai/api/search-image?query=Real%20estate%20agency%20office%20building%20in%20Urubici%20Santa%20Catarina%20Brazil%2C%20property%20sales%20center%2C%20realty%20office%20with%20mountain%20town%20setting&width=300&height=200&seq=realty1&orientation=landscape",
      link: "#",
      isAd: true
    }
  ];
  ...
  const subcategories = [
    {
      title: "Bancos e Cooperativas de Crédito",
      description: "Agências bancárias, cooperativas de crédito, caixas eletrônicos e serviços financeiros locais.",
      icon: "ri-bank-line",
      color: "cyan",
      link: "/guia-servicos/servicos-financeiros-legais/bancos-financeiros"
    },
    {
      title: "Serviços Contábeis e Advocacia",
      description: "Escritórios de contabilidade, consultoria fiscal e profissionais de advocacia.",
      icon: "ri-file-text-line",
      color: "cyan",
      link: "/guia-servicos/servicos-financeiros-legais/contabilidade-legal"
    },
    {
      title: "Imobiliárias e Corretores",
      description: "Imobiliárias e corretores para compra, venda e aluguel de imóveis em Urubici e região.",
      icon: "ri-home-4-line",
      color: "cyan",
      link: "/guia-servicos/servicos-financeiros-legais/imobiliarias-corretores"
    }
  ];
      ...
      <div className="relative z-10 max-w-md mx-auto">
        ...
        <div className="px-4 mb-6">
          <div className="text-center">
            <h2 className="text-white font-bold text-xl mb-2 flex items-center justify-center gap-2">
              ...
              Serviços Financeiros & Legais
              <i className="ri-bank-line text-amber-400"></i>
            </h2>
            <p className="text-white/70 text-sm">Bancos, contabilidade, imobiliárias e serviços jurídicos em Urubici.</p>
          </div>
        </div>
        ...
        <div className="px-4 mb-6">
          <div className="mb-4">
            ...
            <p className="text-white/70 text-xs text-center mt-1">Explore os diferentes serviços financeiros e legais</p>
          </div>
        ...
        <div className="px-4 mb-6">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg">
            ...
            <p className="text-white/90 text-sm leading-relaxed text-center mb-4">
              Esta categoria reúne todos os serviços financeiros e legais disponíveis em Urubici. 
              Aqui você encontra bancos, cooperativas de crédito, escritórios de contabilidade, 
              profissionais de advocacia e imobiliárias que atendem na cidade e região.
            </p>
            <p className="text-white/80 text-sm leading-relaxed text-center mb-4">
              Em breve, esta página apresentará uma lista completa de todos os estabelecimentos, 
              com informações de contato, horários de atendimento, serviços oferecidos e localização.
            </p>
