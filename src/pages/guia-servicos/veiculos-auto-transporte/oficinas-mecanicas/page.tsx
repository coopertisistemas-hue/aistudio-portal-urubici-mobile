...
const FEATURED_ADS = [
    {
        title: "Mecânica Total",
        subtitle: "Soluções completas para seu veículo",
        image: "https://readdy.ai/api/search-image?query=Modern%20auto%20repair%20shop%20mechanic%20working%20under%20car%20lift%20clean%20garage%20Urubici&width=300&height=200&seq=mec01&orientation=landscape",
        link: "#",
        isAd: true
    },
    {
        title: "Auto Peças Serra",
        subtitle: "Peças e serviços com garantia",
        image: "https://readdy.ai/api/search-image?query=Auto%20parts%20store%20interior%20shelves%20with%20car%20parts%20organized%20Urubici&width=300&height=200&seq=mec02&orientation=landscape",
        link: "#",
        isAd: true
    }
];
...
export default function OficinasMecanicas() {
                ...
                <div className="px-4 mb-6">
                    <div className="text-center">
                        <h2 className="text-white font-bold text-xl mb-2 flex items-center justify-center gap-2">
                            <i className="ri-tools-line text-orange-400" />
                            Oficinas Mecânicas
                            <i className="ri-tools-line text-orange-400" />
                        </h2>
                        <p className="text-white/70 text-sm">Manutenção, peças e serviços automotivos em Urubici</p>
                    </div>
                </div>
                ...
                <div className="px-4 mb-6">
                    {loading ? (
                        <div className="flex flex-col items-center justify-center py-12">
                            ...
                            <p className="text-white/70 text-sm">Carregando oficinas...</p>
                        </div>
                    ) : establishments.length === 0 ? (
                        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg text-center mb-4">
                            <i className="ri-information-line text-orange-400 text-4xl mb-3" />
                            <h4 className="text-white font-bold text-lg mb-2">Nenhuma oficina encontrada</h4>
                            <p className="text-white/80 text-sm leading-relaxed">
                                No momento não há oficinas mecânicas cadastradas nesta categoria.
                            </p>
                        </div>
                    ) : (
                        <>
