    ...
    return (
        <div className="px-4 mb-8">
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg text-center">
                <div className="mb-4">
                    <i className="ri-add-circle-line text-orange-400 text-4xl mb-3" />
                    <h3 className="text-white font-bold text-lg mb-2">Cadastre sua Oficina</h3>
                    <p className="text-white/80 text-sm leading-relaxed mb-4">
                        Você possui uma oficina mecânica em Urubici? Cadastre-se gratuitamente em nossa plataforma e alcance mais clientes!
                    </p>
                </div>
                ...
                <div className="flex flex-col gap-3 items-center">
                    <a
                        ...
                        className="w-full inline-flex items-center justify-center gap-2 px-6 py-3 bg-orange-600 hover:bg-orange-700 rounded-lg text-white text-sm font-medium transition-all duration-200 hover:scale-105 whitespace-nowrap min-h-[44px] shadow-md"
                    >
