...
export default function VeiculosAutoTransporte() {
  ...
  const featuredAds = [
    {
      title: "Posto Ipiranga Urubici",
      subtitle: "Combustível de qualidade e loja de conveniência",
      image: "https://readdy.ai/api/search-image?query=Modern%20gas%20station%20fuel%20pump%20Posto%20Ipiranga%20in%20Urubici%20Santa%20Catarina%20Brazil%2C%20petrol%20station%20facility%2C%20convenience%20store%20with%20mountain%20background&width=300&height=200&seq=gas1&orientation=landscape",
      link: "#",
      isAd: true
    },
    {
      title: "Auto Mecânica Serra",
      subtitle: "Manutenção e reparos automotivos",
      image: "https://readdy.ai/api/search-image?query=Professional%20auto%20repair%20shop%20garage%20mechanic%20workshop%20in%20Urubici%20Santa%20Catarina%20Brazil%2C%20automotive%20service%20center%20with%20modern%20equipment&width=300&height=200&seq=mech1&orientation=landscape",
      link: "#",
      isAd: true
    },
    {
      title: "Táxi Urubici",
      subtitle: "Transporte seguro e confiável",
      image: "https://readdy.ai/api/search-image?query=Taxi%20cab%20service%20vehicle%20transportation%20in%20Urubici%20Santa%20Catarina%20Brazil%2C%20passenger%20transport%20car%20with%20mountain%20town%20setting&width=300&height=200&seq=taxi1&orientation=landscape",
      link: "#",
      isAd: true
    }
  ];
  ...
  const subcategories = [
    {
      title: "Postos de Combustível e Abastecimento",
      description: "Postos para abastecimento de veículos e lojas de conveniência.",
      icon: "ri-gas-station-line",
      color: "cyan",
      link: "/guia-servicos/veiculos-auto-transporte/postos-combustivel"
    },
    {
      title: "Oficinas Mecânicas e Borracharias",
      description: "Manutenção automotiva, reparos e troca de pneus.",
      icon: "ri-tools-line",
      color: "cyan",
      link: "/guia-servicos/veiculos-auto-transporte/oficinas-mecanicas"
    },
    {
      title: "Transporte por Aplicativo e Táxis",
      description: "Serviços de transporte de passageiros, táxis e motoristas por aplicativo.",
      icon: "ri-taxi-line",
      color: "cyan",
      link: "/guia-servicos/veiculos-auto-transporte/transporte-passageiros"
    }
  ];
        ...
        <div className="px-4 mb-6">
          <div className="text-center">
            <h2 className="text-white font-bold text-xl mb-2 flex items-center justify-center gap-2">
              <i className="ri-car-line text-rose-400"></i>
              Veículos, Auto & Transporte
              <i className="ri-car-line text-rose-400"></i>
            </h2>
            <p className="text-white/70 text-sm">Postos de combustível, oficinas mecânicas e transporte de passageiros em Urubici.</p>
          </div>
        </div>
        ...
        <div className="px-4 mb-6">
          <div className="mb-4">
            <h3 className="text-white font-bold text-sm uppercase tracking-wider text-center flex items-center justify-center gap-2">
              <i className="ri-roadster-line text-cyan-400"></i>
              Subcategorias
              <i className="ri-roadster-line text-cyan-400"></i>
            </h3>
            <p className="text-white/70 text-xs text-center mt-1">Explore os diferentes serviços automotivos</p>
          </div>
        ...
        <div className="px-4 mb-6">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg">
            ...
            <p className="text-white/90 text-sm leading-relaxed text-center mb-4">
              Aqui você encontrará todos os serviços ligados a veículos e transporte em Urubici. 
              Desde postos de combustível e oficinas mecânicas até serviços de táxi e transporte por aplicativo.
            </p>
            <p className="text-white/80 text-sm leading-relaxed text-center mb-4">
              Em breve, esta página apresentará uma lista completa de todos os estabelecimentos e profissionais 
              do setor automotivo e de transporte da cidade, com informações de contato, horários e localização.
            </p>
