...
const FEATURED_ADS = [
  {
    ...
    subtitle: "Qualidade e serviços completos para você",
    image: "https://readdy.ai/api/search-image?query=Modern%20gas%20station%20Ipiranga%20Urubici%20Brazil%20with%20convenience%20store%20in%20mountain%20landscape&width=300&height=200&seq=posto1&orientation=landscape",
    link: "#",
    isAd: true
  },
  {
    title: "Posto Shell Serra Azul",
    subtitle: "Abasteça com quem entende de qualidade",
    image: "https://readdy.ai/api/search-image?query=Shell%20gas%20station%20Urubici%20Brazil%20modern%20architecture%20mountain%20setting&width=300&height=200&seq=posto2&orientation=landscape",
    link: "#",
    isAd: true
  }
];
  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className="relative z-10 max-w-md mx-auto">
        ...
        <div className="px-4 mb-6">
          <div className="text-center">
            <h2 className="text-white font-bold text-xl mb-2 flex items-center justify-center gap-2">
              <i className="ri-gas-station-line text-rose-400" />
              Postos de Combustível
              <i className="ri-gas-station-line text-rose-400" />
            </h2>
            <p className="text-white/70 text-sm">Abastecimento e conveniência em Urubici</p>
          </div>
        </div>
        ...
        <div className="px-4 mb-6">
          {loading ? (
            <div className="flex flex-col items-center justify-center py-12">
              <div className="w-12 h-12 border-4 border-rose-400 border-t-transparent rounded-full animate-spin mb-4" />
              <p className="text-white/70 text-sm">Carregando postos...</p>
            </div>
          ) : establishments.length === 0 ? (
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg text-center mb-4">
              <i className="ri-information-line text-rose-400 text-4xl mb-3" />
              <h4 className="text-white font-bold text-lg mb-2">Nenhum posto encontrado</h4>
              <p className="text-white/80 text-sm leading-relaxed">
                Estamos atualizando nossa base de dados. Em breve você encontrará os principais postos de combustível aqui!
              </p>
            </div>
          ) : (
            <>
        ...
        <button
          onClick={scrollToTop}
          className="fixed bottom-6 left-6 z-50 w-14 h-14 bg-gradient-to-br from-rose-500 to-rose-600 hover:from-rose-600 hover:to-rose-700 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center backdrop-blur-sm border border-rose-400/30 hover:scale-110 group"
