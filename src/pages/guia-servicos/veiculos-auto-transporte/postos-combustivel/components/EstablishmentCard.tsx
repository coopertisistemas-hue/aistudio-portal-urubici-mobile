            ...
            <div className="flex gap-4">
                <div className="w-20 h-20 rounded-xl overflow-hidden bg-white/20 flex-shrink-0">
                    <img
                        ...
                        src={`https://readdy.ai/api/search-image?query=$%7BencodeURIComponent%28%60$%7Bestablishment.name%7D%20gas%20station%20fuel%20Urubici%20Santa%20Catarina%20Brazil%60%29%7D&width=200&height=200&seq=${establishment.id}&orientation=squarish`}
                    />
                </div>
                ...
                <div className="flex-1">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                        ...
                        <button
                            ...
                            title="Em breve"
                        >
                            <i className="ri-roadster-line text-base" />
