...
export default function TransportePassageirosPage() {
  ...
  const establishments = [
    {
      name: "Táxi Central Urubici",
      description: "Serviço de táxi 24 horas, transporte para aeroportos e passeios turísticos",
      phone: "(49) 3278-1600",
      whatsapp: "5549932781600",
      area: "Urubici e região"
    },
    {
      name: "Motorista Particular João Silva",
      description: "Transporte por aplicativo e fretamento para eventos e passeios",
      phone: "(49) 99876-5432",
      whatsapp: "5549998765432",
      area: "Urubici e Serra Catarinense"
    },
    {
      name: "Táxi Turismo Serra",
      description: "Táxi especializado em turismo, transfer e city tour",
      phone: "(49) 3278-2700",
      whatsapp: "5549932782700",
      area: "Urubici e região"
    },
    {
      name: "Uber Urubici - Motoristas Locais",
      description: "Motoristas parceiros Uber disponíveis na cidade",
      phone: "(49) 99123-4567",
      whatsapp: "5549991234567",
      area: "Urubici - Centro e arredores"
    },
    {
      name: "Transporte Executivo Montanha",
      description: "Transporte particular para empresas, eventos e turismo",
      phone: "(49) 3278-3800",
      whatsapp: "5549932783800",
      area: "Urubici e cidades vizinhas"
    },
    {
      name: "Táxi Ponto Rodoviária",
      description: "Ponto de táxi na rodoviária, atendimento 24h",
      phone: "(49) 3278-4900",
      whatsapp: "5549932784900",
      area: "Urubici e região"
    }
  ];
      ...
      <div className="relative z-10 max-w-md mx-auto">
          ...
          <div className="relative z-20 h-full flex flex-col justify-center max-w-md mx-auto px-4">
            <div className="flex items-center gap-3 mb-2">
              <div className="w-10 h-10 rounded-full bg-rose-500/20 backdrop-blur-sm flex items-center justify-center border border-rose-400/30">
                <i className="ri-bus-line text-xl text-rose-400"></i>
              </div>
              <h1 className="text-xl font-bold text-rose-400">Transporte de Passageiros em Urubici</h1>
            </div>
            <p className="text-sm text-white/90 ml-[52px]">Táxis, vans e serviços de transporte na região.</p>
          </div>
        </section>
        ...
        <nav className="max-w-md mx-auto px-4 py-3 text-xs">
          <div className="flex items-center gap-2 text-white/60">
            ...
            <i className="ri-arrow-right-s-line text-xs"></i>
            <span className="text-rose-400 font-medium">Transporte de Passageiros</span>
          </div>
        </nav>
        ...
        <section className="max-w-md mx-auto px-4 py-6">
              ...
              >
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 bg-cyan-500/30 rounded-full flex items-center justify-center flex-shrink-0 border border-cyan-400/40">
                    <i className="ri-taxi-line text-cyan-300 text-xl"></i>
                  </div>
                  <div className="flex-1">
                    ...
                    <div className="space-y-2 mb-4">
                      ...
                      <div className="flex items-center gap-2 text-white/70 text-xs">
                        <i className="ri-map-2-line text-cyan-400 flex-shrink-0"></i>
          ...
          <div className="mt-6 bg-rose-500/10 backdrop-blur-sm border border-rose-400/30 rounded-xl p-4">
            ...
            <p className="text-white/90 text-sm leading-relaxed text-center mb-4">
              Esta página reúne opções de transporte individual em Urubici, incluindo táxis tradicionais 
              e motoristas por aplicativo que atendem a cidade e região.
            </p>
            <p className="text-white/80 text-sm leading-relaxed text-center mb-4">
              ...
              horários de disponibilidade e áreas de cobertura de cada serviço.
            </p>
