...
export const useEstablishments = () => {
    ...
    useEffect(() => {
        const fetchEstablishments = async () => {
            try {
                console.log('🚀 INÍCIO - Buscando serviços de transporte...');
                ...
                const apiUrl = `${baseUrl}/functions/v1/public-services-api?subcategory=transporte-passageiros&city=Urubici`;
