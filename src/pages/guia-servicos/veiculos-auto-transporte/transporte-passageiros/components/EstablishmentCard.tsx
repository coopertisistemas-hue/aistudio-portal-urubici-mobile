            ...
            <div className="flex gap-4">
                <div className="w-20 h-20 rounded-xl overflow-hidden bg-white/20 flex-shrink-0">
                    {establishment.image_url ? (
                        ...
                        <div className="w-full h-full flex items-center justify-center bg-amber-500/10">
                            <i className="ri-car-fill text-3xl text-amber-400" />
                        </div>
                    )}
                </div>
                ...
                <div className="flex-1">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                        <a
                            href={establishment.whatsapp || establishment.phone ? `https://wa.me/${(establishment.whatsapp || establishment.phone)?.replace(/\D/g, '')}?text=Olá! Gostaria de um transporte.` : '#'}
                            ...
                            title={establishment.whatsapp || establishment.phone ? 'Chamar no WhatsApp' : 'WhatsApp não disponível'}
                        >
                        ...
                        <button
                            ...
                            title="Em breve"
                        >
                            <i className="ri-map-2-line text-base" />
                            <span>Rota</span>
                        </button>
