        ...
        <div className="w-full mb-6">
            <div className="px-4 mb-4">
                ...
                <p className="text-white/70 text-xs text-center mt-1">
                    Motoristas e empresas de confiança
                </p>
            </div>
                        ...
                        <div key={index} className="flex-shrink-0 w-64 mx-2 text-left">
                            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20 shadow-lg hover:bg-white/15 hover:scale-105 transition-all duration-300 cursor-pointer h-full">
                                <div className="flex flex-col items-center text-center h-full">
                                    ...
                                    <div className="mt-auto inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-amber-500 to-amber-700 hover:from-amber-600 hover:to-amber-800 rounded-lg text-white text-xs font-medium transition-all duration-200">
                                        <span>Contatar</span>
