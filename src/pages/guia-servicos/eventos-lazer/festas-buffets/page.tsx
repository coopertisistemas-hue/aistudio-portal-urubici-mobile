...
const FEATURED_ADS = [
  {
    title: "Buffet Festa Perfeita",
    subtitle: "Transformamos seu evento em momentos inesquecíveis",
    image: "https://readdy.ai/api/search-image?query=Elegant%20party%20buffet%20setup%20in%20Urubici%20Santa%20Catarina%20Brazil%20with%20beautiful%20table%20decorations%2C%20gourmet%20food%20displays%2C%20festive%20atmosphere%20and%20professional%20catering%20service%20in%20mountain%20setting&width=300&height=200&seq=buffet1&orientation=landscape",
    link: "#",
    isAd: true
  },
  {
    title: "Espaço Celebrar",
    subtitle: "Estrutura completa para festas e eventos especiais",
    image: "https://readdy.ai/api/search-image?query=Modern%20event%20venue%20in%20Urubici%20Santa%20Catarina%20Brazil%20with%20party%20decorations%2C%20elegant%20setup%2C%20celebration%20space%20and%20professional%20event%20services%20in%20mountain%20region&width=300&height=200&seq=buffet2&orientation=landscape",
    link: "#",
    isAd: true
  }
];
...
export default function FestasBuffets() {
  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className="relative z-10 max-w-md mx-auto">
        ...
        <div className="px-4 mb-6">
          <div className="text-center">
            <h2 className="text-white font-bold text-xl mb-2 flex items-center justify-center gap-2">
              <i className="ri-cake-3-line text-pink-400" />
              Festas e Buffets
              <i className="ri-cake-3-line text-pink-400" />
            </h2>
            <p className="text-white/70 text-sm">Celebre momentos especiais com os melhores serviços de Urubici</p>
          </div>
        </div>
        ...
        <div className="px-4 mb-6">
          {loading ? (
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg text-center mb-4">
              <i className="ri-information-line text-pink-400 text-4xl mb-3" />
              <h4 className="text-white font-bold text-lg mb-2">Ainda não há estabelecimentos cadastrados</h4>
              <p className="text-white/80 text-sm leading-relaxed">
                Estamos atualizando nossa base de dados. Em breve você encontrará os melhores serviços de festas e buffets de Urubici aqui!
              </p>
            </div>
          ) : (
            <>
        ...
        <button
          onClick={scrollToTop}
          className="fixed bottom-6 left-6 z-50 w-14 h-14 bg-gradient-to-br from-pink-500 to-pink-600 hover:from-pink-600 hover:to-pink-700 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center backdrop-blur-sm border border-pink-400/30 hover:scale-110 group"
