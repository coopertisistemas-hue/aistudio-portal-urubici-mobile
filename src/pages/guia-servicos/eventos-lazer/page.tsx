...
export default function EventosLazer() {
  ...
  const featuredAds = [
    {
      title: "Buffet Festa Serra",
      subtitle: "Buffet completo para eventos sociais",
      image: "https://readdy.ai/api/search-image?query=Professional%20event%20buffet%20catering%20service%20setup%20in%20Urubici%20Santa%20Catarina%20Brazil%2C%20elegant%20party%20food%20display%2C%20social%20celebration%20buffet%20with%20mountain%20setting%20simple%20background&width=300&height=200&seq=buffet1&orientation=landscape",
      link: "#",
      isAd: true
    },
    {
      title: "Salão de Festas Urubici",
      subtitle: "Espaço para eventos e celebrações",
      image: "https://readdy.ai/api/search-image?query=Modern%20event%20hall%20party%20venue%20interior%20in%20Urubici%20Santa%20Catarina%20Brazil%2C%20celebration%20space%2C%20social%20event%20facility%20with%20elegant%20decoration%20simple%20background&width=300&height=200&seq=hall1&orientation=landscape",
      link: "#",
      isAd: true
    },
    {
      title: "Decoração & Eventos Serra",
      subtitle: "Decoração personalizada para festas",
      image: "https://readdy.ai/api/search-image?query=Event%20decoration%20party%20setup%20service%20in%20Urubici%20Santa%20Catarina%20Brazil%2C%20festive%20decorations%2C%20celebration%20styling%20with%20elegant%20design%20simple%20background&width=300&height=200&seq=decor1&orientation=landscape",
      link: "#",
      isAd: true
    }
  ];
  ...
  const subcategories = [
    {
      title: "Organização de Festas e Buffets",
      description: "Buffets, decoração, cerimonial e serviços para eventos sociais e corporativos.",
      icon: "ri-cake-3-line",
      color: "cyan",
      link: "/guia-servicos/eventos-lazer/festas-buffets"
    }
  ];
        ...
        <div className="px-4 mb-6">
          <div className="text-center">
            <h2 className="text-white font-bold text-xl mb-2 flex items-center justify-center gap-2">
              <i className="ri-calendar-event-line text-fuchsia-400"></i>
              Eventos & Lazer (Não Turístico)
              <i className="ri-calendar-event-line text-fuchsia-400"></i>
            </h2>
            <p className="text-white/70 text-sm">Organização de festas, buffets e eventos em Urubici.</p>
          </div>
        </div>
        ...
        <div className="px-4 mb-6">
          <div className="mb-4">
            <h3 className="text-white font-bold text-sm uppercase tracking-wider text-center flex items-center justify-center gap-2">
              <i className="ri-cake-3-line text-cyan-400"></i>
              Subcategorias
              <i className="ri-cake-3-line text-cyan-400"></i>
            </h3>
            <p className="text-white/70 text-xs text-center mt-1">Explore os serviços para eventos</p>
          </div>
        ...
        <div className="px-4 mb-6">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg">
            ...
            <p className="text-white/90 text-sm leading-relaxed text-center mb-4">
              Esta categoria reúne serviços para eventos e lazer local que não entram como atração turística. 
              Aqui você encontra buffets, salões de festa, decoração, cerimonial e outros serviços 
              para celebrações sociais e corporativas em Urubici.
            </p>
            <p className="text-white/80 text-sm leading-relaxed text-center mb-4">
              Em breve, esta página apresentará uma lista completa de todos os prestadores de serviços 
              para eventos da cidade, com informações de contato, portfólio e especialidades.
            </p>
