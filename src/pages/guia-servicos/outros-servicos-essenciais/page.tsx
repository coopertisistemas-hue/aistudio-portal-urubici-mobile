...
export default function OutrosServicosEssenciais() {
  ...
  const featuredAds = [
    {
      ...
      subtitle: "Óculos, lentes e exames de vista",
      image: "https://readdy.ai/api/search-image?query=Modern%20optical%20store%20eyewear%20shop%20in%20Urubici%20Santa%20Catarina%20Brazil%2C%20glasses%20retail%20store%2C%20professional%20optician%20facility%20with%20mountain%20town%20setting&width=300&height=200&seq=optic1&orientation=landscape",
      link: "#",
      isAd: true
    },
    {
      title: "Joalheria Serra",
      subtitle: "Joias, relógios e consertos",
      image: "https://readdy.ai/api/search-image?query=Elegant%20jewelry%20store%20boutique%20in%20Urubici%20Santa%20Catarina%20Brazil%2C%20watch%20and%20jewelry%20retail%20shop%2C%20luxury%20accessories%20store%20with%20professional%20display&width=300&height=200&seq=jewelry1&orientation=landscape",
      link: "#",
      isAd: true
    },
    {
      title: "Chaveiro Urubici",
      subtitle: "Cópias de chaves e carimbos",
      image: "https://readdy.ai/api/search-image?query=Professional%20locksmith%20key%20cutting%20shop%20in%20Urubici%20Santa%20Catarina%20Brazil%2C%20key%20duplication%20service%20store%2C%20hardware%20security%20facility%20with%20tools&width=300&height=200&seq=keys1&orientation=landscape",
      link: "#",
      isAd: true
    }
  ];
  ...
  const subcategories = [
    {
      title: "Óticas e Joalherias",
      description: "Lojas de óculos, lentes, relógios e joias.",
      icon: "ri-glasses-line",
      color: "cyan",
      link: "/guia-servicos/outros-servicos-essenciais/oticas-joalherias"
    },
    {
      title: "Chaveiros e Carimbos",
      description: "Cópias de chaves, consertos de fechaduras e confecção de carimbos.",
      icon: "ri-key-line",
      color: "cyan",
      link: "/guia-servicos/outros-servicos-essenciais/chaveiros-carimbos"
    }
  ];
      ...
      <div className="relative z-10 max-w-md mx-auto">
        ...
        <div className="px-4 mb-6">
          <div className="text-center">
            <h2 className="text-white font-bold text-xl mb-2 flex items-center justify-center gap-2">
              <i className="ri-service-line text-sky-400"></i>
              Outros Serviços Essenciais
              <i className="ri-service-line text-sky-400"></i>
            </h2>
            <p className="text-white/70 text-sm">Óticas, joalherias, chaveiros e outros serviços em Urubici.</p>
          </div>
        </div>
        ...
        <div className="px-4 mb-6">
          <div className="mb-4">
            ...
            <p className="text-white/70 text-xs text-center mt-1">Explore os diferentes tipos de serviços</p>
          </div>
        ...
        <div className="px-4 mb-6">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg">
            ...
            <p className="text-white/90 text-sm leading-relaxed text-center mb-4">
              Esta categoria reúne serviços importantes para o dia a dia que não se encaixam nas demais categorias. 
              Aqui você encontra óticas, joalherias, chaveiros e outros serviços essenciais para a comunidade de Urubici.
            </p>
            <p className="text-white/80 text-sm leading-relaxed text-center mb-4">
              Em breve, esta página apresentará uma lista completa de todos os estabelecimentos desta categoria, 
