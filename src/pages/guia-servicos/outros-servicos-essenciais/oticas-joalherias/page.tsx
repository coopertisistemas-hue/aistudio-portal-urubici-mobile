...
const FEATURED_ADS = [
  {
    title: "Ótica Visão Clara Urubici",
    subtitle: "Óculos de grau, sol e lentes de contato com as melhores marcas",
    image: "https://readdy.ai/api/search-image?query=Modern%20optical%20store%20interior%20in%20Urubici%20Santa%20Catarina%20Brazil%20with%20elegant%20eyeglasses%20display%20shelves%2C%20professional%20lighting%2C%20clean%20white%20background%2C%20minimalist%20design%2C%20high-end%20retail%20atmosphere%2C%20organized%20product%20displays%2C%20contemporary%20style&width=300&height=200&seq=optical1&orientation=landscape",
    link: "#",
    isAd: true
  },
  {
    title: "Joalheria Brilho da Serra",
    subtitle: "Joias exclusivas, alianças e relógios de qualidade",
    image: "https://readdy.ai/api/search-image?query=Luxury%20jewelry%20store%20showcase%20in%20Urubici%20Santa%20Catarina%20Brazil%20with%20gold%20and%20silver%20pieces%2C%20elegant%20rings%20and%20necklaces%2C%20professional%20jewelry%20display%2C%20clean%20white%20background%2C%20high-end%20accessories%2C%20sparkling%20gems&width=300&height=200&seq=jewelry1&orientation=landscape",
    link: "#",
    isAd: true
  }
];
...
export default function OticasJoalherias() {
        ...
        <div className="px-4 mb-6">
          <div className="text-center">
            <h2 className="text-white font-bold text-xl mb-2 flex items-center justify-center gap-2">
              <i className="ri-glasses-2-line text-teal-400" />
              Óticas e Joalherias em Urubici
              <i className="ri-vip-diamond-line text-teal-400" />
            </h2>
            <p className="text-white/70 text-sm">Encontre óculos de grau, óculos de sol, lentes de contato, joias e relógios, com atendimento especializado na Serra Catarinense</p>
          </div>
        </div>
          ...
          {loading ? (
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg text-center mb-4">
              ...
              <p className="text-white/80 text-sm leading-relaxed">
                Estamos atualizando nossa base de dados. Em breve você encontrará as melhores óticas e joalherias de Urubici aqui!
              </p>
            </div>
          ) : (
            <>
