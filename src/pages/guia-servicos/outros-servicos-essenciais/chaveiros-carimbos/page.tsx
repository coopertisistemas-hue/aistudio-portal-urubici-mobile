...
const FEATURED_ADS = [
  {
    title: "Chaveiro 24 Horas Urubici",
    subtitle: "Atendimento rápido e confiável",
    image: "https://readdy.ai/api/search-image?query=Professional%20locksmith%20service%20in%20Urubici%20Santa%20Catarina%20Brazil%20with%20keys%2C%20locks%20and%20security%20tools%20in%20mountain%20town%20setting&width=300&height=200&seq=locksmith1&orientation=landscape",
    link: "#",
    isAd: true
  },
  {
    title: "Carimbos Personalizados",
    subtitle: "Qualidade e rapidez na entrega",
    image: "https://readdy.ai/api/search-image?query=Custom%20stamp%20and%20seal%20service%20in%20Urubici%20Santa%20Catarina%20Brazil%20with%20professional%20rubber%20stamps%20and%20personalized%20designs&width=300&height=200&seq=locksmith2&orientation=landscape",
    link: "#",
    isAd: true
  }
];
...
export default function ChaveirosCarimbosPage() {
        ...
        <div className="px-4 mb-6">
          <div className="text-center">
            <h2 className="text-white font-bold text-xl mb-2 flex items-center justify-center gap-2">
              <i className="ri-key-2-line text-amber-400" />
              Chaveiros e Carimbos
              <i className="ri-key-2-line text-amber-400" />
            </h2>
            <p className="text-white/70 text-sm">Soluções rápidas e confiáveis para suas necessidades em Urubici</p>
          </div>
        </div>
          ...
          {loading ? (
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg text-center mb-4">
              ...
              <p className="text-white/80 text-sm leading-relaxed">
                Estamos atualizando nossa base de dados. Em breve você encontrará os melhores chaveiros e serviços de carimbos de Urubici aqui!
              </p>
            </div>
          ) : (
            <>
