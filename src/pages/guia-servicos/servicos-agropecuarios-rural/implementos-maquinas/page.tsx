...
const FEATURED_ADS = [
  {
    ...
    subtitle: "Tratores, colheitadeiras e implementos de todas as marcas",
    image: "https://readdy.ai/api/search-image?query=Modern%20agricultural%20machinery%20store%20in%20Urubici%20Santa%20Catarina%20Brazil%20with%20tractors%2C%20farm%20equipment%20and%20implements%2C%20professional%20service%20in%20mountain%20region&width=300&height=200&seq=machinery1&orientation=landscape",
    link: "#",
    isAd: true
  },
  {
    title: "Implementos do Campo",
    subtitle: "Equipamentos para preparo de solo e plantio",
    image: "https://readdy.ai/api/search-image?query=Agricultural%20implements%20store%20in%20Urubici%20Santa%20Catarina%20Brazil%20with%20plows%2C%20seeders%2C%20sprayers%20and%20farm%20equipment%2C%20quality%20products%20in%20mountain%20area&width=300&height=200&seq=machinery2&orientation=landscape",
    link: "#",
    isAd: true
  }
];
...
export default function ImplementosMaquinasPage() {
        ...
        <div className="px-4 mb-6">
          <div className="text-center">
            <h2 className="text-white font-bold text-xl mb-2 flex items-center justify-center gap-2">
              <i className="ri-tractor-line text-teal-400" />
              Implementos e Máquinas Agrícolas
              <i className="ri-tractor-line text-teal-400" />
            </h2>
            <p className="text-white/70 text-sm">Equipamentos e máquinas para o campo em Urubici</p>
          </div>
        </div>
          ...
          {loading ? (
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg text-center mb-4">
              ...
              <p className="text-white/80 text-sm leading-relaxed">
                Estamos atualizando nossa base de dados. Em breve você encontrará as melhores empresas de implementos e máquinas agrícolas de Urubici aqui!
              </p>
            </div>
          ) : (
            <>
