      ...
      <div className="flex gap-4">
        <div className="w-20 h-20 rounded-xl overflow-hidden bg-white/20 flex-shrink-0">
          <img
            ...
            src={`https://readdy.ai/api/search-image?query=$%7BencodeURIComponent%28%60$%7Bestablishment.name%7D%20agricultural%20machinery%20equipment%20store%20in%20Urubici%20Santa%20Catarina%20Brazil%20with%20tractors%20and%20farm%20implements%60%29%7D&width=200&height=200&seq=${establishment.id}&orientation=squarish`}
          />
        </div>
        ...
        <div className="flex-1">
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <button
              disabled
              className="inline-flex items-center justify-center gap-2 px-3 py-2.5 bg-slate-500/50 cursor-not-allowed rounded-lg text-white text-xs font-medium opacity-50 whitespace-nowrap min-h-[44px]"
              title="Em breve"
            >
