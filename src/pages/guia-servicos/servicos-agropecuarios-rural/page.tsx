...
export default function ServicosAgropecuariosRuralPage() {
  ...
  const featuredAds = [
    {
      ...
      subtitle: 'Rações, insumos e produtos para o campo',
      image: 'https://readdy.ai/api/search-image?query=modern%20agricultural%20supply%20store%20with%20feed%20bags%20fertilizers%20and%20farming%20products%20in%20a%20bright%20organized%20retail%20space%20in%20mountain%20region%20rural%20setting&width=300&height=200&seq=agro1&orientation=landscape',
      link: '#',
      isAd: true
    },
    {
      title: 'Veterinária Rural Urubici',
      subtitle: 'Produtos e serviços veterinários para animais de produção',
      image: 'https://readdy.ai/api/search-image?query=veterinary%20clinic%20for%20farm%20animals%20with%20professional%20equipment%20and%20rural%20setting%20in%20mountain%20region%20clean%20modern%20facility&width=300&height=200&seq=agro2&orientation=landscape',
      link: '#',
      isAd: true
    },
    {
      title: 'Máquinas Agrícolas Serra',
      subtitle: 'Venda e locação de tratores e implementos',
      image: 'https://readdy.ai/api/search-image?query=agricultural%20machinery%20dealership%20with%20tractors%20and%20farm%20equipment%20displayed%20in%20mountain%20region%20rural%20setting%20professional%20showroom&width=300&height=200&seq=agro3&orientation=landscape',
      link: '#',
      isAd: true
    }
  ];
  ...
  const subcategories = [
    {
      title: 'Agropecuárias e Veterinárias',
      description: 'Lojas de rações, insumos, produtos agropecuários e serviços veterinários não médicos',
      icon: 'ri-plant-line',
      color: 'cyan',
      link: '/guia-servicos/servicos-agropecuarios-rural/agropecuaria-veterinaria'
    },
    {
      title: 'Implementos e Máquinas',
      description: 'Venda e locação de tratores, equipamentos e máquinas agrícolas',
      icon: 'ri-truck-line',
      color: 'cyan',
      link: '/guia-servicos/servicos-agropecuarios-rural/implementos-maquinas'
    }
  ];
        ...
        <div className="px-4 mb-6">
          <div className="text-center">
            <h2 className="text-white font-bold text-xl mb-2 flex items-center justify-center gap-2">
              <i className="ri-plant-line text-lime-400"></i>
              Serviços Agropecuários & Rural
              <i className="ri-plant-line text-lime-400"></i>
            </h2>
            <p className="text-white/70 text-sm">Agropecuária, veterinária e implementos agrícolas em Urubici.</p>
          </div>
        </div>
        ...
        <div className="px-4 mb-6">
          <div className="mb-4">
            <h3 className="text-white font-bold text-sm uppercase tracking-wider text-center flex items-center justify-center gap-2">
              <i className="ri-store-line text-cyan-400"></i>
              Subcategorias
              <i className="ri-store-line text-cyan-400"></i>
            </h3>
            <p className="text-white/70 text-xs text-center mt-1">Explore os diferentes serviços agropecuários</p>
          </div>
          <div className="grid grid-cols-2 gap-3">
            {subcategories.map((subcategory, index) => (
              <button
                key={index}
                onClick={() => subcategory.link && navigate(subcategory.link)}
              ...
              >
                ...
                >
                  <i className={`${subcategory.icon} text-white text-xl`}></i>
                </div>
        ...
        <div className="px-4 mb-6">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg">
            ...
            <p className="text-white/90 text-sm leading-relaxed text-center mb-4">
              A categoria <strong>Serviços Agropecuários & Rural</strong> reúne negócios e serviços essenciais para o produtor rural, agricultura, pecuária e vida no campo em Urubici e região.
            </p>
            <p className="text-white/80 text-sm leading-relaxed text-center mb-4">
              Aqui você encontra agropecuárias com rações, insumos agrícolas, fertilizantes e produtos veterinários, além de serviços especializados para animais de produção. Também estão disponíveis empresas que comercializam e locam tratores, implementos agrícolas e máquinas para o campo.
            </p>
            <p className="text-white/80 text-sm leading-relaxed text-center mb-4">
              Seja você um pequeno produtor, agricultor familiar ou proprietário de fazenda, esta seção conecta você aos fornecedores e prestadores de serviços que apoiam o desenvolvimento do agronegócio e da vida rural na Serra Catarinense.
            </p>
