...
export default function LavanderiaCosturaPage() {
  ...
  const establishments = [
    {
      name: "Lavanderia Serra Limpa",
      description: "Lavagem e passadoria de roupas, edredons e cortinas com entrega em domicílio",
    ...
    {
      name: "Ateliê de Costura Ana Maria",
      description: "Ajustes, consertos e customização de roupas com atendimento personalizado",
    ...
    {
      name: "Lavanderia Express Urubici",
      description: "Serviço rápido de lavagem, secagem e passadoria para residências e hotéis",
      address: "Av. Nereu Ramos, 890 - Centro",
      city: "Urubici – SC",
      phone: "(49) 3278-3456",
      whatsapp: "5549932783456"
    },
    {
      name: "Costura & Ajustes Montanha",
      description: "Especializada em ajustes de roupas sociais, vestidos de festa e uniformes",
      address: "Rua Hercílio Luz, 345 - Centro",
      city: "Urubici – SC",
      phone: "(49) 3278-4567",
      whatsapp: "5549932784567"
    },
    {
      name: "Lavanderia e Costura Família",
      description: "Lavagem de roupas delicadas, peças finas e serviços de costura em geral",
      address: "Rua das Flores, 678 - Santa Terezinha",
      city: "Urubici – SC",
      phone: "(49) 3278-5678",
      whatsapp: "5549932785678"
    },
    {
      name: "Ateliê Costura Criativa",
      description: "Confecção sob medida, reformas e customização de peças de vestuário",
      address: "Rua Getúlio Vargas, 123 - Centro",
      city: "Urubici – SC",
      phone: "(49) 3278-6789",
      whatsapp: "5549932786789"
    },
    {
      name: "Lavanderia Self-Service Serra",
      description: "Lavanderia automática com máquinas de alta capacidade e secadoras",
      address: "Av. Aristiliano Ramos, 456 - Centro",
      city: "Urubici – SC",
      phone: "(49) 3278-7890",
      whatsapp: "5549932787890"
    },
    {
      name: "Costura Rápida Urubici",
      description: "Consertos emergenciais, bainhas, zíperes e pequenos ajustes no mesmo dia",
      address: "Rua Barão do Rio Branco, 789 - Centro",
      city: "Urubici – SC",
      phone: "(49) 3278-8901",
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative h-48 overflow-hidden">
        ...
        <div className="relative z-20 h-full flex flex-col justify-center max-w-md mx-auto px-4">
          <div className="flex items-center gap-3 mb-2">
            <div className="w-10 h-10 rounded-full bg-teal-500/20 backdrop-blur-sm flex items-center justify-center border border-teal-400/30">
              <i className="ri-t-shirt-line text-xl text-teal-400"></i>
            </div>
            <h1 className="text-xl font-bold text-teal-400">Lavanderia e Costura em Urubici</h1>
          </div>
          <p className="text-sm text-white/90 ml-[52px]">Lavanderias, tinturarias e serviços de costura.</p>
        </div>
      </section>
      ...
      <nav className="max-w-md mx-auto px-4 py-3 text-xs">
        <div className="flex items-center gap-2 text-white/60">
          <button onClick={() => navigate('/')} className="hover:text-teal-400 transition-colors">
            Home
          </button>
          <i className="ri-arrow-right-s-line text-xs"></i>
          <button onClick={() => navigate('/guia-servicos')} className="hover:text-teal-400 transition-colors">
            Guia de Serviços
          </button>
          <i className="ri-arrow-right-s-line text-xs"></i>
          <button onClick={() => navigate('/guia-servicos/servicos-domesticos-limpeza')} className="hover:text-teal-400 transition-colors">
            Serviços Domésticos & Limpeza
          </button>
          <i className="ri-arrow-right-s-line text-xs"></i>
          <span className="text-teal-400 font-medium">Lavanderia e Costura</span>
        </div>
      </nav>
      ...
      <section className="max-w-md mx-auto px-4 py-6">
        <div className="flex items-center gap-2 mb-4">
          <div className="w-8 h-8 rounded-full bg-teal-500/20 flex items-center justify-center">
            <i className="ri-store-2-line text-teal-400"></i>
          </div>
          <h2 className="text-lg font-semibold text-teal-400">Estabelecimentos</h2>
        </div>
            ...
            >
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 bg-cyan-500/30 rounded-full flex items-center justify-center flex-shrink-0 border border-cyan-400/40">
                  <i className="ri-shirt-line text-cyan-300 text-xl"></i>
                </div>
                <div className="flex-1">
                  ...
                  <div className="flex gap-2 mt-3">
                    <a
                      ...
                      className="flex-1 bg-teal-500 hover:bg-teal-600 text-white text-xs font-medium py-2 px-3 rounded-lg transition-colors flex items-center justify-center gap-1.5"
                    >
                      <i className="ri-whatsapp-line text-sm"></i>
                      WhatsApp
                    </a>
                    <button className="flex-1 bg-white/10 hover:bg-white/20 text-white text-xs font-medium py-2 px-3 rounded-lg transition-colors flex items-center justify-center gap-1.5 border border-teal-400/30">
                      <i className="ri-map-pin-line text-sm text-teal-400"></i>
                      Ver Localização
                    </button>
                  </div>
                </div>
        ...
        {/* Info Badge */}
        <div className="mt-6 bg-teal-500/10 backdrop-blur-sm border border-teal-400/30 rounded-xl p-4">
          ...
          <p className="text-white/90 text-sm leading-relaxed text-center mb-4">
            Esta página reúne os principais serviços de lavanderia e costura de Urubici, 
            facilitando sua busca por profissionais para cuidar das suas roupas e peças de vestuário.
          </p>
