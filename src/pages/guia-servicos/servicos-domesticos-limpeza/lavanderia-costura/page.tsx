...
const FEATURED_ADS = [
    {
        ...
        subtitle: "Suas roupas limpas e cheirosas",
        image: "https://readdy.ai/api/search-image?query=Modern%20laundry%20service%20clean%20clothes%20Urubici&width=300&height=200&seq=laundry01&orientation=landscape",
        link: "#",
        isAd: true
    },
    {
        title: "Ateliê de Costura da Maria",
        subtitle: "Ajustes, reparos e confecção sob medida",
        image: "https://readdy.ai/api/search-image?query=Sewing%20atelier%20tailor%20working%20fabric%20Urubici&width=300&height=200&seq=sewing01&orientation=landscape",
        link: "#",
        isAd: true
    }
];
                ...
                <div className="px-4 mb-6">
                    <div className="text-center">
                        <h2 className="text-white font-bold text-xl mb-2 flex items-center justify-center gap-2">
                            <i className="ri-shirt-line text-rose-400" />
                            Lavanderia e Costura
                            <i className="ri-shirt-line text-rose-400" />
                        </h2>
                        <p className="text-white/70 text-sm">Lavanderias, tinturarias e ateliês de costura em Urubici</p>
                    </div>
                </div>
                    ...
                    {loading ? (
                        ...
                        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg text-center mb-4">
                            ...
                            <p className="text-white/80 text-sm leading-relaxed">
                                Estamos atualizando nossa base de dados. Em breve você encontrará as melhores lavanderias e costureiras de Urubici aqui!
                            </p>
                        </div>
                    ) : (
                        <>
