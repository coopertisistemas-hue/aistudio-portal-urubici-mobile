        ...
        <div className="w-full mb-6">
            ...
            <div className="relative overflow-hidden">
                ...
                >
                        ...
                        <div key={index} className="flex-shrink-0 w-64 mx-2">
                            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20 shadow-lg hover:bg-white/15 hover:scale-105 transition-all duration-300 cursor-pointer h-full">
                                <div className="flex flex-col items-center text-center h-full">
                                    ...
                                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-emerald-600 to-emerald-700 hover:from-emerald-700 hover:to-emerald-800 rounded-lg text-white text-xs font-medium transition-all duration-200 hover:scale-105 mt-auto whitespace-nowrap">
                    ...
                    {/* Render duplicates for infinite effect (simplified) */}
                ...
                <div className="flex justify-center mt-4 space-x-2">
                    {partners.map((_, dotIndex) => (
                        <button
                            ...
                            className={`h-1.5 rounded-full transition-all duration-300 ${currentSlide === dotIndex ? 'bg-white w-6' : 'bg-white/40 hover:bg-white/60 w-1.5'
                                }`}
