...
export default function LimpezaJardinagemPage() {
  ...
  const establishments = [
    {
      name: "Limpeza Total Urubici",
      description: "Faxina residencial e comercial, limpeza pós-obra e limpeza pesada",
      area: "Atende Urubici e região",
      phone: "(49) 3278-1234",
      whatsapp: "5549932781234"
    },
    {
      name: "Jardins da Serra",
      description: "Jardinagem, paisagismo, poda de árvores e manutenção de jardins",
      area: "Atende Urubici e região",
      phone: "(49) 3278-2345",
      whatsapp: "5549932782345"
    },
    {
      name: "Clean House Montanha",
      description: "Limpeza residencial completa, passadeira e organização de ambientes",
      area: "Atende Urubici e região",
      phone: "(49) 3278-3456",
    ...
    },
    {
      ...
      description: "Manutenção de jardins, gramados, podas e adubação de plantas",
      area: "Atende Urubici e região",
      phone: "(49) 3278-4567",
      whatsapp: "5549932784567"
    },
    {
      name: "Limpeza Express Serra",
      description: "Limpeza rápida para eventos, condomínios e empresas",
      area: "Atende Urubici e região",
      phone: "(49) 3278-5678",
      whatsapp: "5549932785678"
    },
    {
      name: "Jardineiro Profissional",
      description: "Serviços de jardinagem, irrigação automática e paisagismo",
      area: "Atende Urubici e região",
      phone: "(49) 3278-6789",
    ...
    {
      name: "Faxina & Cia",
      description: "Faxina completa, limpeza de vidros, cortinas e estofados",
      area: "Atende Urubici e região",
      phone: "(49) 3278-7890",
      whatsapp: "5549932787890"
    },
    {
      name: "Jardim Perfeito Urubici",
      description: "Criação e manutenção de jardins, hortas e áreas verdes",
      area: "Atende Urubici e região",
      phone: "(49) 3278-8901",
    ...
    <div className="min-h-screen bg-black text-white">
        ...
        <div className="relative z-20 h-full flex flex-col justify-center max-w-md mx-auto px-4">
          <div className="flex items-center gap-3 mb-2">
            <div className="w-10 h-10 rounded-full bg-teal-500/20 backdrop-blur-sm flex items-center justify-center border border-teal-400/30">
              <i className="ri-plant-line text-xl text-teal-400"></i>
            </div>
            <h1 className="text-xl font-bold text-teal-400">Limpeza e Jardinagem em Urubici</h1>
          </div>
          <p className="text-sm text-white/90 ml-[52px]">Serviços de limpeza residencial, comercial e jardinagem.</p>
        </div>
      </section>
      ...
      <nav className="max-w-md mx-auto px-4 py-3 text-xs">
        <div className="flex items-center gap-2 text-white/60">
          ...
          <i className="ri-arrow-right-s-line text-xs"></i>
          <span className="text-teal-400 font-medium">Limpeza e Jardinagem</span>
        </div>
      </nav>
      ...
      <section className="max-w-md mx-auto px-4 py-6">
            ...
            >
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 bg-cyan-500/30 rounded-full flex items-center justify-center flex-shrink-0 border border-cyan-400/40">
                  <i className="ri-plant-line text-cyan-300 text-xl"></i>
                </div>
                <div className="flex-1">
                  ...
                  <div className="space-y-2 mb-4">
                    <div className="flex items-center gap-2 text-white/70 text-xs">
                      <i className="ri-map-pin-line text-cyan-400 flex-shrink-0"></i>
        ...
        <div className="mt-6 bg-teal-500/10 backdrop-blur-sm border border-teal-400/30 rounded-xl p-4">
          ...
          <p className="text-white/90 text-sm leading-relaxed text-center mb-4">
            Esta página reúne os principais serviços de limpeza e jardinagem de Urubici, 
            facilitando sua busca por profissionais para cuidar da sua casa, condomínio ou empresa.
          </p>
