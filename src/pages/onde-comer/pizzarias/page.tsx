...
export default function Pizzarias() {
  ...
  const featuredAds = [
    {
      ...
      subtitle: "Pizzas artesanais com vista para a serra",
      image: "https://readdy.ai/api/search-image?query=Artisanal%20pizzeria%20Pizzaria%20Bella%20Vista%20in%20Urubici%20Santa%20Catarina%20Brazil%20with%20mountain%20views%2C%20wood-fired%20oven%2C%20cozy%20atmosphere%2C%20traditional%20Italian%20pizza&width=300&height=200&seq=bella_vista&orientation=landscape",
      link: "#",
      isAd: true
    },
    {
      title: "Pizza da Montanha",
      subtitle: "Sabores únicos da região serrana",
      image: "https://readdy.ai/api/search-image?query=Mountain%20pizzeria%20Pizza%20da%20Montanha%20in%20Urubici%20Santa%20Catarina%20Brazil%20with%20regional%20flavors%2C%20rustic%20decor%2C%20wood-fired%20pizza%2C%20mountain%20atmosphere&width=300&height=200&seq=pizza_montanha&orientation=landscape",
      link: "#",
      isAd: true
    }
  ];
  ...
  const partners = [
    ...
    {
      name: "Pizza da Montanha",
      description: "Sabores únicos da região serrana",
      image: "https://readdy.ai/api/search-image?query=Mountain%20pizza%20logo%20Pizza%20da%20Montanha%20Urubici%20Santa%20Catarina%20Brazil%2C%20regional%20pizza%20brand%20identity%2C%20mountain%20cuisine&width=100&height=100&seq=logo17&orientation=squarish"
    },
    {
      name: "Fornalha Pizzas",
      description: "Pizzas no forno à lenha tradicional",
      image: "https://readdy.ai/api/search-image?query=Wood-fired%20pizza%20logo%20Fornalha%20Pizzas%20Urubici%20Santa%20Catarina%20Brazil%2C%20traditional%20oven%20brand%20identity%2C%20artisanal%20pizza&width=100&height=100&seq=logo18&orientation=squarish"
    }
  ];

  // Dados das pizzarias organizados
  const estabelecimentosData = [
    {
      id: 1,
      nome: "Pizzaria Bella Vista",
      categoria: "Pizzaria",
      descricao: "Pizzas artesanais assadas em forno à lenha com vista panorâmica para as montanhas. Massa tradicional italiana e ingredientes frescos.",
      whatsapp: "5548999887766",
      avaliacao: 4.7,
      imagem: "https://readdy.ai/api/search-image?query=Artisanal%20pizzeria%20Bella%20Vista%20with%20wood-fired%20oven%2C%20panoramic%20mountain%20views%2C%20traditional%20Italian%20dough%2C%20fresh%20ingredients&width=200&height=200&seq=bella_vista_card&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Pizzaria%20Bella%20Vista%20Urubici%20SC",
      tags: [
        { label: "Forno à Lenha", type: "amenity", color: "red" },
        { label: "Vista Panorâmica", type: "location", color: "cyan" },
        { label: "Massa Italiana", type: "amenity", color: "red" }
      ]
    },
    {
      id: 2,
      nome: "Pizza da Montanha",
      categoria: "Pizzaria",
      descricao: "Pizzas com sabores únicos da região serrana, ingredientes locais e ambiente aconchegante. Especialidade em pizzas doces.",
      whatsapp: "5548988776655",
      avaliacao: 4.6,
      imagem: "https://readdy.ai/api/search-image?query=Mountain%20pizzeria%20Pizza%20da%20Montanha%20with%20unique%20regional%20flavors%2C%20local%20ingredients%2C%20cozy%20atmosphere%2C%20sweet%20pizzas%20specialty&width=200&height=200&seq=pizza_montanha_card&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Pizza%20da%20Montanha%20Urubici%20SC",
      tags: [
        { label: "Sabores Regionais", type: "amenity", color: "red" },
        { label: "Ingredientes Locais", type: "feature", color: "green" },
        { label: "Pizzas Doces", type: "amenity", color: "pink" }
      ]
    },
    {
      id: 3,
      nome: "Fornalha Pizzas",
      categoria: "Pizzaria",
      descricao: "Pizzaria tradicional com forno à lenha, ambiente familiar e receitas clássicas. Atendimento rápido e preços acessíveis.",
      whatsapp: "5548977665544",
      avaliacao: 4.5,
      imagem: "https://readdy.ai/api/search-image?query=Traditional%20pizzeria%20Fornalha%20Pizzas%20with%20wood-fired%20oven%2C%20family%20atmosphere%2C%20classic%20recipes%2C%20quick%20service%2C%20affordable%20prices&width=200&height=200&seq=fornalha_pizzas&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Fornalha%20Pizzas%20Urubici%20SC",
      tags: [
        { label: "Receitas Clássicas", type: "amenity", color: "red" },
    ...
    },
    {
      ...
      nome: "Pizza & Cia",
      categoria: "Pizzaria",
      descricao: "Pizzaria moderna com variedade de sabores, delivery rápido e opções vegetarianas. Ambiente jovem e descontraído.",
      whatsapp: "5548966554433",
      avaliacao: 4.4,
      imagem: "https://readdy.ai/api/search-image?query=Modern%20pizzeria%20Pizza%20Cia%20with%20variety%20of%20flavors%2C%20fast%20delivery%2C%20vegetarian%20options%2C%20young%20relaxed%20atmosphere&width=200&height=200&seq=pizza_cia&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Pizza%20Cia%20Urubici%20SC",
      tags: [
        { label: "Variedade Sabores", type: "amenity", color: "red" },
        { label: "Delivery Rápido", type: "service", color: "blue" },
    ...
    },
    {
      ...
      categoria: "Pizzaria",
      descricao: "Localizada no centro da cidade, oferece pizzas tradicionais e especiais. Ambiente climatizado e estacionamento próprio.",
      whatsapp: "5548955443322",
      avaliacao: 4.3,
      imagem: "https://readdy.ai/api/search-image?query=Central%20pizzeria%20Pizzaria%20Central%20downtown%20location%20with%20traditional%20and%20special%20pizzas%2C%20air%20conditioning%2C%20private%20parking&width=200&height=200&seq=pizzaria_central&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Pizzaria%20Central%20Urubici%20SC",
      tags: [
        { label: "Centro da Cidade", type: "location", color: "blue" },
        { label: "Ambiente Climatizado", type: "feature", color: "cyan" },
        { label: "Estacionamento", type: "feature", color: "blue" }
      ]
    }
  ];
  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className="relative z-10 max-w-md mx-auto">
        ...
        <div className="px-4 mb-6">
          <div className="text-center">
            <h2 className="text-white font-bold text-xl mb-2 flex items-center justify-center gap-2">
              <i className="ri-restaurant-2-line text-red-400"></i>
              Pizzarias
              <i className="ri-restaurant-2-line text-red-400"></i>
            </h2>
            <p className="text-white/70 text-sm">Pizzas artesanais e tradicionais da serra</p>
          </div>
        </div>
        ...
        <div className="px-4 mb-8">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20 shadow-lg">
            ...
            <div className="flex flex-wrap gap-2 justify-center">
              <button
                onClick={() => {
                  const element = document.getElementById('pizzarias-urubici');
        ...
        <div className="px-4 mb-6">
          ...
          >
            ...
            <p className="text-white/70 text-sm">
              {estabelecimentosData.length} {estabelecimentosData.length === 1 ? 'pizzaria disponível' : 'pizzarias disponíveis'}
            </p>
          </div>
        ...
        {/* Call to Action - Cadastre sua Pizzaria */}
        <div className="px-4 mb-6">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg text-center">
            <div className="mb-4">
              ...
              <h3 className="text-white font-bold text-lg mb-2">Cadastre sua Pizzaria</h3>
              <p className="text-white/80 text-sm leading-relaxed mb-4">
                Você possui pizzaria em Urubici? Cadastre-se em nossa plataforma!
              </p>
            </div>

            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <a
                href="https://wa.me/5551986859236?text=Olá! Gostaria de cadastrar minha pizzaria no Portal Urubici"
                target="_blank"
                rel="noopener noreferrer"
