...
export default function ChocolateriasGelaterias() {
  ...
  const featuredAds = [
    {
      title: "Chocolateria da Serra",
      subtitle: "Chocolates artesanais e gelatos especiais",
      image: "https://readdy.ai/api/search-image?query=Mountain%20chocolateria%20Chocolateria%20da%20Serra%20in%20Urubici%20Santa%20Catarina%20Brazil%20with%20artisanal%20chocolates%2C%20special%20gelatos%2C%20elegant%20display%2C%20mountain%20setting&width=300&height=200&seq=chocolateria1&orientation=landscape",
      link: "#",
      isAd: true
    },
    {
      title: "Gelateria Italiana",
      subtitle: "Autênticos gelatos italianos na serra",
      image: "https://readdy.ai/api/search-image?query=Italian%20gelateria%20Gelateria%20Italiana%20in%20Urubici%20Santa%20Catarina%20Brazil%20with%20authentic%20Italian%20gelato%2C%20traditional%20methods%2C%20colorful%20display%2C%20mountain%20location&width=300&height=200&seq=gelateria1&orientation=landscape",
      link: "#",
      isAd: true
    },
    {
      title: "Chocolate & Cia",
      subtitle: "Doces especiais e chocolates gourmet",
      image: "https://readdy.ai/api/search-image?query=Gourmet%20chocolate%20shop%20Chocolate%20Cia%20in%20Urubici%20Santa%20Catarina%20Brazil%20with%20special%20sweets%2C%20gourmet%20chocolates%2C%20premium%20products%2C%20elegant%20atmosphere&width=300&height=200&seq=chocolate1&orientation=landscape",
      link: "#",
      isAd: true
    }
  ];
  ...
  const partners = [
    {
      name: "Chocolateria da Serra",
      description: "Chocolates artesanais da serra",
      image: "https://readdy.ai/api/search-image?query=Mountain%20chocolateria%20logo%20Chocolateria%20da%20Serra%20Urubici%20Santa%20Catarina%20Brazil%2C%20artisanal%20chocolate%20brand%20identity%2C%20mountain%20sweets&width=100&height=100&seq=logo66&orientation=squarish"
    },
    {
      name: "Gelateria Italiana",
      description: "Gelatos autênticos italianos",
      image: "https://readdy.ai/api/search-image?query=Italian%20gelateria%20logo%20Gelateria%20Italiana%20Urubici%20Santa%20Catarina%20Brazil%2C%20authentic%20gelato%20brand%20identity%2C%20Italian%20tradition&width=100&height=100&seq=logo67&orientation=squarish"
    },
    {
      name: "Chocolate & Cia",
      description: "Chocolates gourmet e doces especiais",
      image: "https://readdy.ai/api/search-image?query=Gourmet%20chocolate%20logo%20Chocolate%20Cia%20Urubici%20Santa%20Catarina%20Brazil%2C%20premium%20chocolate%20brand%20identity%2C%20special%20sweets&width=100&height=100&seq=logo68&orientation=squarish"
    },
    {
      name: "Gelatos da Montanha",
      description: "Gelatos especiais da montanha",
      image: "https://readdy.ai/api/search-image?query=Mountain%20gelato%20logo%20Gelatos%20da%20Montanha%20Urubici%20Santa%20Catarina%20Brazil%2C%20mountain%20gelato%20brand%20identity%2C%20special%20flavors&width=100&height=100&seq=logo69&orientation=squarish"
    },
    {
      name: "Doce Chocolate",
      description: "Tradição em chocolates e doces",
      image: "https://readdy.ai/api/search-image?query=Sweet%20chocolate%20logo%20Doce%20Chocolate%20Urubici%20Santa%20Catarina%20Brazil%2C%20traditional%20chocolate%20brand%20identity%2C%20sweet%20treats&width=100&height=100&seq=logo70&orientation=squarish"
    }
  ];
  ...
  const establishments = [
    {
      id: 1,
      name: "Chocolateria Montanha Doce",
      image: "https://readdy.ai/api/search-image?query=elegant%20chocolate%20shop%20with%20artisanal%20chocolates%20display%20cases%20warm%20lighting%20mountain%20town%20setting&width=400&height=300&seq=1&orientation=landscape",
      rating: 4.8,
      reviews: 567,
      category: "Chocolateria Artesanal",
      specialties: ["Chocolates Artesanais", "Trufas Especiais", "Presentes Gourmet"],
      description: "Chocolateria artesanal com chocolates únicos e trufas especiais da casa.",
      whatsapp: "+5554999887766"
    },
    {
      id: 2,
      name: "Gelateria Italiana Bella Vista",
      image: "https://readdy.ai/api/search-image?query=authentic%20italian%20gelato%20shop%20with%20colorful%20gelato%20display%20modern%20interior%20mountain%20town%20setting&width=400&height=300&seq=2&orientation=landscape",
      rating: 4.9,
      reviews: 423,
      category: "Gelateria Italiana",
      specialties: ["Gelato Artesanal", "Sabores Únicos", "Receitas Italianas"],
      description: "Autêntica gelateria italiana com gelatos artesanais e sabores exclusivos.",
      whatsapp: "+5554999776655"
    },
    {
      id: 3,
      name: "Sorveteria Cremosa",
      image: "https://readdy.ai/api/search-image?query=modern%20ice%20cream%20parlor%20with%20colorful%20ice%20cream%20display%20family%20friendly%20atmosphere%20mountain%20setting&width=400&height=300&seq=3&orientation=landscape",
      rating: 4.6,
      reviews: 789,
      category: "Sorveteria",
      specialties: ["Sorvetes Cremosos", "Açaí Premium", "Ambiente Familiar"],
      description: "Sorveteria com sorvetes super cremosos e açaí premium em ambiente familiar.",
      whatsapp: "+5554999665544"
    },
    {
      id: 4,
      name: "Chocolates & Cia",
      image: "https://readdy.ai/api/search-image?query=boutique%20chocolate%20store%20with%20luxury%20chocolates%20gift%20boxes%20elegant%20interior%20mountain%20town%20setting&width=400&height=300&seq=4&orientation=landscape",
      rating: 4.7,
      reviews: 345,
      category: "Chocolates Finos",
      specialties: ["Chocolates Importados", "Presentes Exclusivos", "Degustação"],
      description: "Boutique de chocolates finos com seleção de chocolates importados e nacionais.",
      whatsapp: "+5554999554433"
    },
    {
      id: 5,
      name: "Gelato & Café",
      image: "https://readdy.ai/api/search-image?query=cozy%20gelato%20cafe%20with%20coffee%20bar%20dessert%20display%20comfortable%20seating%20mountain%20atmosphere&width=400&height=300&seq=5&orientation=landscape",
      rating: 4.5,
      reviews: 456,
      category: "Gelato & Café",
      specialties: ["Gelatos Artesanais", "Cafés Especiais", "Sobremesas"],
      description: "Combinação perfeita de gelatos artesanais com cafés especiais e sobremesas.",
  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className="relative z-10 max-w-md mx-auto">
        ...
        <div className="px-4 mb-6">
          <div className="text-center">
            <h2 className="text-white font-bold text-xl mb-2 flex items-center justify-center gap-2">
              <i className="ri-heart-3-line text-red-400"></i>
              Chocolaterias & Gelaterias
              <i className="ri-heart-3-line text-red-400"></i>
            </h2>
            <p className="text-white/70 text-sm">Chocolates artesanais e gelatos especiais da serra</p>
          </div>
        </div>
        ...
        {/* Call to Action */}
        <div className="px-4 mb-8">
          <div className="bg-gradient-to-br from-red-600/20 to-red-800/20 backdrop-blur-md rounded-2xl p-6 border border-red-400/30 text-center">
            <div className="w-16 h-16 bg-red-500/20 rounded-full flex items-center justify-center mx-auto mb-4">
              <i className="ri-heart-3-line text-red-400 text-2xl"></i>
            </div>
            <h3 className="text-white font-bold text-lg mb-2">Tem uma Chocolateria ou Gelateria?</h3>
            <p className="text-white/80 text-sm mb-4 leading-relaxed">
              Cadastre seu estabelecimento e apareça para milhares de pessoas que visitam Urubici
            </p>
            <button className="bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white px-6 py-3 rounded-xl font-semibold text-sm transition-all duration-200 hover:scale-105 shadow-lg whitespace-nowrap">
              Cadastrar
Estabelecimento
            </button>
          </div>
        ...
        <div className="w-full mb-6">
          <div className="px-4 mb-4">
            <h3 className="text-white font-bold text-sm uppercase tracking-wider text-center flex items-center justify-center gap-2">
              ...
              Parceiros Chocolaterias & Gelaterias
              <i className="ri-star-line text-yellow-400"></i>
            </h3>
            <p className="text-white/70 text-xs text-center mt-1">Conheça nossos parceiros especializados em chocolates e gelatos</p>
          </div>
