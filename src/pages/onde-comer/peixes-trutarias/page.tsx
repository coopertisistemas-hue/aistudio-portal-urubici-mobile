...
export default function PeixesTrutarias() {
  ...
  const featuredAds = [
    {
      title: "Truta & Cia Premium",
      subtitle: "Especialidade em trutas frescas da serra catarinense",
      image: "https://readdy.ai/api/search-image?query=Fresh%20trout%20restaurant%20Truta%20Cia%20in%20Urubici%20Santa%20Catarina%20Brazil%20with%20mountain%20stream%20setting%2C%20fresh%20fish%20display%2C%20rustic%20dining%20atmosphere%2C%20natural%20water%20features&width=300&height=200&seq=truta1&orientation=landscape",
      link: "#",
      isAd: true
    },
    {
      title: "Peixaria da Serra Gourmet",
      subtitle: "Peixes frescos e frutos do mar selecionados da região",
      image: "https://readdy.ai/api/search-image?query=Mountain%20fish%20restaurant%20Peixaria%20da%20Serra%20in%20Urubici%20Santa%20Catarina%20Brazil%20with%20fresh%20seafood%20display%2C%20mountain%20dining%2C%20aquatic%20themed%20decor%2C%20quality%20fish%20selection&width=300&height=200&seq=peixaria1&orientation=landscape",
      link: "#",
      isAd: true
    }
  ];
  ...
  const partners = [
    ...
    {
      name: "Peixaria da Serra",
      description: "Peixes frescos da serra catarinense",
      image: "https://readdy.ai/api/search-image?query=Mountain%20fish%20market%20logo%20Peixaria%20da%20Serra%20Urubici%20Santa%20Catarina%20Brazil%2C%20fresh%20seafood%20brand%20identity%2C%20mountain%20fish%20restaurant&width=100&height=100&seq=logo16&orientation=squarish"
    },
    {
      name: "Trutaria do Vale",
      description: "Trutas frescas com vista para o vale",
      image: "https://readdy.ai/api/search-image?query=Valley%20trout%20farm%20logo%20Trutaria%20do%20Vale%20Urubici%20Santa%20Catarina%20Brazil%2C%20trout%20farming%20brand%20identity%2C%20natural%20dining&width=100&height=100&seq=logo17&orientation=squarish"
    }
  ];

  // Dados das trutarias organizados
  const trutariasData = [
    {
      id: 1,
      nome: "Truta & Cia Premium",
      categoria: "Trutaria Especializada",
      descricao: "Especializada em trutas frescas criadas na própria propriedade. Ambiente rústico com vista para os tanques e preparos tradicionais.",
      whatsapp: "5548999887766",
      avaliacao: 4.9,
      imagem: "https://readdy.ai/api/search-image?query=Rustic%20trout%20restaurant%20interior%20Truta%20Cia%20with%20fresh%20fish%20tanks%2C%20mountain%20dining%20atmosphere%2C%20natural%20wood%20decor%2C%20trout%20specialties%20in%20Urubici%20Santa%20Catarina&width=200&height=200&seq=truta_cia&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Truta%20Cia%20Premium%20Urubici%20SC",
      tags: [
        { label: "Trutas Frescas", type: "amenity", color: "teal" },
        { label: "Criação Própria", type: "feature", color: "green" },
        { label: "Vista dos Tanques", type: "location", color: "blue" }
      ]
    },
    {
      id: 2,
      nome: "Peixaria da Serra Gourmet",
      categoria: "Peixes & Frutos do Mar",
      descricao: "Variedade de peixes frescos e frutos do mar selecionados. Preparos tradicionais e contemporâneos com ingredientes da região.",
      whatsapp: "5548999776655",
      avaliacao: 4.7,
      imagem: "https://readdy.ai/api/search-image?query=Fresh%20seafood%20restaurant%20Peixaria%20da%20Serra%20with%20fish%20display%2C%20mountain%20setting%2C%20quality%20seafood%20preparation%2C%20dining%20atmosphere%20in%20Urubici%20Santa%20Catarina&width=200&height=200&seq=peixaria_serra&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Peixaria%20da%20Serra%20Gourmet%20Urubici%20SC",
      tags: [
        { label: "Frutos do Mar", type: "amenity", color: "teal" },
        { label: "Peixes Frescos", type: "amenity", color: "blue" },
        { label: "Preparos Especiais", type: "feature", color: "purple" }
      ]
    },
    {
      id: 3,
      nome: "Trutaria do Vale Natural",
      categoria: "Trutaria com Vista",
      descricao: "Ambiente natural com vista panorâmica do vale. Trutas criadas em tanques naturais com água corrente da montanha.",
      whatsapp: "5548999665544",
      avaliacao: 4.8,
      imagem: "https://readdy.ai/api/search-image?query=Valley%20trout%20farm%20restaurant%20Trutaria%20do%20Vale%20with%20panoramic%20mountain%20views%2C%20natural%20trout%20ponds%2C%20outdoor%20dining%2C%20scenic%20location%20in%20Urubici%20Santa%20Catarina&width=200&height=200&seq=trutaria_vale&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Trutaria%20do%20Vale%20Natural%20Urubici%20SC",
      tags: [
        { label: "Vista Panorâmica", type: "location", color: "cyan" },
        { label: "Tanques Naturais", type: "feature", color: "green" },
        { label: "Água da Montanha", type: "feature", color: "blue" }
      ]
    },
    {
      id: 4,
      nome: "Pescados da Montanha",
      categoria: "Restaurante de Peixes",
      descricao: "Especializado em peixes de água doce e salgada. Ambiente familiar com preparos caseiros e receitas tradicionais da região.",
      whatsapp: "5548999554433",
      avaliacao: 4.6,
      imagem: "https://readdy.ai/api/search-image?query=Mountain%20fish%20restaurant%20Pescados%20da%20Montanha%20with%20family%20dining%20atmosphere%2C%20fresh%20fish%20preparation%2C%20homestyle%20cooking%20in%20Urubici%20Santa%20Catarina&width=200&height=200&seq=pescados_montanha&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Pescados%20da%20Montanha%20Urubici%20SC",
      tags: [
        { label: "Ambiente Familiar", type: "feature", color: "green" },
        { label: "Preparos Caseiros", type: "amenity", color: "orange" },
        { label: "Receitas Tradicionais", type: "feature", color: "amber" }
      ]
    },
    {
      id: 5,
      nome: "Aquário Restaurante",
      categoria: "Peixes Vivos",
      descricao: "Peixes vivos em aquários, preparados na hora. Experiência única de frescor e sabor com seleção diária dos melhores exemplares.",
      whatsapp: "5548999443322",
      avaliacao: 4.5,
      imagem: "https://readdy.ai/api/search-image?query=Live%20fish%20restaurant%20Aqu%C3%A1rio%20with%20fish%20tanks%2C%20fresh%20preparation%2C%20unique%20dining%20experience%2C%20aquarium%20themed%20decor%20in%20Urubici%20Santa%20Catarina&width=200&height=200&seq=aquario_restaurante&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Aquário%20Restaurante%20Urubici%20SC",
      tags: [
        { label: "Peixes Vivos", type: "amenity", color: "teal" },
        { label: "Preparo na Hora", type: "feature", color: "green" },
        { label: "Experiência Única", type: "feature", color: "purple" }
      ]
    }
  ];
  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className="relative z-10 max-w-md mx-auto">
                ...
                <div key={index} className="w-full flex-shrink-0 px-2">
                  <div className="relative overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 group cursor-pointer bg-white/10 backdrop-blur-md border border-white/20 rounded-3xl hover:bg-white/15 hover:scale-105">
                    ...
                    >
                      ...
                      <div className="p-6">
                        <h3 className="font-bold text-white text-xl mb-2 leading-tight group-hover:text-teal-200 transition-colors">
                          {ad.title}
                        </h3>
        ...
        <div className="px-4 mb-6">
          <div className="text-center">
            <h2 className="text-white font-bold text-xl mb-2 flex items-center justify-center gap-2">
              <i className="ri-water-flash-line text-teal-400"></i>
              Peixes & Trutarias
              <i className="ri-water-flash-line text-teal-400"></i>
            </h2>
            <p className="text-white/70 text-sm">Especialidades em peixes e frutos do mar da serra</p>
          </div>
        </div>
        ...
        <div className="px-4 mb-8">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20 shadow-lg">
            ...
            <div className="flex flex-wrap gap-2 justify-center">
              <button
                onClick={() => {
                  const element = document.getElementById('trutarias-em-urubici');
                  if (element) element.scrollIntoView({ behavior: 'smooth' });
                }}
                className="bg-teal-500/20 hover:bg-teal-400/30 hover:scale-105 active:scale-95 text-teal-200 font-medium px-4 py-2.5 rounded-full shadow-sm transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-teal-300/50 min-h-[44px] text-sm whitespace-nowrap"
              >
                Trutarias em Urubici
              </button>
            </div>
          </div>
        </div>
        ...
        <div className="px-4 mb-6">
          ...
          >
            ...
            <p className="text-white/70 text-sm">
              {trutariasData.length} {trutariasData.length === 1 ? 'trutaria disponível' : 'trutarias disponíveis'}
            </p>
          </div>

          <div className="space-y-4">
            {trutariasData.map((trutaria) => (
              <div key={trutaria.id} className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20 shadow-lg hover:bg-white/15 transition-all duration-300">
                <div className="flex gap-4">
                  ...
                  <div className="flex-1">
                    <div className="flex items-start justify-between mb-2">
                            ...
                            {trutaria.avaliacao ? (
                              <>
                                {[1, 2, 3, 4, 5].map((star) => (
                                  <i
                                    key={star}
                                    className={`${star <= Math.floor(trutaria.avaliacao) ? 'ri-star-fill' : star <= trutaria.avaliacao ? 'ri-star-half-fill' : 'ri-star-line'} text-yellow-400 text-sm`}
                                  ></i>
                                ))}
                                <span className="text-yellow-300 text-xs font-medium ml-1">
                                  {trutaria.avaliacao.toFixed(1)}
                                </span>
                              </>
                            ) : (
                              <>
                      ...
                      <div className="bg-teal-500/20 text-teal-200 border-teal-400/30 px-2 py-1 rounded-full text-xs font-medium">
                        {trutaria.categoria}
                      </div>
                    </div>
                    ...
                    <div className="flex flex-wrap gap-1 mb-3">
                      {trutaria.tags.map((tag, tagIndex) => {
                    ...
                    <div className="flex flex-col gap-2">
                      <div className="flex gap-2">
                        {trutaria.whatsapp ? (
                          <a
                            href={`https://wa.me/${trutaria.whatsapp.replace(/\\D/g, '')}?text=Olá! Gostaria de informações sobre ${trutaria.nome}`}
                            target="_blank"
                            rel="noopener noreferrer"
        ...
        {/* Call to Action - Cadastre sua Trutaria */}
        <div className="px-4 mb-6">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg text-center">
            <div className="mb-4">
              ...
              <h3 className="text-white font-bold text-lg mb-2">Cadastre sua Trutaria</h3>
              <p className="text-white/80 text-sm leading-relaxed mb-4">
                Você possui trutaria em Urubici? Cadastre-se em nossa plataforma!
              </p>
            </div>

            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <a
                href="https://wa.me/5551986859236?text=Olá! Gostaria de cadastrar minha trutaria no Portal Urubici"
                target="_blank"
                rel="noopener noreferrer"
              ...
              >
                ...
                <span>Cadastrar Trutaria</span>
              </a>
              <button
                onClick={() => navigate('/onde-comer')}
                className="inline-flex items-center gap-2 px-4 py-3 bg-teal-600 hover:bg-teal-700 rounded-lg text-white text-sm font-medium transition-all duration-200 hover:scale-105 whitespace-nowrap"
              >
        ...
        <div className="w-full mb-6">
          <div className="px-4 mb-4">
            ...
            <p className="text-white/70 text-xs text-center mt-1">
              Conheça nossos parceiros especializados em peixes
            </p>
          </div>
