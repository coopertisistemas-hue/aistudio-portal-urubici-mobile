...
export default function CafeColonial() {
  ...
  const featuredAds = [
    {
      title: "Colonial da Serra",
      subtitle: "Tradição colonial com produtos caseiros",
      image: "https://readdy.ai/api/search-image?query=Traditional%20colonial%20cafe%20Colonial%20da%20Serra%20in%20Urubici%20Santa%20Catarina%20Brazil%20with%20homemade%20products%2C%20colonial%20tradition%2C%20rustic%20atmosphere%2C%20mountain%20setting&width=300&height=200&seq=colonial_serra&orientation=landscape",
      link: "#",
      isAd: true
    },
    {
      title: "Mesa Colonial",
      subtitle: "Café colonial completo da região",
      image: "https://readdy.ai/api/search-image?query=Complete%20colonial%20breakfast%20Mesa%20Colonial%20in%20Urubici%20Santa%20Catarina%20Brazil%20with%20regional%20products%2C%20traditional%20table%20setting%2C%20mountain%20atmosphere&width=300&height=200&seq=mesa_colonial&orientation=landscape",
      link: "#",
      isAd: true
    }
  ];
  ...
  const partners = [
    {
      name: "Colonial da Serra",
      description: "Tradição colonial com produtos caseiros",
      image: "https://readdy.ai/api/search-image?query=Colonial%20cafe%20logo%20Colonial%20da%20Serra%20Urubici%20Santa%20Catarina%20Brazil%2C%20traditional%20colonial%20brand%20identity%2C%20homemade%20products&width=100&height=100&seq=logo14&orientation=squarish"
    },
    {
      name: "Mesa Colonial",
      description: "Café colonial completo da região",
      image: "https://readdy.ai/api/search-image?query=Colonial%20breakfast%20logo%20Mesa%20Colonial%20Urubici%20Santa%20Catarina%20Brazil%2C%20regional%20colonial%20brand%20identity%2C%20traditional%20table&width=100&height=100&seq=logo15&orientation=squarish"
    },
    {
      name: "Tradição Colonial",
      description: "Receitas familiares há gerações",
      image: "https://readdy.ai/api/search-image?query=Traditional%20colonial%20logo%20Tradi%C3%A7%C3%A3o%20Colonial%20Urubici%20Santa%20Catarina%20Brazil%2C%20family%20recipes%20brand%20identity%2C%20generational%20tradition&width=100&height=100&seq=logo16&orientation=squarish"
    }
  ];

  // Dados dos cafés coloniais organizados
  const estabelecimentosData = [
    {
      id: 1,
      nome: "Colonial da Serra",
      categoria: "Café Colonial",
      descricao: "Café colonial tradicional com produtos caseiros da região. Mesa farta com pães, geleias, queijos, embutidos e doces artesanais.",
      whatsapp: "5548999887766",
      avaliacao: 4.8,
      imagem: "https://readdy.ai/api/search-image?query=Traditional%20colonial%20cafe%20Colonial%20da%20Serra%20with%20homemade%20regional%20products%2C%20abundant%20table%2C%20artisanal%20breads%2C%20jams%2C%20cheeses&width=200&height=200&seq=colonial_serra_card&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Colonial%20da%20Serra%20Urubici%20SC",
      tags: [
        { label: "Produtos Caseiros", type: "amenity", color: "green" },
        { label: "Mesa Farta", type: "feature", color: "green" },
        { label: "Tradição Regional", type: "feature", color: "amber" }
      ]
    },
    {
      id: 2,
      nome: "Mesa Colonial",
      categoria: "Café Colonial",
      descricao: "Café colonial completo com variedade de produtos regionais. Ambiente familiar e acolhedor com vista para as montanhas.",
      whatsapp: "5548988776655",
      avaliacao: 4.7,
      imagem: "https://readdy.ai/api/search-image?query=Complete%20colonial%20breakfast%20Mesa%20Colonial%20with%20regional%20variety%2C%20family%20atmosphere%2C%20mountain%20views%2C%20welcoming%20environment&width=200&height=200&seq=mesa_colonial_card&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Mesa%20Colonial%20Urubici%20SC",
      tags: [
        { label: "Variedade Regional", type: "amenity", color: "green" },
    ...
    {
      id: 3,
      nome: "Café Colonial Vovó Maria",
      categoria: "Café Colonial",
      descricao: "Receitas tradicionais da vovó Maria com mais de 50 anos de tradição. Pães caseiros, cucas e chimia da casa.",
      whatsapp: "5548977665544",
      avaliacao: 4.9,
      imagem: "https://readdy.ai/api/search-image?query=Traditional%20grandmother%20cafe%20Caf%C3%A9%20Colonial%20Vov%C3%B3%20Maria%20with%2050%20years%20tradition%2C%20homemade%20breads%2C%20traditional%20cakes%2C%20house%20preserves&width=200&height=200&seq=vovo_maria&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Café%20Colonial%20Vovó%20Maria%20Urubici%20SC",
      tags: [
        { label: "50 Anos Tradição", type: "feature", color: "amber" },
        { label: "Receitas da Vovó", type: "feature", color: "green" },
        { label: "Pães Caseiros", type: "amenity", color: "green" }
      ]
    },
    {
      id: 4,
      nome: "Tradição Colonial",
      categoria: "Café Colonial",
      descricao: "Café colonial com receitas familiares passadas de geração em geração. Ambiente rústico e aconchegante.",
      whatsapp: "5548966554433",
      avaliacao: 4.6,
      imagem: "https://readdy.ai/api/search-image?query=Family%20tradition%20colonial%20cafe%20Tradi%C3%A7%C3%A3o%20Colonial%20with%20generational%20recipes%2C%20rustic%20cozy%20atmosphere%2C%20traditional%20setting&width=200&height=200&seq=tradicao_colonial&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Tradição%20Colonial%20Urubici%20SC",
      tags: [
        { label: "Receitas Familiares", type: "feature", color: "green" },
        { label: "Ambiente Rústico", type: "feature", color: "amber" },
        { label: "Tradição Geracional", type: "feature", color: "green" }
      ]
    },
    {
      id: 5,
      nome: "Colonial do Vale",
      categoria: "Café Colonial",
      descricao: "Localizado no vale com vista panorâmica. Café colonial servido em ambiente campestre com produtos orgânicos.",
      whatsapp: "5548955443322",
      avaliacao: 4.5,
      imagem: "https://readdy.ai/api/search-image?query=Valley%20colonial%20cafe%20Colonial%20do%20Vale%20with%20panoramic%20views%2C%20countryside%20atmosphere%2C%20organic%20products%2C%20rural%20setting&width=200&height=200&seq=colonial_vale&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Colonial%20do%20Vale%20Urubici%20SC",
      tags: [
        { label: "Vista Panorâmica", type: "location", color: "cyan" },
        { label: "Ambiente Campestre", type: "feature", color: "green" },
        { label: "Produtos Orgânicos", type: "feature", color: "green" }
      ]
    }
  ];
        ...
        <div className="px-4 mb-6">
          <div className="text-center">
            <h2 className="text-white font-bold text-xl mb-2 flex items-center justify-center gap-2">
              <i className="ri-cake-3-line text-green-400"></i>
              Café Colonial
              <i className="ri-cake-3-line text-green-400"></i>
            </h2>
            <p className="text-white/70 text-sm">Tradição colonial com produtos caseiros da serra</p>
          </div>
        </div>
        ...
        <div className="px-4 mb-8">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20 shadow-lg">
            ...
            <div className="flex flex-wrap gap-2 justify-center">
              <button
                onClick={() => {
                  const element = document.getElementById('cafe-colonial-urubici');
        ...
        <div className="px-4 mb-6">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg text-center">
            <div className="mb-4">
              ...
              <h3 className="text-white font-bold text-lg mb-2">Cadastre seu Café Colonial</h3>
              <p className="text-white/80 text-sm leading-relaxed mb-4">
                Você possui café colonial em Urubici? Cadastre-se em nossa plataforma!
              </p>
            </div>

            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <a
                href="https://wa.me/5551986859236?text=Olá! Gostaria de cadastrar meu café colonial no Portal Urubici"
                target="_blank"
                rel="noopener noreferrer"
