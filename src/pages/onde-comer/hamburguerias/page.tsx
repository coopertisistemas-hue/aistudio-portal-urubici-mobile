...
export default function Hamburguerias() {
  ...
  const featuredAds = [
    {
      title: "Burger Mountain",
      subtitle: "Hambúrgueres gourmet da serra",
      image: "https://readdy.ai/api/search-image?query=Gourmet%20burger%20restaurant%20Burger%20Mountain%20in%20Urubici%20Santa%20Catarina%20Brazil%20with%20artisanal%20burgers%2C%20mountain%20atmosphere%2C%20rustic%20decor%2C%20quality%20ingredients&width=300&height=200&seq=burger_mountain&orientation=landscape",
      link: "#",
      isAd: true
    },
    {
      title: "Hamburguer da Serra",
      subtitle: "Sabores únicos da região serrana",
      image: "https://readdy.ai/api/search-image?query=Mountain%20burger%20joint%20Hamburguer%20da%20Serra%20in%20Urubici%20Santa%20Catarina%20Brazil%20with%20regional%20flavors%2C%20cozy%20atmosphere%2C%20local%20ingredients&width=300&height=200&seq=hamburguer_serra&orientation=landscape",
      link: "#",
      isAd: true
    }
  ];
  ...
  const partners = [
    {
      ...
      description: "Hambúrgueres gourmet da serra",
      image: "https://readdy.ai/api/search-image?query=Mountain%20burger%20logo%20Burger%20Mountain%20Urubici%20Santa%20Catarina%20Brazil%2C%20gourmet%20burger%20brand%20identity%2C%20artisanal%20food&width=100&height=100&seq=logo19&orientation=squarish"
    },
    {
      name: "Hamburguer da Serra",
      description: "Sabores únicos da região serrana",
      image: "https://readdy.ai/api/search-image?query=Regional%20burger%20logo%20Hamburguer%20da%20Serra%20Urubici%20Santa%20Catarina%20Brazil%2C%20mountain%20burger%20brand%20identity%2C%20local%20flavors&width=100&height=100&seq=logo20&orientation=squarish"
    },
    {
      name: "Gourmet Burger",
      description: "Hambúrgueres artesanais premium",
      image: "https://readdy.ai/api/search-image?query=Gourmet%20burger%20logo%20Gourmet%20Burger%20Urubici%20Santa%20Catarina%20Brazil%2C%20premium%20artisanal%20burger%20brand%20identity&width=100&height=100&seq=logo21&orientation=squarish"
    }
  ];

  // Dados das hamburguerias organizados
  const estabelecimentosData = [
    {
      id: 1,
      nome: "Burger Mountain",
      categoria: "Hamburgueria",
      descricao: "Hambúrgueres gourmet com ingredientes selecionados, pães artesanais e ambiente descontraído. Especialidade em carnes nobres.",
      whatsapp: "5548999887766",
      avaliacao: 4.6,
      imagem: "https://readdy.ai/api/search-image?query=Gourmet%20burger%20restaurant%20Burger%20Mountain%20with%20selected%20ingredients%2C%20artisanal%20buns%2C%20relaxed%20atmosphere%2C%20premium%20meats&width=200&height=200&seq=burger_mountain_card&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Burger%20Mountain%20Urubici%20SC",
      tags: [
        { label: "Hambúrgueres Gourmet", type: "amenity", color: "orange" },
        { label: "Pães Artesanais", type: "amenity", color: "orange" },
        { label: "Carnes Nobres", type: "amenity", color: "red" }
      ]
    },
    {
      id: 2,
      nome: "Hamburguer da Serra",
      categoria: "Hamburgueria",
      descricao: "Hambúrgueres com sabores regionais, ingredientes locais e receitas exclusivas. Ambiente familiar e aconchegante.",
      whatsapp: "5548988776655",
      avaliacao: 4.5,
      imagem: "https://readdy.ai/api/search-image?query=Regional%20burger%20joint%20Hamburguer%20da%20Serra%20with%20local%20flavors%2C%20regional%20ingredients%2C%20exclusive%20recipes%2C%20family%20atmosphere&width=200&height=200&seq=hamburguer_serra_card&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Hamburguer%20da%20Serra%20Urubici%20SC",
      tags: [
        { label: "Sabores Regionais", type: "amenity", color: "orange" },
        { label: "Ingredientes Locais", type: "feature", color: "green" },
    ...
    },
    {
      ...
      nome: "Gourmet Burger",
      categoria: "Hamburgueria",
      descricao: "Hambúrgueres artesanais premium com opções vegetarianas, molhos especiais e batatas rústicas. Delivery disponível.",
      whatsapp: "5548977665544",
      avaliacao: 4.7,
      imagem: "https://readdy.ai/api/search-image?query=Premium%20artisanal%20burger%20Gourmet%20Burger%20with%20vegetarian%20options%2C%20special%20sauces%2C%20rustic%20fries%2C%20delivery%20service&width=200&height=200&seq=gourmet_burger&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Gourmet%20Burger%20Urubici%20SC",
      tags: [
        { label: "Hambúrgueres Premium", type: "amenity", color: "orange" },
        { label: "Opções Vegetarianas", type: "feature", color: "green" },
        { label: "Delivery Disponível", type: "service", color: "blue" }
      ]
    },
    {
      id: 4,
      nome: "Serra Burger",
      categoria: "Hamburgueria",
      descricao: "Hambúrgueres tradicionais com preços acessíveis, atendimento rápido e ambiente jovem. Combos promocionais diários.",
      whatsapp: "5548966554433",
      avaliacao: 4.3,
      imagem: "https://readdy.ai/api/search-image?query=Traditional%20burger%20joint%20Serra%20Burger%20with%20affordable%20prices%2C%20quick%20service%2C%20young%20atmosphere%2C%20daily%20combo%20deals&width=200&height=200&seq=serra_burger&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Serra%20Burger%20Urubici%20SC",
      tags: [
        { label: "Preços Acessíveis", type: "feature", color: "green" },
        { label: "Atendimento Rápido", type: "service", color: "blue" },
        { label: "Combos Promocionais", type: "feature", color: "orange" }
      ]
    },
    {
      id: 5,
      nome: "Mountain Grill",
      categoria: "Hamburgueria",
      descricao: "Hambúrgueres na chapa com vista para as montanhas. Especialidade em carnes grelhadas e ambiente ao ar livre.",
      whatsapp: "5548955443322",
      avaliacao: 4.4,
      imagem: "https://readdy.ai/api/search-image?query=Mountain%20grill%20burger%20Mountain%20Grill%20with%20mountain%20views%2C%20grilled%20meats%20specialty%2C%20outdoor%20atmosphere%2C%20scenic%20location&width=200&height=200&seq=mountain_grill&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Mountain%20Grill%20Urubici%20SC",
      tags: [
        { label: "Vista Montanha", type: "location", color: "cyan" },
        { label: "Carnes Grelhadas", type: "amenity", color: "red" },
        { label: "Ambiente Ao Ar Livre", type: "feature", color: "green" }
      ]
    }
  ];
  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className="relative z-10 max-w-md mx-auto">
        ...
        <div className="px-4 mb-6">
          <div className="text-center">
            <h2 className="text-white font-bold text-xl mb-2 flex items-center justify-center gap-2">
              <i className="ri-cake-2-line text-orange-400"></i>
              Hamburguerias
              <i className="ri-cake-2-line text-orange-400"></i>
            </h2>
            <p className="text-white/70 text-sm">Hambúrgueres gourmet e artesanais da serra</p>
          </div>
        </div>
        ...
        <div className="px-4 mb-8">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20 shadow-lg">
            ...
            <div className="flex flex-wrap gap-2 justify-center">
              <button
                onClick={() => {
                  const element = document.getElementById('hamburguerias-urubici');
        ...
        <div className="px-4 mb-6">
          ...
          >
            ...
            <p className="text-white/70 text-sm">
              {estabelecimentosData.length} {estabelecimentosData.length === 1 ? 'hamburgueria disponível' : 'hamburguerias disponíveis'}
            </p>
          </div>
        ...
        {/* Call to Action - Cadastre sua Hamburgueria */}
        <div className="px-4 mb-6">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg text-center">
            <div className="mb-4">
              ...
              <h3 className="text-white font-bold text-lg mb-2">Cadastre sua Hamburgueria</h3>
              <p className="text-white/80 text-sm leading-relaxed mb-4">
                Você possui hamburgueria em Urubici? Cadastre-se em nossa plataforma!
              </p>
            </div>

            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <a
                href="https://wa.me/5551986859236?text=Olá! Gostaria de cadastrar minha hamburgueria no Portal Urubici"
                target="_blank"
                rel="noopener noreferrer"
