...
export default function VinicolasBistrosVinicola() {
  ...
  const featuredAds = [
    {
      ...
      subtitle: "Vinhos de altitude e harmonizações especiais",
      image: "https://readdy.ai/api/search-image?query=High%20altitude%20winery%20Vin%C3%ADcola%20Altitude%20in%20Urubici%20Santa%20Catarina%20Brazil%20with%20vineyard%20views%2C%20wine%20tasting%20room%2C%20elegant%20dining%20area%2C%20mountain%20landscape%20background&width=300&height=200&seq=vinicola1&orientation=landscape",
      link: "#",
      isAd: true
    },
    {
      title: "Bistrô da Vinícola",
      subtitle: "Gastronomia harmonizada com vinhos locais",
      image: "https://readdy.ai/api/search-image?query=Winery%20bistro%20Bistr%C3%B4%20da%20Vin%C3%ADcola%20in%20Urubici%20Santa%20Catarina%20Brazil%20with%20wine%20cellar%2C%20gourmet%20dining%2C%20vineyard%20atmosphere%2C%20wine%20pairing%20experience&width=300&height=200&seq=bistro2&orientation=landscape",
      link: "#",
      isAd: true
    },
    {
      title: "Wine House Serra",
      subtitle: "Experiência completa em vinhos da serra",
      image: "https://readdy.ai/api/search-image?query=Mountain%20wine%20house%20Wine%20House%20Serra%20in%20Urubici%20Santa%20Catarina%20Brazil%20with%20wine%20collection%2C%20tasting%20room%2C%20mountain%20winery%2C%20premium%20wine%20experience&width=300&height=200&seq=winehouse1&orientation=landscape",
      link: "#",
      isAd: true
    }
  ];
  ...
  const partners = [
    {
      ...
      image: "https://readdy.ai/api/search-image?query=High%20altitude%20winery%20logo%20Vin%C3%ADcola%20Altitude%20Urubici%20Santa%20Catarina%20Brazil%2C%20mountain%20vineyard%20brand%20identity%2C%20wine%20producer&width=100&height=100&seq=logo40&orientation=squarish"
    },
    {
      name: "Bistrô da Vinícola",
      description: "Gastronomia e vinhos harmonizados",
      image: "https://readdy.ai/api/search-image?query=Winery%20bistro%20logo%20Bistr%C3%B4%20da%20Vin%C3%ADcola%20Urubici%20Santa%20Catarina%20Brazil%2C%20wine%20dining%20brand%20identity%2C%20vineyard%20restaurant&width=100&height=100&seq=logo41&orientation=squarish"
    },
    {
      name: "Wine House Serra",
      description: "Casa de vinhos premium da serra",
      image: "https://readdy.ai/api/search-image?query=Wine%20house%20logo%20Wine%20House%20Serra%20Urubici%20Santa%20Catarina%20Brazil%2C%20premium%20wine%20brand%20identity%2C%20mountain%20wine%20collection&width=100&height=100&seq=logo42&orientation=squarish"
    },
    {
      name: "Adega da Montanha",
      description: "Tradição em vinhos de montanha",
      image: "https://readdy.ai/api/search-image?query=Mountain%20cellar%20logo%20Adega%20da%20Montanha%20Urubici%20Santa%20Catarina%20Brazil%2C%20wine%20cellar%20brand%20identity%2C%20traditional%20winery&width=100&height=100&seq=logo43&orientation=squarish"
    },
    {
      name: "Vinhos da Serra",
      description: "Seleção especial de vinhos locais",
      image: "https://readdy.ai/api/search-image?query=Mountain%20wines%20logo%20Vinhos%20da%20Serra%20Urubici%20Santa%20Catarina%20Brazil%2C%20local%20wine%20brand%20identity%2C%20serra%20wine%20selection&width=100&height=100&seq=logo44&orientation=squarish"
    }
  ];
  ...
  const establishments = [
    {
      ...
      image: "https://readdy.ai/api/search-image?query=elegant%20vineyard%20winery%20with%20wine%20barrels%20tasting%20room%20mountain%20landscape%20grape%20vines%20sophisticated%20interior&width=400&height=300&seq=1&orientation=landscape",
      rating: 4.8,
      reviews: 234,
      category: "Vinícola Premium",
      specialties: ["Vinhos Premiados", "Degustação Guiada", "Vista dos Vinhedos"],
      description: "Vinícola premiada com degustações exclusivas e vista deslumbrante dos vinhedos.",
      whatsapp: "+5554999887766"
    },
    {
      id: 2,
      name: "Bistrô Terroir",
      image: "https://readdy.ai/api/search-image?query=sophisticated%20wine%20bistro%20interior%20with%20wine%20cellar%20elegant%20dining%20room%20french%20cuisine%20mountain%20setting&width=400&height=300&seq=2&orientation=landscape",
      rating: 4.9,
      reviews: 187,
      category: "Bistrô de Vinícola",
      specialties: ["Harmonização", "Culinária Francesa", "Carta de Vinhos"],
      description: "Bistrô sofisticado especializado em harmonização de vinhos e culinária francesa.",
      whatsapp: "+5554999776655"
    },
    {
      id: 3,
      name: "Cantina do Vale",
      image: "https://readdy.ai/api/search-image?query=rustic%20wine%20cellar%20with%20stone%20walls%20wooden%20barrels%20traditional%20italian%20atmosphere%20mountain%20valley%20setting&width=400&height=300&seq=3&orientation=landscape",
      rating: 4.6,
      reviews: 298,
      category: "Cantina Tradicional",
      specialties: ["Vinhos Coloniais", "Ambiente Rústico", "Tradição Familiar"],
      description: "Cantina familiar com tradição na produção de vinhos coloniais artesanais.",
      whatsapp: "+5554999665544"
    },
    {
      id: 4,
      name: "Château Montanha",
      image: "https://readdy.ai/api/search-image?query=luxury%20chateau%20winery%20with%20elegant%20architecture%20wine%20tasting%20terrace%20mountain%20views%20premium%20atmosphere&width=400&height=300&seq=4&orientation=landscape",
      rating: 4.7,
      reviews: 156,
      category: "Château",
      specialties: ["Vinhos Finos", "Arquitetura Única", "Experiência Premium"],
      description: "Château com arquitetura impressionante e produção de vinhos finos de altitude.",
        ...
        <div className="px-4 mb-6">
          <div className="text-center">
            <h2 className="text-white font-bold text-xl mb-2 flex items-center justify-center gap-2">
              <i className="ri-drop-line text-purple-400"></i>
              Vinícolas & Bistrôs de Vinícola
              <i className="ri-drop-line text-purple-400"></i>
            </h2>
            <p className="text-white/70 text-sm">Vinhos de altitude e harmonizações especiais na serra</p>
          </div>
        </div>
        ...
        <div className="px-4 mb-8">
          <div className="bg-gradient-to-br from-purple-600/20 to-purple-800/20 backdrop-blur-md rounded-2xl p-6 border border-purple-400/30 text-center">
            <div className="w-16 h-16 bg-purple-500/20 rounded-full flex items-center justify-center mx-auto mb-4">
              <i className="ri-drop-line text-purple-400 text-2xl"></i>
            </div>
            <h3 className="text-white font-bold text-lg mb-2">Tem uma Vinícola ou Bistrô?</h3>
        ...
        <div className="w-full mb-6">
          <div className="px-4 mb-4">
            <h3 className="text-white font-bold text-sm uppercase tracking-wider text-center flex items-center justify-center gap-2">
              ...
              Parceiros Vinícolas & Bistrôs
              <i className="ri-star-line text-yellow-400"></i>
            </h3>
            <p className="text-white/70 text-xs text-center mt-1">Conheça nossos parceiros especializados em vinhos e harmonizações</p>
          </div>
