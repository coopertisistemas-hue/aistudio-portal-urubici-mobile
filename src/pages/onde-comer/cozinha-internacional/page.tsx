...
export default function CozinhaInternacional() {
  ...
  const featuredAds = [
    {
      title: "World Kitchen",
      subtitle: "Sabores do mundo em um só lugar na serra",
      image: "https://readdy.ai/api/search-image?query=International%20cuisine%20restaurant%20World%20Kitchen%20in%20Urubici%20Santa%20Catarina%20Brazil%20with%20diverse%20global%20dishes%2C%20multicultural%20decor%2C%20world%20flavors%2C%20cosmopolitan%20dining&width=300&height=200&seq=world1&orientation=landscape",
      link: "#",
      isAd: true
    },
    {
      title: "Sabores do Mundo",
      subtitle: "Culinária internacional com ingredientes locais",
      image: "https://readdy.ai/api/search-image?query=Global%20flavors%20restaurant%20Sabores%20do%20Mundo%20in%20Urubici%20Santa%20Catarina%20Brazil%20with%20international%20cuisine%2C%20world%20map%20decor%2C%20diverse%20menu%2C%20cultural%20fusion&width=300&height=200&seq=sabores1&orientation=landscape",
      link: "#",
      isAd: true
    },
    {
      title: "Internacional Gourmet",
      subtitle: "Experiência gastronômica internacional premium",
      image: "https://readdy.ai/api/search-image?query=Premium%20international%20restaurant%20Internacional%20Gourmet%20in%20Urubici%20Santa%20Catarina%20Brazil%20with%20elegant%20dining%2C%20gourmet%20international%20dishes%2C%20sophisticated%20atmosphere&width=300&height=200&seq=internacional1&orientation=landscape",
      link: "#",
      isAd: true
    }
  ];
  ...
  const partners = [
    {
      ...
      image: "https://readdy.ai/api/search-image?query=International%20restaurant%20logo%20World%20Kitchen%20Urubici%20Santa%20Catarina%20Brazil%2C%20global%20cuisine%20brand%20identity%2C%20world%20flavors&width=100&height=100&seq=logo29&orientation=squarish"
    },
    {
      name: "Sabores do Mundo",
      description: "Culinária internacional diversificada",
      image: "https://readdy.ai/api/search-image?query=Global%20cuisine%20logo%20Sabores%20do%20Mundo%20Urubici%20Santa%20Catarina%20Brazil%2C%20international%20flavors%20brand%20identity%2C%20world%20food&width=100&height=100&seq=logo30&orientation=squarish"
    },
    {
      name: "Internacional Gourmet",
      description: "Experiência gastronômica premium",
      image: "https://readdy.ai/api/search-image?query=Premium%20international%20logo%20Internacional%20Gourmet%20Urubici%20Santa%20Catarina%20Brazil%2C%20gourmet%20dining%20brand%20identity%2C%20luxury%20cuisine&width=100&height=100&seq=logo31&orientation=squarish"
    },
    {
      name: "Global Taste",
      description: "Fusão de sabores internacionais",
      image: "https://readdy.ai/api/search-image?query=Global%20taste%20restaurant%20logo%20Global%20Taste%20Urubici%20Santa%20Catarina%20Brazil%2C%20fusion%20cuisine%20brand%20identity%2C%20international%20dining&width=100&height=100&seq=logo32&orientation=squarish"
    },
    {
      name: "Fusion Restaurant",
      description: "Cozinha fusion contemporânea",
      image: "https://readdy.ai/api/search-image?query=Fusion%20restaurant%20logo%20Fusion%20Restaurant%20Urubici%20Santa%20Catarina%20Brazil%2C%20contemporary%20fusion%20brand%20identity%2C%20modern%20cuisine&width=100&height=100&seq=logo33&orientation=squarish"
    }
  ];
  ...
  const restaurants = [
    {
      name: "World Kitchen",
      category: "Cozinha Mundial",
      rating: 4.8,
      reviews: 189,
      description: "Pratos representativos de diversos países em um ambiente cosmopolita. Carta de vinhos internacionais.",
      phone: "(49) 3278-4567",
      address: "Rua Internacional, 123 - Centro",
      hours: "18:00 às 23:00",
      specialties: ["Paella", "Curry", "Tacos", "Pad Thai"],
      image: "https://readdy.ai/api/search-image?query=Cosmopolitan%20restaurant%20World%20Kitchen%20with%20diverse%20international%20dishes%2C%20world%20map%20decor%2C%20global%20cuisine%20presentation%2C%20multicultural%20dining%20in%20Urubici%20Santa%20Catarina&width=300&height=200&seq=rest1&orientation=landscape"
    },
    {
      name: "Sabores do Mundo",
      category: "Fusão Internacional",
      rating: 4.7,
      reviews: 156,
      description: "Fusão criativa de sabores internacionais com ingredientes da serra catarinense.",
      phone: "(49) 3278-5678",
      address: "Av. Global, 456 - Centro",
      hours: "17:30 às 22:30",
      specialties: ["Risotto", "Ceviche", "Coq au Vin", "Moussaka"],
      image: "https://readdy.ai/api/search-image?query=International%20fusion%20restaurant%20Sabores%20do%20Mundo%20with%20creative%20global%20dishes%2C%20fusion%20cooking%2C%20diverse%20flavors%2C%20cultural%20blend%20in%20Urubici%20Santa%20Catarina&width=300&height=200&seq=rest2&orientation=landscape"
    },
    {
      name: "Internacional Gourmet",
      category: "Fine Dining Internacional",
      rating: 4.9,
      reviews: 134,
      description: "Alta gastronomia internacional com apresentação sofisticada e serviço premium.",
      phone: "(49) 3278-6789",
      address: "Rua Gourmet, 789 - Alto",
      hours: "19:00 às 23:30",
      specialties: ["Foie Gras", "Wagyu", "Caviar", "Trufas"],
      image: "https://readdy.ai/api/search-image?query=Fine%20dining%20international%20restaurant%20Internacional%20Gourmet%20with%20elegant%20presentation%2C%20premium%20service%2C%20sophisticated%20atmosphere%2C%20luxury%20dining%20in%20Urubici%20Santa%20Catarina&width=300&height=200&seq=rest3&orientation=landscape"
    },
    {
      name: "Global Taste",
      ...
      rating: 4.6,
      reviews: 112,
      description: "Ambiente descontraído com pratos típicos de diferentes culturas. Menu variado e acessível.",
      phone: "(49) 3278-7890",
      address: "Rua Cosmopolita, 321 - Centro",
      hours: "18:30 às 22:00",
      specialties: ["Fish & Chips", "Falafel", "Ramen", "Empanadas"],
      image: "https://readdy.ai/api/search-image?query=Casual%20international%20restaurant%20Global%20Taste%20with%20diverse%20cultural%20dishes%2C%20relaxed%20atmosphere%2C%20accessible%20dining%2C%20world%20cuisine%20in%20Urubici%20Santa%20Catarina&width=300&height=200&seq=rest4&orientation=landscape"
    },
    {
      name: "Fusion Restaurant",
      category: "Cozinha Fusion",
      rating: 4.5,
      reviews: 98,
      description: "Conceito inovador misturando técnicas culinárias de diferentes países em pratos únicos.",
      phone: "(49) 3278-8901",
      address: "Av. Fusion, 567 - Bairro Alto",
      hours: "19:30 às 22:30",
      specialties: ["Nikkei", "Tex-Mex", "Asian Fusion", "Mediterranean"],
      image: "https://readdy.ai/api/search-image?query=Modern%20fusion%20restaurant%20with%20innovative%20culinary%20techniques%2C%20unique%20dishes%2C%20contemporary%20atmosphere%2C%20creative%20cuisine%20in%20Urubici%20Santa%20Catarina&width=300&height=200&seq=rest5&orientation=landscape"
    }
  ];
      ...
      <div className="relative z-10 max-w-md mx-auto">
        ...
        <div className="px-4 mb-6">
          <div className="text-center">
            ...
            <p className="text-white/70 text-sm">Sabores do mundo em um só lugar na serra</p>
          </div>
        </div>
        ...
        {/* Call to Action */}
        <div className="px-4 mb-8">
          <div className="bg-gradient-to-br from-purple-600/20 to-purple-800/20 backdrop-blur-md rounded-2xl p-6 border border-purple-400/30 text-center">
            <div className="w-16 h-16 bg-purple-500/20 rounded-full flex items-center justify-center mx-auto mb-4">
              <i className="ri-global-line text-purple-400 text-2xl"></i>
            </div>
            <h3 className="text-white font-bold text-lg mb-2">Tem um Restaurante Internacional?</h3>
            <p className="text-white/80 text-sm mb-4 leading-relaxed">
              Cadastre seu estabelecimento e apareça para milhares de pessoas que visitam Urubici
            </p>
            <button className="bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-white px-6 py-3 rounded-xl font-semibold text-sm transition-all duration-200 hover:scale-105 shadow-lg whitespace-nowrap">
        ...
        <div className="w-full mb-6">
          <div className="px-4 mb-4">
            <h3 className="text-white font-bold text-sm uppercase tracking-wider text-center flex items-center justify-center gap-2">
              ...
              Parceiros Cozinha Internacional
              <i className="ri-star-line text-yellow-400"></i>
            </h3>
            <p className="text-white/70 text-xs text-center mt-1">Conheça nossos parceiros especializados em culinária internacional</p>
          </div>
