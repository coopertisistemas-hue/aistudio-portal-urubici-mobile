...
export default function ComplexosGastronomicos() {
  ...
  const featuredAds = [
    {
      title: "Complexo Gastronômico Serra",
      subtitle: "Variedade gastronômica em um só local",
      image: "https://readdy.ai/api/search-image?query=Gastronomic%20complex%20Complexo%20Gastron%C3%B4mico%20Serra%20in%20Urubici%20Santa%20Catarina%20Brazil%20with%20food%20court%2C%20diverse%20restaurants%2C%20modern%20architecture%2C%20mountain%20setting&width=300&height=200&seq=complex1&orientation=landscape",
      link: "#",
      isAd: true
    },
    {
      title: "Praça Gourmet",
      subtitle: "Praça de alimentação premium da serra",
      image: "https://readdy.ai/api/search-image?query=Premium%20food%20court%20Pra%C3%A7a%20Gourmet%20in%20Urubici%20Santa%20Catarina%20Brazil%20with%20gourmet%20food%20stalls%2C%20elegant%20dining%20area%2C%20variety%20of%20cuisines%2C%20upscale%20atmosphere&width=300&height=200&seq=praca1&orientation=landscape",
      link: "#",
      isAd: true
    },
    {
      title: "Food Park Urubici",
      subtitle: "Experiência gastronômica ao ar livre",
      image: "https://readdy.ai/api/search-image?query=Outdoor%20food%20park%20Food%20Park%20Urubici%20in%20Santa%20Catarina%20Brazil%20with%20food%20trucks%2C%20outdoor%20seating%2C%20mountain%20views%2C%20casual%20dining%20atmosphere&width=300&height=200&seq=foodpark1&orientation=landscape",
      link: "#",
      isAd: true
    }
  ];
  ...
  const partners = [
    {
      name: "Complexo Gastronômico Serra",
      description: "Variedade gastronômica da serra",
      image: "https://readdy.ai/api/search-image?query=Gastronomic%20complex%20logo%20Complexo%20Gastron%C3%B4mico%20Serra%20Urubici%20Santa%20Catarina%20Brazil%2C%20food%20court%20brand%20identity%2C%20diverse%20dining&width=100&height=100&seq=logo50&orientation=squarish"
    },
    {
      name: "Praça Gourmet",
      description: "Praça de alimentação premium",
      image: "https://readdy.ai/api/search-image?query=Premium%20food%20court%20logo%20Pra%C3%A7a%20Gourmet%20Urubici%20Santa%20Catarina%20Brazil%2C%20gourmet%20dining%20brand%20identity%2C%20upscale%20food%20court&width=100&height=100&seq=logo51&orientation=squarish"
    },
    {
      name: "Food Park Urubici",
      description: "Experiência gastronômica ao ar livre",
      image: "https://readdy.ai/api/search-image?query=Food%20park%20logo%20Food%20Park%20Urubici%20Santa%20Catarina%20Brazil%2C%20outdoor%20dining%20brand%20identity%2C%20food%20truck%20park&width=100&height=100&seq=logo52&orientation=squarish"
    },
    {
      name: "Centro Gastronômico",
      description: "Centro de gastronomia diversificada",
      image: "https://readdy.ai/api/search-image?query=Gastronomic%20center%20logo%20Centro%20Gastron%C3%B4mico%20Urubici%20Santa%20Catarina%20Brazil%2C%20dining%20center%20brand%20identity%2C%20food%20hub&width=100&height=100&seq=logo53&orientation=squarish"
    }
  ];
  ...
  const establishments = [
    {
      id: 1,
      name: "Mercado Gastronômico Central",
      image: "https://readdy.ai/api/search-image?query=modern%20food%20market%20with%20multiple%20food%20stalls%20diverse%20cuisine%20options%20contemporary%20design%20mountain%20town%20setting&width=400&height=300&seq=1&orientation=landscape",
      rating: 4.7,
      reviews: 892,
      category: "Mercado Gastronômico",
      specialties: ["Variedade Culinária", "Ambiente Moderno", "Opções para Todos"],
      description: "Mercado gastronômico com mais de 20 opções culinárias em ambiente moderno e aconchegante.",
      whatsapp: "+5554999887766"
    },
    {
      id: 2,
      name: "Praça Gourmet Shopping",
      image: "https://readdy.ai/api/search-image?query=upscale%20food%20court%20with%20elegant%20seating%20gourmet%20restaurants%20modern%20architecture%20mountain%20shopping%20center&width=400&height=300&seq=2&orientation=landscape",
      rating: 4.6,
      reviews: 567,
      category: "Praça de Alimentação",
      specialties: ["Restaurantes Gourmet", "Ambiente Climatizado", "Estacionamento"],
      description: "Praça de alimentação premium com restaurantes gourmet e ambiente sofisticado.",
      whatsapp: "+5554999776655"
    },
    {
      id: 3,
      name: "Vila Gastronômica",
      image: "https://readdy.ai/api/search-image?query=charming%20food%20village%20with%20outdoor%20seating%20multiple%20restaurants%20garden%20setting%20mountain%20atmosphere&width=400&height=300&seq=3&orientation=landscape",
      rating: 4.8,
      reviews: 423,
      category: "Vila Gastronômica",
      specialties: ["Ambiente Aberto", "Jardins", "Eventos Gastronômicos"],
      description: "Vila gastronômica ao ar livre com jardins e programação especial de eventos.",
      whatsapp: "+5554999665544"
    },
    {
      id: 4,
      name: "Food Park Montanha",
      image: "https://readdy.ai/api/search-image?query=outdoor%20food%20park%20with%20food%20trucks%20picnic%20tables%20mountain%20views%20casual%20dining%20atmosphere&width=400&height=300&seq=4&orientation=landscape",
      rating: 4.5,
      reviews: 334,
      category: "Food Park",
      specialties: ["Food Trucks", "Ambiente Descontraído", "Vista da Montanha"],
      description: "Food park com food trucks variados e vista privilegiada da serra.",
  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className="relative z-10 max-w-md mx-auto">
        ...
        <div className="px-4 mb-6">
          <div className="text-center">
            <h2 className="text-white font-bold text-xl mb-2 flex items-center justify-center gap-2">
              ...
              Complexos Gastronômicos / Praças de Alimentação
              <i className="ri-building-3-line text-teal-400"></i>
            </h2>
            <p className="text-white/70 text-sm">Variedade gastronômica em um só local na serra</p>
          </div>
        </div>
              ...
              <div key={index} className="bg-white/10 backdrop-blur-md rounded-2xl p-4 border border-white/20 shadow-lg hover:bg-white/15 transition-all duration-300">
                <div className="flex gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="mb-2">
                      <span className="bg-teal-500/20 text-teal-200 px-2 py-1 rounded-full text-xs font-medium">
        ...
        {/* Call to Action */}
        <div className="px-4 mb-8">
          <div className="bg-gradient-to-br from-teal-600/20 to-teal-800/20 backdrop-blur-md rounded-2xl p-6 border border-teal-400/30 text-center">
            <div className="w-16 h-16 bg-teal-500/20 rounded-full flex items-center justify-center mx-auto mb-4">
              <i className="ri-building-3-line text-teal-400 text-2xl"></i>
            </div>
            <h3 className="text-white font-bold text-lg mb-2">Tem um Complexo Gastronômico?</h3>
            <p className="text-white/80 text-sm mb-4 leading-relaxed">
              Cadastre seu estabelecimento e apareça para milhares de pessoas que visitam Urubici
            </p>
            <button className="bg-gradient-to-r from-teal-600 to-teal-700 hover:from-teal-700 hover:to-teal-800 text-white px-6 py-3 rounded-xl font-semibold text-sm transition-all duration-200 hover:scale-105 shadow-lg whitespace-nowrap">
              Cadastrar
Estabelecimento
            </button>
          </div>
        ...
        <div className="w-full mb-6">
          <div className="px-4 mb-4">
            <h3 className="text-white font-bold text-sm uppercase tracking-wider text-center flex items-center justify-center gap-2">
              ...
              Parceiros Complexos Gastronômicos
              <i className="ri-star-line text-yellow-400"></i>
            </h3>
            <p className="text-white/70 text-xs text-center mt-1">Conheça nossos parceiros especializados em variedade gastronômica</p>
          </div>
