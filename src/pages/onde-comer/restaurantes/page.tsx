...
export default function Restaurantes() {
  ...
  // Dados dos restaurantes organizados
  const restaurantesData = [
    {
      id: 1,
      nome: "La Man Bistrô",
      categoria: "Bistrô",
      descricao: "Bistrô sofisticado com ambiente aconchegante, culinária contemporânea e vinhos selecionados. Pratos autorais com ingredientes locais.",
      whatsapp: "5548999887766",
      avaliacao: 4.8,
      imagem: "https://readdy.ai/api/search-image?query=Elegant%20mountain%20bistro%20La%20Man%20with%20sophisticated%20atmosphere%2C%20contemporary%20cuisine%2C%20selected%20wines%2C%20cozy%20dining%20room%2C%20Urubici%20Santa%20Catarina&width=200&height=200&seq=laman_bistro&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=La%20Man%20Bistrô%20Urubici%20SC",
      tags: [
        { label: "Culinária Contemporânea", type: "amenity", color: "purple" },
        { label: "Vinhos Selecionados", type: "amenity", color: "red" },
        { label: "Ambiente Romântico", type: "feature", color: "pink" }
      ]
    },
    {
      id: 2,
      nome: "Montês Restaurante",
      categoria: "Restaurante",
      descricao: "Culinária regional da serra catarinense com pratos tradicionais, ambiente familiar e vista para as montanhas. Massas artesanais.",
      whatsapp: "5548988776655",
      avaliacao: 4.6,
      imagem: "https://readdy.ai/api/search-image?query=Traditional%20mountain%20restaurant%20Mont%C3%AAs%20with%20regional%20cuisine%2C%20family%20atmosphere%2C%20mountain%20views%2C%20artisanal%20pasta%2C%20serra%20catarinense&width=200&height=200&seq=montes_restaurant&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Montês%20Restaurante%20Urubici%20SC",
      tags: [
        { label: "Pratos Regionais", type: "amenity", color: "green" },
    ...
    {
      id: 3,
      nome: "Château du Valle",
      categoria: "Restaurante",
      descricao: "Alta gastronomia com influências europeias, culinária francesa, ambiente elegante e vista do vale. Fondue tradicional.",
      whatsapp: "5548977665544",
      avaliacao: 4.7,
      imagem: "https://readdy.ai/api/search-image?query=Elegant%20European%20restaurant%20Ch%C3%A2teau%20du%20Valle%20with%20French%20cuisine%2C%20upscale%20atmosphere%2C%20valley%20views%2C%20traditional%20fondue%2C%20fine%20dining&width=200&height=200&seq=chateau_valle&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Château%20du%20Valle%20Urubici%20SC",
      tags: [
        { label: "Culinária Francesa", type: "amenity", color: "purple" },
        { label: "Ambiente Elegante", type: "feature", color: "amber" },
        { label: "Fondue Tradicional", type: "amenity", color: "orange" }
      ]
    },
    {
      id: 4,
      nome: "Quinta das Bromélias",
      categoria: "Restaurante",
      descricao: "Culinária orgânica em meio à natureza com horta própria, ingredientes naturais e foco na sustentabilidade. Ambiente rural.",
      whatsapp: "5548966554433",
      avaliacao: 4.4,
      image: "https://readdy.ai/api/search-image?query=Organic%20mountain%20restaurant%20Quinta%20das%20Brom%C3%A9lias%20with%20natural%20ingredients%2C%20own%20garden%2C%20sustainable%20cuisine%2C%20rural%20atmosphere%2C%20eco-friendly%20dining&width=200&height=200&seq=quinta_bromelias&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Quinta%20das%20Bromélias%20Urubici%20SC",
      tags: [
        { label: "Culinária Orgânica", type: "amenity", color: "green" },
        { label: "Horta Própria", type: "feature", color: "green" },
        { label: "Sustentabilidade", type: "feature", color: "teal" }
      ]
    },
    {
      id: 5,
      nome: "Casa Negra Trutaria",
      categoria: "Trutaria",
      descricao: "Especializada em trutas frescas da região, ambiente rústico próximo ao rio. Peixes regionais e tradição local.",
      whatsapp: "5548955443322",
      avaliacao: 4.5,
      image: "https://readdy.ai/api/search-image?query=Rustic%20trout%20restaurant%20Casa%20Negra%20near%20river%20with%20fresh%20regional%20fish%2C%20traditional%20local%20cuisine%2C%20mountain%20stream%20setting&width=200&height=200&seq=casa_negra&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Casa%20Negra%20Trutaria%20Urubici%20SC",
      tags: [
        { label: "Trutas Frescas", type: "amenity", color: "blue" },
        { label: "Ambiente Rústico", type: "feature", color: "amber" },
        { label: "Próximo ao Rio", type: "location", color: "blue" }
      ]
    },
    {
      id: 6,
      nome: "Casarão da Serra",
      categoria: "Restaurante",
      descricao: "Culinária brasileira em casarão histórico com arquitetura colonial, ambiente charmoso e tradição. Pratos típicos brasileiros.",
      whatsapp: "5548944332211",
      avaliacao: 4.3,
      image: "https://readdy.ai/api/search-image?query=Historic%20colonial%20mansion%20restaurant%20Casar%C3%A3o%20da%20Serra%20with%20Brazilian%20cuisine%2C%20charming%20atmosphere%2C%20traditional%20architecture%2C%20typical%20dishes&width=200&height=200&seq=casarao_serra&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Casarão%20da%20Serra%20Urubici%20SC",
      tags: [
        { label: "Casarão Histórico", type: "feature", color: "amber" },
        { label: "Culinária Brasileira", type: "amenity", color: "green" },
        { label: "Arquitetura Colonial", type: "feature", color: "red" }
      ]
    }
  ];
  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className="relative z-10 max-w-md mx-auto">
        ...
        <div className="px-4 mb-6">
          <div className="text-center">
            <h2 className="text-white font-bold text-xl mb-2 flex items-center justify-center gap-2">
              <i className="ri-restaurant-line text-blue-400"></i>
              Restaurantes
              <i className="ri-restaurant-line text-blue-400"></i>
            </h2>
            <p className="text-white/70 text-sm">Restaurantes com gastronomia variada e ambiente acolhedor</p>
          </div>
        </div>
        ...
        <div className="px-4 mb-8">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20 shadow-lg">
            ...
            <div className="flex flex-wrap gap-2 justify-center">
              <button
                onClick={() => {
                  const element = document.getElementById('restaurantes-em-urubici');
        ...
        <div className="px-4 mb-6">
          ...
          >
            ...
            <p className="text-white/70 text-sm">
              {restaurantesData.length} {restaurantesData.length === 1 ? 'restaurante disponível' : 'restaurantes disponíveis'}
            </p>
          </div>

          <div className="space-y-4">
            {restaurantesData.map((restaurante) => (
              <div key={restaurante.id} className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20 shadow-lg hover:bg-white/15 transition-all duration-300">
                <div className="flex gap-4">
                  ...
                  <div className="flex-1">
                            ...
                            {restaurante.avaliacao ? (
                              <>
                                {[1, 2, 3, 4, 5].map((star) => (
                                  <i
                                    key={star}
                                    className={`${star <= Math.floor(restaurante.avaliacao) ? 'ri-star-fill' : star <= restaurante.avaliacao ? 'ri-star-half-fill' : 'ri-star-line'} text-yellow-400 text-sm`}
                                  ></i>
                                ))}
                    ...
                    <div className="flex flex-wrap gap-1 mb-3">
                      {restaurante.tags.map((tag, tagIndex) => {
                    ...
                    <div className="flex flex-col gap-2">
                      <div className="flex gap-2">
                        {restaurante.whatsapp ? (
                          <a
                            href={`https://wa.me/${restaurante.whatsapp.replace(/\\D/g, '')}?text=Olá! Gostaria de informações sobre ${restaurante.nome}`}
                            target="_blank"
                            rel="noopener noreferrer"
        ...
        {/* Call to Action - Cadastre seu Restaurante */}
        <div className="px-4 mb-6">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg text-center">
            <div className="mb-4">
              ...
              <h3 className="text-white font-bold text-lg mb-2">Cadastre seu Restaurante</h3>
              <p className="text-white/80 text-sm leading-relaxed mb-4">
                Você possui restaurante em Urubici? Cadastre-se em nossa plataforma!
              </p>
            </div>

            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <a
                href="https://wa.me/5551986859236?text=Olá! Gostaria de cadastrar meu restaurante no Portal Urubici"
                target="_blank"
                rel="noopener noreferrer"
