...
export default function GastrobaresBares() {
  ...
  const featuredAds = [
    {
      title: "Gastrobar Altitude",
      subtitle: "Drinks autorais e petiscos gourmet na serra",
      image: "https://readdy.ai/api/search-image?query=Modern%20gastrobar%20Gastrobar%20Altitude%20in%20Urubici%20Santa%20Catarina%20Brazil%20with%20craft%20cocktails%2C%20gourmet%20appetizers%2C%20contemporary%20bar%20atmosphere%2C%20mountain%20setting&width=300&height=200&seq=gastrobar1&orientation=landscape",
      link: "#",
      isAd: true
    },
    {
      title: "Bar da Montanha",
      subtitle: "Ambiente descontraído com vista panorâmica",
      image: "https://readdy.ai/api/search-image?query=Mountain%20bar%20Bar%20da%20Montanha%20in%20Urubici%20Santa%20Catarina%20Brazil%20with%20panoramic%20views%2C%20relaxed%20atmosphere%2C%20craft%20beers%2C%20mountain%20bar%20setting&width=300&height=200&seq=bar1&orientation=landscape",
      link: "#",
      isAd: true
    },
    {
      title: "Drinks & Petiscos",
      subtitle: "Coquetelaria especializada e gastronomia de bar",
      image: "https://readdy.ai/api/search-image?query=Cocktail%20bar%20Drinks%20Petiscos%20in%20Urubici%20Santa%20Catarina%20Brazil%20with%20specialized%20mixology%2C%20bar%20gastronomy%2C%20craft%20cocktails%2C%20modern%20bar%20interior&width=300&height=200&seq=drinks1&orientation=landscape",
      link: "#",
      isAd: true
    }
  ];
  ...
  const partners = [
    {
      name: "Gastrobar Altitude",
      description: "Drinks autorais e petiscos gourmet",
      image: "https://readdy.ai/api/search-image?query=Gastrobar%20logo%20Gastrobar%20Altitude%20Urubici%20Santa%20Catarina%20Brazil%2C%20craft%20cocktails%20brand%20identity%2C%20gourmet%20bar&width=100&height=100&seq=logo34&orientation=squarish"
    },
    {
      name: "Bar da Montanha",
      description: "Ambiente descontraído na serra",
      image: "https://readdy.ai/api/search-image?query=Mountain%20bar%20logo%20Bar%20da%20Montanha%20Urubici%20Santa%20Catarina%20Brazil%2C%20mountain%20bar%20brand%20identity%2C%20relaxed%20atmosphere&width=100&height=100&seq=logo35&orientation=squarish"
    },
    {
      name: "Drinks & Petiscos",
      description: "Coquetelaria e gastronomia de bar",
      image: "https://readdy.ai/api/search-image?query=Cocktail%20bar%20logo%20Drinks%20Petiscos%20Urubici%20Santa%20Catarina%20Brazil%2C%20mixology%20brand%20identity%2C%20bar%20gastronomy&width=100&height=100&seq=logo36&orientation=squarish"
    },
    {
      name: "Boteco da Serra",
      description: "Tradição de boteco na montanha",
      image: "https://readdy.ai/api/search-image?query=Traditional%20bar%20logo%20Boteco%20da%20Serra%20Urubici%20Santa%20Catarina%20Brazil%2C%20mountain%20tavern%20brand%20identity%2C%20traditional%20bar&width=100&height=100&seq=logo37&orientation=squarish"
    },
    {
      name: "Pub Mountain",
      description: "Cervejas artesanais e ambiente pub",
      image: "https://readdy.ai/api/search-image?query=Mountain%20pub%20logo%20Pub%20Mountain%20Urubici%20Santa%20Catarina%20Brazil%2C%20craft%20beer%20brand%20identity%2C%20pub%20atmosphere&width=100&height=100&seq=logo38&orientation=squarish"
    }
  ];
  ...
  const establishments = [
    {
      ...
      image: "https://readdy.ai/api/search-image?query=cozy%20german%20beer%20bar%20interior%20with%20wooden%20tables%20craft%20beer%20taps%20warm%20lighting%20rustic%20atmosphere%20mountain%20town%20setting&width=400&height=300&seq=1&orientation=landscape",
      rating: 4.6,
      reviews: 342,
      category: "Cervejaria Artesanal",
      specialties: ["Cerveja Artesanal", "Petiscos Alemães", "Música Ao Vivo"],
      description: "Ambiente aconchegante com cervejas artesanais e petiscos tradicionais alemães.",
      whatsapp: "+5554999887766"
    },
    {
      id: 2,
      name: "Gastrobar Elevation",
      image: "https://readdy.ai/api/search-image?query=modern%20upscale%20gastrobar%20interior%20with%20sophisticated%20lighting%20craft%20cocktails%20elegant%20bar%20counter%20mountain%20view&width=400&height=300&seq=2&orientation=landscape",
      rating: 4.8,
      reviews: 198,
      category: "Gastrobar",
      specialties: ["Coquetéis Autorais", "Gastronomia Contemporânea", "Vista Panorâmica"],
      description: "Gastrobar sofisticado com coquetéis autorais e vista deslumbrante da serra.",
      whatsapp: "+5554999776655"
    },
    {
      id: 3,
      name: "Bar do Lago",
      image: "https://readdy.ai/api/search-image?query=lakeside%20bar%20with%20outdoor%20seating%20wooden%20deck%20sunset%20views%20craft%20beer%20selection%20mountain%20lake%20setting%20peaceful%20atmosphere&width=400&height=300&seq=3&orientation=landscape",
      rating: 4.5,
      reviews: 267,
      category: "Bar Temático",
      specialties: ["Vista do Lago", "Drinks Tropicais", "Ambiente Relaxante"],
      description: "Bar à beira do lago com drinks refrescantes e ambiente descontraído.",
      whatsapp: "+5554999665544"
    },
    {
      id: 4,
      name: "Choperia Central",
      image: "https://readdy.ai/api/search-image?query=traditional%20beer%20hall%20with%20long%20wooden%20tables%20beer%20barrels%20hanging%20lights%20lively%20atmosphere%20mountain%20town%20brewery&width=400&height=300&seq=4&orientation=landscape",
      rating: 4.4,
      reviews: 423,
      category: "Choperia",
      specialties: ["Chopp Gelado", "Porções Generosas", "Ambiente Familiar"],
      description: "Choperia tradicional com chopp sempre gelado e porções fartas.",
      whatsapp: "+5554999554433"
    },
    {
      id: 5,
      name: "Rooftop 360",
      image: "https://readdy.ai/api/search-image?query=rooftop%20bar%20with%20panoramic%20mountain%20views%20modern%20furniture%20cocktail%20lounge%20sunset%20lighting%20sophisticated%20atmosphere&width=400&height=300&seq=5&orientation=landscape",
      rating: 4.9,
      reviews: 156,
      category: "Rooftop Bar",
      specialties: ["Vista 360°", "Coquetéis Premium", "Ambiente Exclusivo"],
      description: "Bar no último andar com vista panorâmica de 360° da região.",
      whatsapp: "+5554999443322"
    },
    {
      id: 6,
      name: "Pub do Vale",
      image: "https://readdy.ai/api/search-image?query=cozy%20english%20pub%20interior%20with%20dark%20wood%20furniture%20beer%20taps%20fireplace%20warm%20lighting%20mountain%20valley%20setting&width=400&height=300&seq=6&orientation=landscape",
      rating: 4.3,
      reviews: 289,
      category: "Pub",
      specialties: ["Cervejas Importadas", "Fish & Chips", "Ambiente Acolhedor"],
      description: "Pub aconchegante com cervejas importadas e pratos típicos ingleses.",
  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className="relative z-10 max-w-md mx-auto">
        ...
        <div className="px-4 mb-6">
          <div className="text-center">
            <h2 className="text-white font-bold text-xl mb-2 flex items-center justify-center gap-2">
              <i className="ri-goblet-fill text-blue-400"></i>
              Gastrobares & Bares
              <i className="ri-goblet-fill text-blue-400"></i>
            </h2>
            <p className="text-white/70 text-sm">Drinks autorais e petiscos gourmet na serra</p>
          </div>
        </div>
        ...
        {/* Call to Action */}
        <div className="px-4 mb-8">
          <div className="bg-gradient-to-br from-blue-600/20 to-blue-800/20 backdrop-blur-md rounded-2xl p-6 border border-blue-400/30 text-center">
            <div className="w-16 h-16 bg-blue-500/20 rounded-full flex items-center justify-center mx-auto mb-4">
              <i className="ri-goblet-fill text-blue-400 text-2xl"></i>
            </div>
            <h3 className="text-white font-bold text-lg mb-2">Tem um Gastrobar ou Bar?</h3>
            <p className="text-white/80 text-sm mb-4 leading-relaxed">
              Cadastre seu estabelecimento e apareça para milhares de pessoas que visitam Urubici
            </p>
            <button className="bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white px-6 py-3 rounded-xl font-semibold text-sm transition-all duration-200 hover:scale-105 shadow-lg whitespace-nowrap">
              Cadastrar
Estabelecimento
            </button>
          </div>
        ...
        <div className="w-full mb-6">
          <div className="px-4 mb-4">
            <h3 className="text-white font-bold text-sm uppercase tracking-wider text-center flex items-center justify-center gap-2">
              ...
              Parceiros Gastrobares & Bares
              <i className="ri-star-line text-yellow-400"></i>
            </h3>
            <p className="text-white/70 text-xs text-center mt-1">Conheça nossos parceiros especializados em drinks e petiscos</p>
          </div>
