...
export default function EcoPousadasEcoVillagesPage() {
  ...
  const featuredAds = [
    {
      title: "Eco Pousada Verde",
      subtitle: "Hospedagem sustentável em harmonia com a natureza",
      image: "https://readdy.ai/api/search-image?query=Sustainable%20eco%20lodge%20with%20solar%20panels%2C%20green%20architecture%2C%20natural%20materials%2C%20surrounded%20by%20lush%20forest%2C%20eco-friendly%20accommodation%2C%20mountain%20setting%2C%20environmental%20harmony&width=300&height=200&seq=eco1&orientation=landscape",
      link: "#",
      isAd: true
    },
    {
      title: "Eco Village Serra",
      subtitle: "Comunidade sustentável com experiência única",
      image: "https://readdy.ai/api/search-image?query=Eco%20village%20community%20with%20sustainable%20cabins%2C%20organic%20gardens%2C%20renewable%20energy%2C%20mountain%20backdrop%2C%20eco-tourism%20accommodation%2C%20green%20living%20concept&width=300&height=200&seq=eco2&orientation=landscape",
      link: "#",
      isAd: true
    }
  ];
  ...
  // Dados das eco pousadas organizados
  const ecoPousadasData = [
    {
      id: 1,
      nome: "Eco Pousada Verde",
      categoria: "Eco Pousada",
      descricao: "Pousada sustentável com energia solar, horta orgânica e construção ecológica. Experiência única em harmonia com a natureza.",
      whatsapp: "5548999887766",
      avaliacao: 4.8,
      imagem: "https://readdy.ai/api/search-image?query=Sustainable%20eco%20lodge%20with%20solar%20panels%2C%20green%20architecture%2C%20natural%20materials%2C%20surrounded%20by%20lush%20forest%2C%20eco-friendly%20accommodation%2C%20mountain%20setting%2C%20environmental%20harmony&width=200&height=200&seq=eco_verde&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Eco%20Pousada%20Verde%20Urubici%20SC",
      tags: [
        { label: "Energia Solar", type: "amenity", color: "green" },
        { label: "Horta Orgânica", type: "feature", color: "green" },
        { label: "Sustentável", type: "feature", color: "teal" }
      ]
    },
    {
      id: 2,
      nome: "Eco Village Serra",
      categoria: "Eco Village",
      descricao: "Comunidade sustentável com cabanas ecológicas, permacultura e vivência comunitária. Ideal para quem busca reconexão.",
      whatsapp: "5548988776655",
      avaliacao: 4.6,
      imagem: "https://readdy.ai/api/search-image?query=Eco%20village%20community%20with%20sustainable%20cabins%2C%20organic%20gardens%2C%20renewable%20energy%2C%20mountain%20backdrop%2C%20eco-tourism%20accommodation%2C%20green%20living%20concept&width=200&height=200&seq=eco_village&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Eco%20Village%20Serra%20Urubici%20SC",
      tags: [
        { label: "Permacultura", type: "feature", color: "green" },
        { label: "Vivência Comunitária", type: "feature", color: "purple" },
        { label: "Cabanas Ecológicas", type: "amenity", color: "amber" }
      ]
    },
    {
      id: 3,
      nome: "Pousada Sustentável",
      categoria: "Eco Pousada",
      descricao: "Pousada com práticas sustentáveis, reciclagem de água, compostagem e alimentação orgânica. Turismo consciente.",
      whatsapp: "",
      avaliacao: 4.4,
      imagem: "https://readdy.ai/api/search-image?query=Sustainable%20mountain%20inn%20with%20water%20recycling%2C%20composting%2C%20organic%20food%2C%20eco-friendly%20practices%2C%20green%20tourism%2C%20natural%20architecture&width=200&height=200&seq=eco_sustentavel&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Pousada%20Sustentável%20Urubici%20SC",
      tags: [
        { label: "Reciclagem Água", type: "amenity", color: "blue" },
        { label: "Compostagem", type: "feature", color: "green" },
        { label: "Alimentação Orgânica", type: "amenity", color: "orange" }
      ]
    },
    {
      id: 4,
      nome: "Eco Resort Urubici",
      categoria: "Eco Resort",
      descricao: "Resort ecológico com trilhas interpretativas, observação de fauna e flora, e programas de educação ambiental.",
      whatsapp: "5548977665544",
      avaliacao: 4.7,
      imagem: "https://readdy.ai/api/search-image?query=Eco%20resort%20with%20interpretive%20trails%2C%20wildlife%20observation%2C%20environmental%20education%20programs%2C%20sustainable%20luxury%20accommodation%2C%20mountain%20forest%20setting&width=200&height=200&seq=eco_resort&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Eco%20Resort%20Urubici%20SC",
      tags: [
        { label: "Trilhas Interpretativas", type: "feature", color: "green" },
        { label: "Observação Fauna", type: "feature", color: "amber" },
  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className="relative z-10 max-w-md mx-auto">
        ...
        <div className="px-4 mb-6">
          <div className="text-center">
            <h2 className="text-white font-bold text-xl mb-2 flex items-center justify-center gap-2">
              <i className="ri-leaf-line text-teal-400"></i>
              Eco Pousadas / Eco Villages
              <i className="ri-leaf-line text-teal-400"></i>
            </h2>
            <p className="text-white/70 text-sm">Hospedagem sustentável em harmonia com a natureza</p>
          </div>
        </div>
        ...
        <div className="px-4 mb-8">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20 shadow-lg">
            ...
            <div className="flex flex-wrap gap-2 justify-center">
              <button
                onClick={() => {
                  const element = document.getElementById('eco-pousadas-em-urubici');
        ...
        <div className="px-4 mb-6">
          ...
          >
            ...
            <p className="text-white/70 text-sm">
              {ecoPousadasData.length} {ecoPousadasData.length === 1 ? 'eco pousada disponível' : 'eco pousadas disponíveis'}
            </p>
          </div>

          <div className="space-y-4">
            {ecoPousadasData.map((pousada) => (
              <div key={pousada.id} className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20 shadow-lg hover:bg-white/15 transition-all duration-300">
                  ...
                  <div className="flex-1">
                            ...
                            {pousada.avaliacao ? (
                              <>
                                {[1, 2, 3, 4, 5].map((star) => (
                                  <i
                                    key={star}
                                    className={`${star <= Math.floor(pousada.avaliacao) ? 'ri-star-fill' : star <= pousada.avaliacao ? 'ri-star-half-fill' : 'ri-star-line'} text-yellow-400 text-sm`}
                                  ></i>
                                ))}
                                <span className="text-yellow-300 text-xs font-medium ml-1">
                                  {pousada.avaliacao.toFixed(1)}
                                </span>
                              </>
                            ) : (
                              <>
                    ...
                    <div className="flex flex-col gap-2">
                      <div className="flex gap-2">
                        {pousada.whatsapp ? (
                          <a
                            href={`https://wa.me/${pousada.whatsapp.replace(/\\D/g, '')}?text=Olá! Gostaria de informações sobre ${pousada.nome}`}
                            target="_blank"
                            rel="noopener noreferrer"
        ...
        {/* Call to Action - Cadastre sua Eco Pousada */}
        <div className="px-4 mb-6">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg text-center">
            <div className="mb-4">
              ...
              <h3 className="text-white font-bold text-lg mb-2">Cadastre sua Eco Pousada</h3>
              <p className="text-white/80 text-sm leading-relaxed mb-4">
                Você possui eco pousada em Urubici? Cadastre-se em nossa plataforma!
              </p>
            </div>

            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <a
                href="https://wa.me/5551986859236?text=Olá! Gostaria de cadastrar minha eco pousada no Portal Urubici"
                target="_blank"
                rel="noopener noreferrer"
              ...
              >
                ...
                <span>Cadastrar Eco Pousada</span>
              </a>
              <button
