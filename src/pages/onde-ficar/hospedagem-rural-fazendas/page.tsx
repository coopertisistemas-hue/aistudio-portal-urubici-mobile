...
export default function HospedagemRuralFazendasPage() {
  ...
  const featuredAds = [
    {
      ...
      subtitle: "Experiência rural autêntica na serra catarinense",
      image: "https://readdy.ai/api/search-image?query=Authentic%20rural%20farm%20accommodation%20in%20Santa%20Catarina%20mountains%2C%20traditional%20farmhouse%2C%20countryside%20setting%2C%20agricultural%20tourism%2C%20rustic%20charm%2C%20mountain%20backdrop&width=300&height=200&seq=fazenda1&orientation=landscape",
      link: "#",
      isAd: true
    },
    {
      title: "Sítio Acolhedor",
      subtitle: "Hospedagem rural com atividades na fazenda",
      image: "https://readdy.ai/api/search-image?query=Cozy%20rural%20farm%20stay%20with%20farm%20activities%2C%20traditional%20countryside%20accommodation%2C%20agricultural%20experience%2C%20mountain%20farm%20setting%2C%20rustic%20hospitality&width=300&height=200&seq=sitio1&orientation=landscape",
      link: "#",
      isAd: true
    }
  ];
  ...
  // Dados das hospedagens rurais organizados
  const hospedagemRuralData = [
    {
      id: 1,
      nome: "Fazenda da Serra",
      categoria: "Fazenda",
      descricao: "Fazenda tradicional com hospedagem rural, ordenha de vacas, trilhas ecológicas e culinária típica da região serrana.",
      whatsapp: "5548999887766",
      avaliacao: 4.6,
      imagem: "https://readdy.ai/api/search-image?query=Authentic%20rural%20farm%20accommodation%20in%20Santa%20Catarina%20mountains%2C%20traditional%20farmhouse%2C%20countryside%20setting%2C%20agricultural%20tourism%2C%20rustic%20charm%2C%20mountain%20backdrop&width=200&height=200&seq=fazenda_serra&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Fazenda%20da%20Serra%20Urubici%20SC",
      tags: [
        { label: "Ordenha de Vacas", type: "feature", color: "orange" },
        { label: "Trilhas Ecológicas", type: "feature", color: "green" },
        { label: "Culinária Típica", type: "amenity", color: "amber" }
      ]
    },
    {
      id: 2,
      nome: "Sítio Acolhedor",
      categoria: "Sítio",
      descricao: "Sítio familiar com hospedagem rural, horta orgânica, animais da fazenda e atividades para toda a família.",
      whatsapp: "5548988776655",
      avaliacao: 4.4,
      imagem: "https://readdy.ai/api/search-image?query=Cozy%20rural%20farm%20stay%20with%20farm%20activities%2C%20traditional%20countryside%20accommodation%2C%20agricultural%20experience%2C%20mountain%20farm%20setting%2C%20rustic%20hospitality&width=200&height=200&seq=sitio_acolhedor&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Sítio%20Acolhedor%20Urubici%20SC",
      tags: [
        { label: "Horta Orgânica", type: "feature", color: "green" },
        { label: "Animais da Fazenda", type: "feature", color: "orange" },
        { label: "Atividades Familiares", type: "amenity", color: "purple" }
      ]
    },
    {
      id: 3,
      nome: "Rancho Rural",
      categoria: "Rancho",
      descricao: "Rancho rural com cavalgadas, pesca esportiva, fogueira noturna e experiência autêntica do campo.",
      whatsapp: "",
      avaliacao: 4.3,
      imagem: "https://readdy.ai/api/search-image?query=Rural%20ranch%20with%20horseback%20riding%2C%20sport%20fishing%2C%20campfire%20nights%2C%20authentic%20countryside%20experience%2C%20mountain%20ranch%20setting%2C%20rural%20tourism&width=200&height=200&seq=rancho_rural&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Rancho%20Rural%20Urubici%20SC",
      tags: [
        { label: "Cavalgadas", type: "feature", color: "amber" },
        { label: "Pesca Esportiva", type: "feature", color: "blue" },
        { label: "Fogueira Noturna", type: "amenity", color: "orange" }
      ]
    },
    {
      id: 4,
      nome: "Fazenda Boutique",
      categoria: "Fazenda Boutique",
      descricao: "Fazenda boutique com acomodações de luxo, spa rural, gastronomia gourmet e experiências exclusivas no campo.",
      whatsapp: "5548977665544",
      avaliacao: 4.8,
      imagem: "https://readdy.ai/api/search-image?query=Luxury%20boutique%20farm%20with%20upscale%20accommodations%2C%20rural%20spa%2C%20gourmet%20cuisine%2C%20exclusive%20countryside%20experiences%2C%20elegant%20rural%20hospitality&width=200&height=200&seq=fazenda_boutique&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Fazenda%20Boutique%20Urubici%20SC",
      tags: [
        { label: "Spa Rural", type: "amenity", color: "purple" },
        { label: "Gastronomia Gourmet", type: "amenity", color: "amber" },
        { label: "Experiências Exclusivas", type: "feature", color: "red" }
      ]
    }
  ];
  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className="relative z-10 max-w-md mx-auto">
        ...
        <div className="px-4 mb-6">
          <div className="text-center">
            <h2 className="text-white font-bold text-xl mb-2 flex items-center justify-center gap-2">
              <i className="ri-plant-line text-orange-400"></i>
              Hospedagem Rural / Fazendas
              <i className="ri-plant-line text-orange-400"></i>
            </h2>
            <p className="text-white/70 text-sm">Experiência autêntica da vida rural na serra</p>
          </div>
        </div>
        ...
        <div className="px-4 mb-8">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20 shadow-lg">
            ...
            <div className="flex flex-wrap gap-2 justify-center">
              <button
                onClick={() => {
                  const element = document.getElementById('hospedagem-rural-em-urubici');
        ...
        {/* Hospedagem Rural List */}
        <div className="px-4 mb-6">
          <div 
            id="hospedagem-rural-em-urubici"
            className="mb-4"
          >
            <h3 className="text-white font-bold text-lg mb-2 flex items-center gap-2">
              <i className="ri-plant-line text-orange-400"></i>
              Hospedagem Rural em Urubici
            </h3>
            <p className="text-white/70 text-sm">
              {hospedagemRuralData.length} {hospedagemRuralData.length === 1 ? 'hospedagem rural disponível' : 'hospedagens rurais disponíveis'}
            </p>
          </div>

          <div className="space-y-4">
            {hospedagemRuralData.map((hospedagem) => (
        ...
        {/* Call to Action - Cadastre sua Hospedagem Rural */}
        <div className="px-4 mb-6">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg text-center">
            <div className="mb-4">
              ...
              <h3 className="text-white font-bold text-lg mb-2">Cadastre sua Hospedagem Rural</h3>
              <p className="text-white/80 text-sm leading-relaxed mb-4">
                Você possui fazenda ou hospedagem rural em Urubici? Cadastre-se em nossa plataforma!
              </p>
            </div>

            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <a
                href="https://wa.me/5551986859236?text=Olá! Gostaria de cadastrar minha hospedagem rural no Portal Urubici"
                target="_blank"
                rel="noopener noreferrer"
