...
export default function HostelsPage() {
  ...
  const featuredAds = [
    {
      title: "Hostel Montanha",
      subtitle: "Hospedagem econômica para jovens aventureiros",
      image: "https://readdy.ai/api/search-image?query=Modern%20mountain%20hostel%20with%20dormitory%20beds%2C%20common%20areas%2C%20backpacker%20accommodation%2C%20young%20travelers%2C%20social%20atmosphere%2C%20budget-friendly%20lodging%20in%20mountain%20setting&width=300&height=200&seq=hostel1&orientation=landscape",
      link: "#",
      isAd: true
    },
    {
      title: "Hostel Backpackers",
      subtitle: "Ambiente jovem e descontraído na serra",
      image: "https://readdy.ai/api/search-image?query=Backpacker%20hostel%20with%20social%20common%20room%2C%20shared%20kitchen%2C%20young%20atmosphere%2C%20budget%20accommodation%2C%20mountain%20backdrop%2C%20traveler-friendly%20environment&width=300&height=200&seq=hostel2&orientation=landscape",
      link: "#",
      isAd: true
    }
  ];
  ...
  // Dados dos hostels organizados
  const hostelsData = [
    {
      id: 1,
      nome: "Hostel Montanha",
      categoria: "Hostel",
      descricao: "Hostel moderno com dormitórios compartilhados, área comum, cozinha equipada e ambiente jovem. Ideal para mochileiros e viajantes econômicos.",
      whatsapp: "5548999887766",
      avaliacao: 4.3,
      imagem: "https://readdy.ai/api/search-image?query=Modern%20mountain%20hostel%20with%20dormitory%20beds%2C%20common%20areas%2C%20backpacker%20accommodation%2C%20young%20travelers%2C%20social%20atmosphere%2C%20budget-friendly%20lodging%20in%20mountain%20setting&width=200&height=200&seq=hostel_montanha&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Hostel%20Montanha%20Urubici%20SC",
      tags: [
        { label: "Dormitórios", type: "amenity", color: "blue" },
        { label: "Cozinha Equipada", type: "amenity", color: "orange" },
        { label: "Área Comum", type: "feature", color: "purple" }
      ]
    },
    {
      id: 2,
      nome: "Hostel Backpackers",
      categoria: "Hostel",
      descricao: "Hostel descontraído com ambiente jovem, sala de jogos, área de convivência e organização de atividades em grupo.",
      whatsapp: "5548988776655",
      avaliacao: 4.1,
      imagem: "https://readdy.ai/api/search-image?query=Backpacker%20hostel%20with%20social%20common%20room%2C%20shared%20kitchen%2C%20young%20atmosphere%2C%20budget%20accommodation%2C%20mountain%20backdrop%2C%20traveler-friendly%20environment&width=200&height=200&seq=hostel_backpackers&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Hostel%20Backpackers%20Urubici%20SC",
      tags: [
        { label: "Sala de Jogos", type: "amenity", color: "green" },
        { label: "Atividades em Grupo", type: "feature", color: "purple" },
        { label: "Ambiente Jovem", type: "feature", color: "pink" }
      ]
    },
    {
      id: 3,
      nome: "Hostel Serra",
      categoria: "Hostel",
      descricao: "Hostel aconchegante com vista para as montanhas, quartos privativos e compartilhados, café da manhã incluso.",
      whatsapp: "",
      avaliacao: 4.0,
      imagem: "https://readdy.ai/api/search-image?query=Cozy%20mountain%20hostel%20with%20mountain%20views%2C%20private%20and%20shared%20rooms%2C%20breakfast%20included%2C%20comfortable%20budget%20accommodation%2C%20serra%20catarinense%20setting&width=200&height=200&seq=hostel_serra&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Hostel%20Serra%20Urubici%20SC",
      tags: [
        { label: "Vista Montanhas", type: "feature", color: "green" },
        { label: "Quartos Privativos", type: "amenity", color: "blue" },
        { label: "Café Incluso", type: "amenity", color: "amber" }
      ]
    },
    {
      id: 4,
      nome: "Hostel Jovem",
      categoria: "Hostel",
      descricao: "Hostel voltado para jovens viajantes com espaço de coworking, wifi de alta velocidade e eventos culturais.",
      whatsapp: "5548977665544",
      avaliacao: 4.2,
      imagem: "https://readdy.ai/api/search-image?query=Youth%20hostel%20with%20coworking%20space%2C%20high-speed%20wifi%2C%20cultural%20events%2C%20modern%20facilities%20for%20young%20travelers%2C%20mountain%20location&width=200&height=200&seq=hostel_jovem&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Hostel%20Jovem%20Urubici%20SC",
      tags: [
        { label: "Coworking", type: "amenity", color: "cyan" },
        { label: "Wifi Alta Velocidade", type: "amenity", color: "blue" },
        { label: "Eventos Culturais", type: "feature", color: "purple" }
      ]
    }
  ];
  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className="relative z-10 max-w-md mx-auto">
        ...
        <div className="px-4 mb-6">
          <div className="text-center">
            <h2 className="text-white font-bold text-xl mb-2 flex items-center justify-center gap-2">
              <i className="ri-community-line text-blue-400"></i>
              Hostels
              <i className="ri-community-line text-blue-400"></i>
            </h2>
            <p className="text-white/70 text-sm">Hospedagem econômica para jovens viajantes</p>
          </div>
        </div>
        ...
        <div className="px-4 mb-8">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20 shadow-lg">
            ...
            <div className="flex flex-wrap gap-2 justify-center">
              <button
                onClick={() => {
                  const element = document.getElementById('hostels-em-urubici');
        ...
        <div className="px-4 mb-6">
          ...
          >
            ...
            <p className="text-white/70 text-sm">
              {hostelsData.length} {hostelsData.length === 1 ? 'hostel disponível' : 'hostels disponíveis'}
            </p>
          </div>

          <div className="space-y-4">
            {hostelsData.map((hostel) => (
              <div key={hostel.id} className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20 shadow-lg hover:bg-white/15 transition-all duration-300">
                  ...
                  <div className="flex-1">
                            ...
                            {hostel.avaliacao ? (
                              <>
                                {[1, 2, 3, 4, 5].map((star) => (
                                  <i
                                    key={star}
                                    className={`${star <= Math.floor(hostel.avaliacao) ? 'ri-star-fill' : star <= hostel.avaliacao ? 'ri-star-half-fill' : 'ri-star-line'} text-yellow-400 text-sm`}
                                  ></i>
                                ))}
                                <span className="text-yellow-300 text-xs font-medium ml-1">
                                  {hostel.avaliacao.toFixed(1)}
                                </span>
                              </>
                            ) : (
                              <>
                    ...
                    <div className="flex flex-col gap-2">
                      <div className="flex gap-2">
                        {hostel.whatsapp ? (
                          <a
                            href={`https://wa.me/${hostel.whatsapp.replace(/\\D/g, '')}?text=Olá! Gostaria de informações sobre ${hostel.nome}`}
                            target="_blank"
                            rel="noopener noreferrer"
        ...
        {/* Call to Action - Cadastre seu Hostel */}
        <div className="px-4 mb-6">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg text-center">
            <div className="mb-4">
              ...
              <h3 className="text-white font-bold text-lg mb-2">Cadastre seu Hostel</h3>
              <p className="text-white/80 text-sm leading-relaxed mb-4">
                Você possui hostel em Urubici? Cadastre-se em nossa plataforma!
              </p>
            </div>

            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <a
                href="https://wa.me/5551986859236?text=Olá! Gostaria de cadastrar meu hostel no Portal Urubici"
                target="_blank"
                rel="noopener noreferrer"
