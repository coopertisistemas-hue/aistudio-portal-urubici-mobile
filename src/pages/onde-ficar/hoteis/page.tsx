...
export default function HoteisPage() {
  ...
  const featuredAds = [
    {
      ...
      subtitle: "Hotel de luxo com conforto e serviços completos",
      image: "https://readdy.ai/api/search-image?query=Luxury%20mountain%20hotel%20Urubici%20Park%20Hotel%20with%20elegant%20architecture%2C%20full%20service%20accommodation%2C%20mountain%20views%2C%20upscale%20hospitality%2C%20Santa%20Catarina%20Brazil&width=300&height=200&seq=hotel1&orientation=landscape",
      link: "#",
      isAd: true
    },
    {
      title: "Hotel Serra Verde",
      subtitle: "Experiência premium na serra catarinense",
      image: "https://readdy.ai/api/search-image?query=Premium%20mountain%20hotel%20Serra%20Verde%20with%20modern%20facilities%2C%20spa%20services%2C%20gourmet%20restaurant%2C%20luxury%20accommodation%20in%20serra%20catarinense&width=300&height=200&seq=hotel2&orientation=landscape",
      link: "#",
      isAd: true
    }
  ];
  ...
  // Dados dos hotéis organizados
  const hoteisData = [
    {
      id: 1,
      nome: "Urubici Park Hotel",
      categoria: "Hotel",
      descricao: "Hotel de luxo com spa, restaurante gourmet, piscina aquecida e vista panorâmica das montanhas. Serviços completos e conforto premium.",
      whatsapp: "5548999887766",
      avaliacao: 4.8,
      imagem: "https://readdy.ai/api/search-image?query=Luxury%20mountain%20hotel%20Urubici%20Park%20Hotel%20with%20elegant%20architecture%2C%20full%20service%20accommodation%2C%20mountain%20views%2C%20upscale%20hospitality%2C%20Santa%20Catarina%20Brazil&width=200&height=200&seq=urubici_park&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Urubici%20Park%20Hotel%20Urubici%20SC",
      tags: [
        { label: "Spa", type: "amenity", color: "purple" },
        { label: "Restaurante Gourmet", type: "amenity", color: "amber" },
    ...
    },
    {
      ...
      categoria: "Hotel",
      descricao: "Hotel moderno com centro de convenções, academia, sauna e serviços executivos. Ideal para negócios e lazer.",
      whatsapp: "5548988776655",
      avaliacao: 4.6,
      imagem: "https://readdy.ai/api/search-image?query=Premium%20mountain%20hotel%20Serra%20Verde%20with%20modern%20facilities%2C%20spa%20services%2C%20gourmet%20restaurant%2C%20luxury%20accommodation%20in%20serra%20catarinense&width=200&height=200&seq=serra_verde&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Hotel%20Serra%20Verde%20Urubici%20SC",
      tags: [
        { label: "Centro Convenções", type: "amenity", color: "blue" },
        { label: "Academia", type: "amenity", color: "green" },
        { label: "Serviços Executivos", type: "feature", color: "purple" }
      ]
    },
    {
      id: 3,
      nome: "Hotel Montanha",
      categoria: "Hotel",
      descricao: "Hotel familiar com quartos confortáveis, café da manhã completo, área de lazer infantil e estacionamento gratuito.",
      whatsapp: "",
      avaliacao: 4.3,
      imagem: "https://readdy.ai/api/search-image?query=Family%20mountain%20hotel%20with%20comfortable%20rooms%2C%20complete%20breakfast%2C%20children%20play%20area%2C%20free%20parking%2C%20mountain%20setting&width=200&height=200&seq=hotel_montanha&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Hotel%20Montanha%20Urubici%20SC",
      tags: [
        { label: "Familiar", type: "feature", color: "green" },
        { label: "Café Completo", type: "amenity", color: "amber" },
        { label: "Área Infantil", type: "amenity", color: "pink" }
      ]
    },
    {
      id: 4,
      nome: "Hotel Vale Encantado",
      categoria: "Hotel",
      descricao: "Hotel boutique com decoração temática, suítes românticas, lareira e serviços personalizados. Perfeito para casais.",
      whatsapp: "5548977665544",
      avaliacao: 4.7,
      imagem: "https://readdy.ai/api/search-image?query=Boutique%20mountain%20hotel%20Vale%20Encantado%20with%20thematic%20decoration%2C%20romantic%20suites%2C%20fireplace%2C%20personalized%20services%2C%20couples%20accommodation&width=200&height=200&seq=vale_encantado&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Hotel%20Vale%20Encantado%20Urubici%20SC",
      tags: [
        { label: "Boutique", type: "feature", color: "red" },
        { label: "Suítes Românticas", type: "amenity", color: "pink" },
        { label: "Serviços Personalizados", type: "feature", color: "purple" }
      ]
    },
    {
      id: 5,
      nome: "Hotel Pedra Branca",
      categoria: "Hotel",
      descricao: "Hotel tradicional com arquitetura regional, restaurante típico, sala de eventos e localização privilegiada no centro.",
      whatsapp: "5548966554433",
      avaliacao: 4.4,
      imagem: "https://readdy.ai/api/search-image?query=Traditional%20mountain%20hotel%20Pedra%20Branca%20with%20regional%20architecture%2C%20typical%20restaurant%2C%20event%20hall%2C%20privileged%20downtown%20location&width=200&height=200&seq=pedra_branca&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Hotel%20Pedra%20Branca%20Urubici%20SC",
      tags: [
        { label: "Arquitetura Regional", type: "feature", color: "amber" },
        { label: "Restaurante Típico", type: "amenity", color: "orange" },
        { label: "Centro", type: "location", color: "blue" }
      ]
    },
    {
      id: 6,
      nome: "Hotel Boutique Serra",
      categoria: "Hotel Boutique",
      descricao: "Hotel boutique exclusivo com design contemporâneo, wine bar, concierge e experiências gastronômicas únicas.",
      whatsapp: "5548955443322",
      avaliacao: 4.9,
      imagem: "https://readdy.ai/api/search-image?query=Exclusive%20boutique%20mountain%20hotel%20with%20contemporary%20design%2C%20wine%20bar%2C%20concierge%20service%2C%20unique%20gastronomic%20experiences%2C%20luxury%20accommodation&width=200&height=200&seq=boutique_serra&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Hotel%20Boutique%20Serra%20Urubici%20SC",
      tags: [
        { label: "Design Contemporâneo", type: "feature", color: "cyan" },
        { label: "Wine Bar", type: "amenity", color: "red" },
        { label: "Concierge", type: "service", color: "purple" }
      ]
    }
  ];
      ...
      <div className="relative z-10 max-w-md mx-auto">
        ...
        <div className="px-4 mb-6">
          <div className="text-center">
            ...
            <p className="text-white/70 text-sm">Hotéis com conforto e serviços completos</p>
          </div>
        </div>
        ...
        <div className="px-4 mb-8">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20 shadow-lg">
            ...
            <div className="flex flex-wrap gap-2 justify-center">
              <button
                onClick={() => {
                  const element = document.getElementById('hoteis-em-urubici');
        ...
        <div className="px-4 mb-6">
          ...
          >
            ...
            <p className="text-white/70 text-sm">
              {hoteisData.length} {hoteisData.length === 1 ? 'hotel disponível' : 'hotéis disponíveis'}
            </p>
          </div>

          <div className="space-y-4">
            {hoteisData.map((hotel) => (
              <div key={hotel.id} className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20 shadow-lg hover:bg-white/15 transition-all duration-300">
                  ...
                  <div className="flex-1">
                            ...
                            {hotel.avaliacao ? (
                              <>
                                {[1, 2, 3, 4, 5].map((star) => (
                                  <i
                                    key={star}
                                    className={`${star <= Math.floor(hotel.avaliacao) ? 'ri-star-fill' : star <= hotel.avaliacao ? 'ri-star-half-fill' : 'ri-star-line'} text-yellow-400 text-sm`}
                                  ></i>
                                ))}
                    ...
                    <div className="flex flex-col gap-2">
                      <div className="flex gap-2">
                        {hotel.whatsapp ? (
                          <a
                            href={`https://wa.me/${hotel.whatsapp.replace(/\\D/g, '')}?text=Olá! Gostaria de informações sobre ${hotel.nome}`}
                            target="_blank"
                            rel="noopener noreferrer"
        ...
        {/* Call to Action - Cadastre seu Hotel */}
        <div className="px-4 mb-6">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg text-center">
            <div className="mb-4">
              ...
              <h3 className="text-white font-bold text-lg mb-2">Cadastre seu Hotel</h3>
              <p className="text-white/80 text-sm leading-relaxed mb-4">
                Você possui hotel em Urubici? Cadastre-se em nossa plataforma!
              </p>
            </div>

            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <a
                href="https://wa.me/5551986859236?text=Olá! Gostaria de cadastrar meu hotel no Portal Urubici"
                target="_blank"
                rel="noopener noreferrer"
