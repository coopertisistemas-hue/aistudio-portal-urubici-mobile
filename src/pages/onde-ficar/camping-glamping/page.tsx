...
export default function CampingGlamping() {
  ...
  const featuredAds = [
    {
      title: "Orion Glamping Urubici",
      subtitle: "Tendas glamping com conforto e vista da serra",
      image: "https://readdy.ai/api/search-image?query=Outdoor%20camping%20area%20with%20tents%20and%20glamping%20facilities%2C%20natural%20mountain%20setting%2C%20adventure%20tourism%2C%20outdoor%20recreation%2C%20camping%20infrastructure%2C%20beautiful%20landscape%2C%20nature%20experience&width=300&height=200&seq=glamping1&orientation=landscape",
      link: "#",
      isAd: true
    },
    {
      title: "Camping Urubici",
      subtitle: "Área de camping com estrutura completa",
      image: "https://readdy.ai/api/search-image?query=Mountain%20camping%20area%20with%20basic%20facilities%20in%20Urubici%20Santa%20Catarina%20Brazil%2C%20outdoor%20adventure%20accommodation%2C%20camping%20infrastructure%20in%20natural%20setting&width=300&height=200&seq=camping1&orientation=landscape",
      link: "#",
      isAd: true
    }
  ];
  ...
  // Dados dos campings e glamping organizados
  const campingData = [
    {
      id: 1,
      nome: "Camping Urubici",
      categoria: "Camping",
      descricao: "Camping com estrutura básica localizado a 6 km do centro. Ideal para aventureiros que buscam contato com a natureza.",
      imagem: "https://readdy.ai/api/search-image?query=Camping%20Urubici%20mountain%20camping%20area%20with%20basic%20facilities%20in%20Santa%20Catarina%20Brazil%2C%20outdoor%20adventure%20accommodation%2C%20camping%20infrastructure&width=200&height=200&seq=camping_urubici&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Camping%20Urubici%20Urubici%20SC",
      tags: [
        { label: "Camping", type: "category", color: "green" },
        { label: "Estrutura Básica", type: "feature", color: "orange" },
        { label: "6km do Centro", type: "location", color: "blue" }
      ]
    },
    {
      id: 2,
      nome: "Pousada Cajuva (Camping)",
      categoria: "Pousada/Camping",
      descricao: "Área de camping integrada à pousada, oferecendo opções de hospedagem flexíveis para diferentes perfis de viajantes.",
      imagem: "https://readdy.ai/api/search-image?query=Pousada%20Cajuva%20camping%20area%20with%20accommodation%20options%20in%20Urubici%20Santa%20Catarina%20Brazil%2C%20mixed%20lodging%20facility%20with%20camping%20and%20inn%20services&width=200&height=200&seq=cajuva_camping&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Pousada%20Cajuva%20Camping%20Urubici%20SC",
      tags: [
        { label: "Pousada", type: "category", color: "purple" },
        { label: "Camping", type: "category", color: "green" },
        { label: "Opções Flexíveis", type: "feature", color: "blue" }
      ]
    },
    {
      id: 3,
      nome: "Orion Glamping Urubici",
      categoria: "Glamping",
      descricao: "Tendas glamping com conforto e comodidades modernas. Experiência única de camping com luxo em meio à natureza.",
      imagem: "https://readdy.ai/api/search-image?query=Orion%20Glamping%20Urubici%20luxury%20camping%20tents%20with%20modern%20amenities%20in%20Santa%20Catarina%20Brazil%2C%20glamping%20accommodation%20with%20comfort%20and%20nature&width=200&height=200&seq=orion_glamping&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Orion%20Glamping%20Urubici%20Urubici%20SC",
      tags: [
        { label: "Glamping", type: "category", color: "purple" },
        { label: "Conforto Premium", type: "feature", color: "red" },
        { label: "Experiência Única", type: "feature", color: "orange" }
      ]
    }
  ];
  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className="relative z-10 max-w-md mx-auto">
        ...
        <div className="px-4 mb-6">
          <div className="text-center">
            <h2 className="text-white font-bold text-xl mb-2 flex items-center justify-center gap-2">
              <i className="ri-tent-line text-green-400"></i>
              Camping & Glamping
              <i className="ri-tent-line text-green-400"></i>
            </h2>
            <p className="text-white/70 text-sm">Áreas de camping e glamping para aventureiros</p>
          </div>
        </div>
        ...
        <div className="px-4 mb-8">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20 shadow-lg">
            ...
            <div className="flex flex-wrap gap-2 justify-center">
              ...
              <button
                onClick={() => navigate('/onde-ficar/hostels')}
        ...
        <div className="px-4 mb-6">
          <div className="mb-4">
            ...
            <p className="text-white/70 text-sm">
              {campingData.length} {campingData.length === 1 ? 'estabelecimento disponível' : 'estabelecimentos disponíveis'}
            </p>
          </div>

          <div className="space-y-4">
            {campingData.map((camping) => (
              <div key={camping.id} className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20 shadow-lg hover:bg-white/15 transition-all duration-300">
        ...
        {/* Call to Action - Cadastre sua Área */}
        <div className="px-4 mb-6">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg text-center">
            <div className="mb-4">
              ...
              <h3 className="text-white font-bold text-lg mb-2">Cadastre sua Área de Camping</h3>
              <p className="text-white/80 text-sm leading-relaxed mb-4">
                Você possui área de camping ou glamping em Urubici? Cadastre-se em nossa plataforma!
              </p>
            </div>

            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <a
                href="https://wa.me/5551986859236?text=Olá! Gostaria de cadastrar minha área de camping/glamping no Portal Urubici"
                target="_blank"
                rel="noopener noreferrer"
