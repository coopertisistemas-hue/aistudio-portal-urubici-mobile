...
export default function ChalesPage() {
  ...
  const featuredAds = [
    {
      title: "Chalé Vila Chamonix Premium",
      subtitle: "Chalé luxuoso com hidromassagem e vista panorâmica",
      image: "https://readdy.ai/api/search-image?query=Luxury%20mountain%20chalet%20with%20hot%20tub%2C%20fireplace%2C%20panoramic%20mountain%20views%2C%20romantic%20wooden%20architecture%2C%20cozy%20interior%2C%20warm%20lighting%2C%20surrounded%20by%20pine%20trees&width=300&height=200&seq=chale1&orientation=landscape",
      link: "#",
      isAd: true
    },
    {
      title: "Chalé Sonho de Sophia",
      subtitle: "Chalé romântico com decoração rústica e hidromassagem",
      image: "https://readdy.ai/api/search-image?query=Romantic%20rustic%20chalet%20with%20hot%20tub%2C%20cozy%20fireplace%2C%20wooden%20interior%2C%20garden%20setting%2C%20intimate%20atmosphere%2C%20mountain%20backdrop%2C%20warm%20ambient%20lighting&width=300&height=200&seq=chale2&orientation=landscape",
      link: "#",
      isAd: true
    }
  ];
  ...
  // Dados dos chalés organizados
  const chalesData = [
    {
      id: 1,
      nome: "Chalé Vila Chamonix Premium",
      categoria: "Chalé",
      descricao: "Chalé luxuoso com hidromassagem, lareira e vista panorâmica das montanhas. Perfeito para casais em busca de romance e conforto.",
      whatsapp: "5548999887766",
      avaliacao: 4.7,
      imagem: "https://readdy.ai/api/search-image?query=Luxury%20mountain%20chalet%20with%20hot%20tub%2C%20fireplace%2C%20panoramic%20mountain%20views%2C%20romantic%20wooden%20architecture%2C%20cozy%20interior%2C%20warm%20lighting%2C%20surrounded%20by%20pine%20trees&width=200&height=200&seq=chale_chamonix&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Chalé%20Vila%20Chamonix%20Premium%20Urubici%20SC",
      tags: [
        { label: "Hidromassagem", type: "amenity", color: "blue" },
        { label: "Lareira", type: "amenity", color: "orange" },
        { label: "Vista Montanha", type: "feature", color: "green" }
      ]
    },
    {
      id: 2,
      nome: "Chalé Sonho de Sophia",
      categoria: "Chalé",
      descricao: "Chalé romântico com decoração rústica, banheira de hidromassagem e ambiente aconchegante. Ideal para lua de mel e momentos especiais.",
      whatsapp: "5548988776655",
      avaliacao: 4.5,
      imagem: "https://readdy.ai/api/search-image?query=Romantic%20rustic%20chalet%20with%20hot%20tub%2C%20cozy%20fireplace%2C%20wooden%20interior%2C%20garden%20setting%2C%20intimate%20atmosphere%2C%20mountain%20backdrop%2C%20warm%20ambient%20lighting&width=200&height=200&seq=chale_sophia&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Chalé%20Sonho%20de%20Sophia%20Urubici%20SC",
      tags: [
        { label: "Romântico", type: "feature", color: "pink" },
        { label: "Hidromassagem", type: "amenity", color: "blue" },
        { label: "Decoração Rústica", type: "feature", color: "amber" }
      ]
    },
    {
      id: 3,
      nome: "Chalé Refúgio Serra e Flor",
      categoria: "Chalé",
      descricao: "Chalé aconchegante em meio à natureza, com hidromassagem externa e área gourmet. Perfeito para relaxar e contemplar a serra.",
      whatsapp: "",
      avaliacao: 4.3,
      imagem: "https://readdy.ai/api/search-image?query=Cozy%20mountain%20chalet%20surrounded%20by%20nature%2C%20outdoor%20hot%20tub%2C%20gourmet%20area%2C%20peaceful%20setting%2C%20forest%20environment%2C%20wooden%20deck%2C%20mountain%20views&width=200&height=200&seq=chale_refugio&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Chalé%20Refúgio%20Serra%20e%20Flor%20Urubici%20SC",
      tags: [
        { label: "Natureza", type: "feature", color: "green" },
        { label: "Hidro Externa", type: "amenity", color: "blue" },
        { label: "Área Gourmet", type: "amenity", color: "purple" }
      ]
    },
    {
      id: 4,
      nome: "Chalé Herança do Velho Pai",
      categoria: "Chalé",
      descricao: "Chalé rural com arquitetura tradicional, lareira a lenha e ambiente familiar. Experiência autêntica da vida no campo.",
      whatsapp: "5548977665544",
      avaliacao: 4.6,
      imagem: "https://readdy.ai/api/search-image?query=Traditional%20rural%20chalet%20with%20authentic%20architecture%2C%20wood-burning%20fireplace%2C%20family%20atmosphere%2C%20countryside%20setting%2C%20rustic%20charm%2C%20mountain%20landscape&width=200&height=200&seq=chale_heranca&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Chalé%20Herança%20do%20Velho%20Pai%20Urubici%20SC",
      tags: [
        { label: "Rural", type: "feature", color: "amber" },
        { label: "Tradicional", type: "feature", color: "orange" },
        { label: "Lareira a Lenha", type: "amenity", color: "orange" }
      ]
    },
    {
      id: 5,
      nome: "Chalé Império das Montanhas",
      categoria: "Chalé",
      descricao: "Chalé moderno com piscina aquecida, sauna e área de lazer completa. Combina conforto contemporâneo com a beleza natural da serra.",
      whatsapp: "5548966554433",
      avaliacao: 4.8,
      imagem: "https://readdy.ai/api/search-image?query=Modern%20mountain%20chalet%20with%20heated%20pool%2C%20sauna%2C%20leisure%20area%2C%20contemporary%20design%2C%20luxury%20amenities%2C%20mountain%20setting%2C%20elegant%20architecture&width=200&height=200&seq=chale_imperio&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Chalé%20Império%20das%20Montanhas%20Urubici%20SC",
      tags: [
        { label: "Piscina Aquecida", type: "amenity", color: "blue" },
        { label: "Sauna", type: "amenity", color: "purple" },
  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className="relative z-10 max-w-md mx-auto">
                  ...
                  <div className="relative overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 group cursor-pointer bg-white/10 backdrop-blur-md border border-white/20 rounded-3xl hover:bg-white/15 hover:scale-105">
                    ...
                    >
                      <div className="relative h-48 overflow-hidden rounded-t-3xl">
                        ...
                        <div className="absolute top-4 left-4 px-3 py-1 rounded-full text-xs font-medium shadow-lg bg-amber-600/90 text-white">
                          Chalé
                        </div>
                      </div>
                      <div className="p-6">
                        <h3 className="font-bold text-white text-xl mb-2 leading-tight group-hover:text-amber-200 transition-colors">
                          {ad.title}
                        </h3>
                        <p className="text-white/80 text-sm leading-relaxed mb-4">
                          {ad.subtitle}
                        </p>
                        <div className="inline-flex items-center gap-2 px-6 py-3 rounded-xl font-semibold text-sm transition-all duration-200 whitespace-nowrap shadow-lg hover:shadow-xl transform hover:scale-105 bg-gradient-to-r from-amber-600 to-amber-700 hover:from-amber-700 hover:to-amber-800 text-white">
        ...
        <div className="px-4 mb-6">
          <div className="text-center">
            <h2 className="text-white font-bold text-xl mb-2 flex items-center justify-center gap-2">
              <i className="ri-home-5-line text-amber-400"></i>
              Chalés
              <i className="ri-home-5-line text-amber-400"></i>
            </h2>
            <p className="text-white/70 text-sm">Chalés charmosos para uma experiência única na serra</p>
          </div>
        </div>
        ...
        <div className="px-4 mb-8">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20 shadow-lg">
            ...
            <div className="flex flex-wrap gap-2 justify-center">
              <button
                onClick={() => {
                  const element = document.getElementById('chales-em-urubici');
                  if (element) element.scrollIntoView({ behavior: 'smooth' });
                }}
                className="bg-amber-500/20 hover:bg-amber-400/30 hover:scale-105 active:scale-95 text-amber-200 font-medium px-4 py-2.5 rounded-full shadow-sm transition-all duration-200 focus:outline-none focus:ring-amber-300/50 min-h-[44px] text-sm whitespace-nowrap"
              >
                Chalés em Urubici
              </button>
            </div>
        ...
        <div className="px-4 mb-6">
          ...
          >
            ...
            <p className="text-white/70 text-sm">
              {chalesData.length} {chalesData.length === 1 ? 'chalé disponível' : 'chalés disponíveis'}
            </p>
          </div>

          <div className="space-y-4">
            {chalesData.map((chale) => (
              <div key={chale.id} className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20 shadow-lg hover:bg-white/15 transition-all duration-300">
                  ...
                  <div className="flex-1">
                            ...
                            {chale.avaliacao ? (
                              <>
                                {[1, 2, 3, 4, 5].map((star) => (
                                  <i
                                    key={star}
                                    className={`${star <= Math.floor(chale.avaliacao) ? 'ri-star-fill' : star <= chale.avaliacao ? 'ri-star-half-fill' : 'ri-star-line'} text-yellow-400 text-sm`}
                                  ></i>
                                ))}
                                <span className="text-yellow-300 text-xs font-medium ml-1">
                                  {chale.avaliacao.toFixed(1)}
                                </span>
                              </>
                            ) : (
                              <>
                    ...
                    <div className="flex flex-col gap-2">
                      <div className="flex gap-2">
                        {chale.whatsapp ? (
                          <a
                            href={`https://wa.me/${chale.whatsapp.replace(/\\D/g, '')}?text=Olá! Gostaria de informações sobre ${chale.nome}`}
                            target="_blank"
                            rel="noopener noreferrer"
        ...
        {/* Call to Action - Cadastre seu Chalé */}
        <div className="px-4 mb-6">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg text-center">
            <div className="mb-4">
              <i className="ri-add-circle-line text-amber-400 text-4xl mb-3"></i>
              <h3 className="text-white font-bold text-lg mb-2">Cadastre seu Chalé</h3>
              <p className="text-white/80 text-sm leading-relaxed mb-4">
                Você possui chalé em Urubici? Cadastre-se em nossa plataforma!
              </p>
            </div>

            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <a
                href="https://wa.me/5551986859236?text=Olá! Gostaria de cadastrar meu chalé no Portal Urubici"
                target="_blank"
                rel="noopener noreferrer"
