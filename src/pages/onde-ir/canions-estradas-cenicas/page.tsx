...
export default function CanionsEstradasCenicas() {
  ...
  const featuredAds = [
    {
      ...
      subtitle: "SC-370 com maior corte em rocha do Brasil (~90m)",
      image: "https://readdy.ai/api/search-image?query=Serra%20do%20Corvo%20Branco%20scenic%20road%20SC-370%20with%20largest%20rock%20cut%20in%20Brazil%2090%20meters%2C%20dramatic%20mountain%20highway%2C%20scenic%20route%20between%20Urubici%20and%20Gr%C3%A3o-Par%C3%A1&width=300&height=200&seq=serra_corvo_branco&orientation=landscape",
      link: "#",
      isAd: true
    },
    {
      title: "Cânion do Espraiado",
      subtitle: "Mirantes e paredões com acesso por estrada de terra",
      image: "https://readdy.ai/api/search-image?query=C%C3%A2nion%20do%20Espraiado%20canyon%20viewpoints%20and%20cliff%20walls%2C%20dirt%20road%20access%2C%204x4%20recommended%2C%20dramatic%20canyon%20landscape%2C%20Urubici%20Santa%20Catarina&width=300&height=200&seq=canion_espraiado&orientation=landscape",
      link: "#",
      isAd: true
    }
  ];
  ...
  const partners = [
    {
      ...
      description: "Especialistas em trilhas e cânions da região",
      image: "https://readdy.ai/api/search-image?query=Adventure%20tourism%20logo%20specialized%20in%20trails%20and%20canyons%2C%20mountain%20adventure%20company%2C%20outdoor%20activities&width=100&height=100&seq=adventure_logo&orientation=squarish"
    },
    {
      name: "Guias 4x4",
      description: "Acesso seguro aos cânions com veículos especializados",
      image: "https://readdy.ai/api/search-image?query=4x4%20guides%20logo%20specialized%20vehicles%20for%20canyon%20access%2C%20off-road%20tourism%2C%20mountain%20driving&width=100&height=100&seq=4x4_logo&orientation=squarish"
    },
    {
      name: "Fotografia Aérea",
      description: "Registros únicos dos cânions e estradas cênicas",
      image: "https://readdy.ai/api/search-image?query=Aerial%20photography%20logo%20unique%20canyon%20and%20scenic%20road%20records%2C%20drone%20photography%2C%20landscape%20documentation&width=100&height=100&seq=aerial_logo&orientation=squarish"
    }
  ];

  // Dados dos cânions e estradas cênicas organizados
  const atrativos = [
    {
      id: 1,
      nome: "Serra do Corvo Branco",
      categoria: "Estrada cênica/Corte na rocha",
      descricao: "SC-370 com maior corte em rocha do Brasil (~90m); trecho entre Urubici e Grão-Pará.",
      whatsapp: "",
      avaliacao: 4.8,
      imagem: "https://readdy.ai/api/search-image?query=Serra%20do%20Corvo%20Branco%20scenic%20highway%20SC-370%20largest%20rock%20cut%20Brazil%2090%20meters%2C%20mountain%20road%20between%20Urubici%20and%20Gr%C3%A3o-Par%C3%A1&width=200&height=200&seq=serra_corvo_card&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Serra%20do%20Corvo%20Branco%20Urubici%20SC",
      tags: [
        { label: "Estrada cênica", type: "location", color: "blue" },
        { label: "Mirante", type: "location", color: "green" },
        { label: "Atenção", type: "feature", color: "amber" }
      ]
    },
    {
      id: 2,
      nome: "Cânion do Espraiado (acesso pela região)",
      categoria: "Cânion/Mirantes",
      descricao: "Mirantes e paredões; acesso por estrada de terra, 4x4 recomendado.",
      whatsapp: "",
      avaliacao: 4.6,
      imagem: "https://readdy.ai/api/search-image?query=C%C3%A2nion%20do%20Espraiado%20canyon%20viewpoints%20cliff%20walls%2C%20dirt%20road%20access%2C%204x4%20recommended%2C%20dramatic%20canyon%20landscape&width=200&height=200&seq=canion_espraiado_card&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=C%C3%A2nion%20do%20Espraiado%20%28acesso%20pela%20regi%C3%A3o%29%20Urubici%20SC",
      tags: [
        { label: "Cânion", type: "location", color: "blue" },
        { label: "4x4 recomendado", type: "service", color: "amber" }
      ]
    }
  ];
        ...
        <div className="px-4 mb-6">
          <div className="text-center">
            <h2 className="text-white font-bold text-xl mb-2 flex items-center justify-center gap-2">
              <i className="ri-road-map-line text-green-400"></i>
              Cânions & Estradas Cênicas
              <i className="ri-road-map-line text-green-400"></i>
            </h2>
            <p className="text-white/70 text-sm">Paisagens dramáticas e rotas espetaculares da serra</p>
          </div>
        </div>
        ...
        <div className="px-4 mb-8">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20 shadow-lg">
            ...
            <div className="flex flex-wrap gap-2 justify-center">
              <button
                onClick={() => {
                  const element = document.getElementById('canions-estradas');
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      >
                        ...
                        <span>Contratar Transporte</span>
                      </button>
                    </div>
        ...
        <div className="px-4 mb-6">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg text-center">
            <div className="mb-4">
              ...
              <p className="text-white/80 text-sm leading-relaxed mb-4">
                Explore os cânions e estradas cênicas com segurança e conhecimento local!
              </p>
            </div>

            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <a
                href="https://wa.me/5551986859236?text=Olá! Gostaria de contratar um guia para os cânions e estradas cênicas de Urubici"
                target="_blank"
                rel="noopener noreferrer"
