...
export default function GrutasCavernas() {
  ...
  const featuredAds = [
    {
      title: "Gruta Nossa Senhora de Lourdes",
      subtitle: "Gruta natural com queda d'água e ponto de peregrinação",
      image: "https://readdy.ai/api/search-image?query=Gruta%20Nossa%20Senhora%20de%20Lourdes%20natural%20cave%20with%20waterfall%2010%20meters%20and%20religious%20pilgrimage%20site%2C%20image%20since%201944%2C%20short%20trail%2C%20Urubici%20Santa%20Catarina&width=300&height=200&seq=gruta_lourdes&orientation=landscape",
      link: "#",
      isAd: true
    },
    {
      title: "Caverna Rio dos Bugres",
      subtitle: "Conjunto de cavernas com acesso controlado",
      image: "https://readdy.ai/api/search-image?query=Caverna%20Rio%20dos%20Bugres%20cave%20complex%20with%20controlled%20access%2C%20guide%20recommended%2C%20underground%20formations%2C%20cave%20exploration%2C%20Urubici%20Santa%20Catarina&width=300&height=200&seq=caverna_bugres&orientation=landscape",
      link: "#",
      isAd: true
    }
  ];
  ...
  const partners = [
    {
      name: "Espeleologia Serra",
      description: "Especialistas em exploração de cavernas e grutas",
      image: "https://readdy.ai/api/search-image?query=Espeleologia%20Serra%20logo%20cave%20and%20grotto%20exploration%20specialists%2C%20speleology%2C%20underground%20tourism&width=100&height=100&seq=espeleologia_logo&orientation=squarish"
    },
    {
      name: "Turismo Religioso",
      description: "Roteiros de peregrinação e turismo religioso",
      image: "https://readdy.ai/api/search-image?query=Turismo%20Religioso%20logo%20pilgrimage%20routes%20and%20religious%20tourism%2C%20spiritual%20tourism%2C%20faith-based%20travel&width=100&height=100&seq=religioso_logo&orientation=squarish"
    },
    {
      name: "Guias Subterrâneos",
      description: "Guias especializados em formações subterrâneas",
      image: "https://readdy.ai/api/search-image?query=Guias%20Subterr%C3%A2neos%20logo%20specialized%20guides%20for%20underground%20formations%2C%20cave%20guides%2C%20subterranean%20exploration&width=100&height=100&seq=subterraneo_logo&orientation=squarish"
    }
  ];

  // Dados das grutas e cavernas organizados
  const atrativos = [
    {
      id: 1,
      nome: "Gruta Nossa Senhora de Lourdes",
      categoria: "Gruta religiosa",
      descricao: "Gruta natural com queda d'água (~10m) e imagem desde 1944; ponto de peregrinação.",
      whatsapp: "",
      avaliacao: 4.7,
      imagem: "https://readdy.ai/api/search-image?query=Gruta%20Nossa%20Senhora%20de%20Lourdes%20natural%20cave%20with%2010m%20waterfall%2C%20religious%20image%20since%201944%2C%20pilgrimage%20site%2C%20short%20trail&width=200&height=200&seq=gruta_lourdes_card&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Gruta%20Nossa%20Senhora%20de%20Lourdes%20Urubici%20SC",
      tags: [
        { label: "Religioso", type: "feature", color: "purple" },
        { label: "Queda d'água", type: "location", color: "blue" },
        { label: "Trilha curta", type: "feature", color: "green" }
      ]
    },
    {
      id: 2,
      nome: "Caverna Rio dos Bugres",
      categoria: "Caverna",
      descricao: "Conjunto de cavernas; acesso controlado/guia recomendado.",
      whatsapp: "",
      avaliacao: 4.5,
      imagem: "https://readdy.ai/api/search-image?query=Caverna%20Rio%20dos%20Bugres%20cave%20complex%20controlled%20access%2C%20guide%20recommended%2C%20underground%20formations%2C%20cave%20exploration&width=200&height=200&seq=caverna_bugres_card&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Caverna%20Rio%20dos%20Bugres%20Urubici%20SC",
      tags: [
        { label: "Caverna", type: "location", color: "amber" },
        { label: "Guia recomendado", type: "service", color: "orange" }
      ]
    }
  ];
        ...
        <div className="px-4 mb-6">
          <div className="text-center">
            <h2 className="text-white font-bold text-xl mb-2 flex items-center justify-center gap-2">
              <i className="ri-cave-line text-green-400"></i>
              Grutas & Cavernas
              <i className="ri-cave-line text-green-400"></i>
            </h2>
            <p className="text-white/70 text-sm">Formações subterrâneas e mistérios da natureza</p>
          </div>
        </div>
        ...
        <div className="px-4 mb-8">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20 shadow-lg">
            ...
            <div className="flex flex-wrap gap-2 justify-center">
              <button
                onClick={() => {
                  const element = document.getElementById('grutas-cavernas');
        ...
        <div className="px-4 mb-6">
          ...
          >
            ...
            <p className="text-white/70 text-sm">
              {atrativos.length} {atrativos.length === 1 ? 'formação disponível' : 'formações disponíveis'}
            </p>
          </div>
        ...
        <div className="px-4 mb-6">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg text-center">
            <div className="mb-4">
              ...
              <p className="text-white/80 text-sm leading-relaxed mb-4">
                Explore as grutas e cavernas com segurança e conhecimento especializado!
              </p>
            </div>

            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <a
                href="https://wa.me/5551986859236?text=Olá! Gostaria de contratar um guia para as grutas e cavernas de Urubici"
                target="_blank"
                rel="noopener noreferrer"
        ...
        <div className="w-full mb-6">
          <div className="px-4 mb-4">
            ...
            <p className="text-white/70 text-xs text-center mt-1">
              Conheça nossos parceiros especializados em espeleologia
            </p>
          </div>
