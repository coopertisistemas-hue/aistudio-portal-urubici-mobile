...
export default function MirantesMontanhas() {
  ...
  const featuredAds = [
    {
      ...
      subtitle: "Vista para a Pedra Furada - Local mais frio do Brasil",
      image: "https://readdy.ai/api/search-image?query=Morro%20da%20Igreja%20viewpoint%20with%20Pedra%20Furada%20rock%20formation%20view%2C%20coldest%20place%20in%20Brazil%2C%20mountain%20landscape%2C%20dramatic%20rocky%20peaks%2C%20Urubici%20Santa%20Catarina&width=300&height=200&seq=morro_igreja&orientation=landscape",
      link: "#",
      isAd: true
    },
    {
      title: "Morro do Campestre",
      subtitle: "Formação de arenito em arco com vista do Vale do Canoas",
      image: "https://readdy.ai/api/search-image?query=Morro%20do%20Campestre%20sandstone%20arch%20formation%20with%20Canoas%20Valley%20view%2C%20natural%20rock%20arch%2C%20mountain%20viewpoint%2C%20scenic%20landscape%2C%20Urubici%20Santa%20Catarina&width=300&height=200&seq=morro_campestre&orientation=landscape",
      link: "#",
      isAd: true
    }
  ];
  ...
  const partners = [
    {
      name: "ICMBio Urubici",
      description: "Agendamento para visitação do Morro da Igreja",
      image: "https://readdy.ai/api/search-image?query=ICMBio%20logo%20environmental%20protection%20agency%20Brazil%2C%20national%20park%20management%2C%20conservation%20organization&width=100&height=100&seq=icmbio_logo&orientation=squarish"
    },
    {
      name: "Guias Locais",
      description: "Guias especializados em trilhas e mirantes",
      image: "https://readdy.ai/api/search-image?query=Local%20mountain%20guides%20logo%20Urubici%20Santa%20Catarina%20Brazil%2C%20hiking%20trail%20specialists%2C%20mountain%20tourism&width=100&height=100&seq=guias_logo&orientation=squarish"
    },
    {
      name: "Turismo Rural",
      description: "Experiências autênticas na serra catarinense",
      image: "https://readdy.ai/api/search-image?query=Rural%20tourism%20logo%20serra%20catarinense%20Brazil%2C%20authentic%20mountain%20experiences%2C%20countryside%20tourism&width=100&height=100&seq=rural_logo&orientation=squarish"
    }
  ];

  // Dados dos mirantes e montanhas organizados
  const atrativos = [
    {
      id: 1,
      nome: "Morro da Igreja (Pedra Furada)",
      categoria: "Mirante/Altitude",
      descricao: "Acesso por agendamento ICMBio; vista para a Pedra Furada; local mais frio do Brasil.",
      whatsapp: "",
      avaliacao: 4.9,
      imagem: "https://readdy.ai/api/search-image?query=Morro%20da%20Igreja%20viewpoint%20with%20Pedra%20Furada%20rock%20formation%2C%20coldest%20place%20Brazil%2C%20dramatic%20mountain%20landscape%2C%20rocky%20peaks%2C%20scenic%20overlook&width=200&height=200&seq=morro_igreja_card&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Morro%20da%20Igreja%20%28Pedra%20Furada%29%20Urubici%20SC",
      tags: [
        { label: "Mirante", type: "location", color: "green" },
        { label: "Alto", type: "feature", color: "blue" },
        { label: "Frio", type: "feature", color: "cyan" },
        { label: "Agendamento ICMBio", type: "service", color: "amber" }
      ]
    },
    {
      id: 2,
      nome: "Morro do Campestre",
      categoria: "Formação Rochosa/Mirante",
      descricao: "Formação de arenito em arco com vista do Vale do Canoas; acesso privado.",
      whatsapp: "",
      avaliacao: 4.7,
      imagem: "https://readdy.ai/api/search-image?query=Morro%20do%20Campestre%20sandstone%20arch%20formation%2C%20Canoas%20Valley%20view%2C%20natural%20rock%20arch%2C%20mountain%20viewpoint%2C%20private%20access&width=200&height=200&seq=morro_campestre_card&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Morro%20do%20Campestre%20Urubici%20SC",
      tags: [
        { label: "Mirante", type: "location", color: "green" },
        { label: "Arenito", type: "feature", color: "amber" },
        { label: "Vista", type: "feature", color: "blue" }
      ]
    }
  ];
        ...
        <div className="px-4 mb-6">
          <div className="text-center">
            <h2 className="text-white font-bold text-xl mb-2 flex items-center justify-center gap-2">
              <i className="ri-landscape-line text-green-400"></i>
              Mirantes & Montanhas
              <i className="ri-landscape-line text-green-400"></i>
            </h2>
            <p className="text-white/70 text-sm">Vistas panorâmicas e formações rochosas espetaculares</p>
          </div>
        </div>
        ...
        <div className="px-4 mb-8">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20 shadow-lg">
            ...
            <div className="flex flex-wrap gap-2 justify-center">
              <button
                onClick={() => {
                  const element = document.getElementById('mirantes-montanhas');
        ...
        <div className="px-4 mb-6">
          ...
          >
            ...
            <p className="text-white/70 text-sm">
              {atrativos.length} {atrativos.length === 1 ? 'atrativo disponível' : 'atrativos disponíveis'}
            </p>
          </div>
        ...
        <div className="px-4 mb-6">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg text-center">
            <div className="mb-4">
              ...
              <p className="text-white/80 text-sm leading-relaxed mb-4">
                Explore os mirantes e montanhas com segurança e conhecimento local!
              </p>
            </div>

            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <a
                href="https://wa.me/5551986859236?text=Olá! Gostaria de contratar um guia para os mirantes e montanhas de Urubici"
                target="_blank"
                rel="noopener noreferrer"
        ...
        <div className="w-full mb-6">
          <div className="px-4 mb-4">
            ...
            <p className="text-white/70 text-xs text-center mt-1">
              Conheça nossos parceiros especializados em turismo de montanha
            </p>
          </div>
