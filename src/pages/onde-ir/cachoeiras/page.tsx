...
export default function Cachoeiras() {
  ...
  const featuredAds = [
    {
      ...
      subtitle: "Queda de ~100m com mirantes e atividades de aventura",
      image: "https://readdy.ai/api/search-image?query=Cascata%20do%20Avencal%20waterfall%20100%20meters%20high%20with%20viewpoints%20and%20adventure%20activities%2C%20Parque%20Mundo%20Novo%2C%20zipline%2C%20upper%20and%20lower%20access%2C%20Urubici%20Santa%20Catarina&width=300&height=200&seq=cascata_avencal&orientation=landscape",
      link: "#",
      isAd: true
    },
    {
      title: "Cascata Véu de Noiva",
      subtitle: "Queda ~60m com passarela e trilha curta de fácil acesso",
      image: "https://readdy.ai/api/search-image?query=Cascata%20V%C3%A9u%20de%20Noiva%20waterfall%2060%20meters%20high%20with%20walkway%20and%20short%20easy%20access%20trail%2C%20entrance%20fee%2C%20beautiful%20mountain%20waterfall%2C%20Urubici%20Santa%20Catarina&width=300&height=200&seq=cascata_veu_noiva&orientation=landscape",
      link: "#",
      isAd: true
    }
  ];
  ...
  const partners = [
    {
      ...
      description: "Estrutura completa para visitação da Cascata do Avencal",
      image: "https://readdy.ai/api/search-image?query=Parque%20Mundo%20Novo%20logo%20complete%20structure%20for%20Cascata%20do%20Avencal%20visitation%2C%20adventure%20park%2C%20waterfall%20tourism&width=100&height=100&seq=mundo_novo_logo&orientation=squarish"
    },
    {
      name: "Ecoturismo Serra",
      description: "Guias especializados em trilhas para cachoeiras",
      image: "https://readdy.ai/api/search-image?query=Ecoturismo%20Serra%20logo%20specialized%20guides%20for%20waterfall%20trails%2C%20mountain%20ecotourism%2C%20nature%20tourism&width=100&height=100&seq=ecoturismo_logo&orientation=squarish"
    },
    {
      name: "Aventura Radical",
      description: "Atividades de aventura nas cachoeiras da região",
      image: "https://readdy.ai/api/search-image?query=Aventura%20Radical%20logo%20adventure%20activities%20at%20regional%20waterfalls%2C%20extreme%20sports%2C%20waterfall%20adventures&width=100&height=100&seq=aventura_logo&orientation=squarish"
    }
  ];

  // Dados das cachoeiras organizados
  const atrativos = [
    {
      id: 1,
      nome: "Cascata do Avencal (Parque Mundo Novo)",
      categoria: "Cachoeira/Parque",
      descricao: "Queda de ~100m com mirantes e atividades de aventura; acesso superior e inferior.",
      whatsapp: "",
      avaliacao: 4.8,
      imagem: "https://readdy.ai/api/search-image?query=Cascata%20do%20Avencal%20waterfall%20100%20meters%20Parque%20Mundo%20Novo%20with%20viewpoints%20adventure%20activities%2C%20zipline%2C%20upper%20lower%20access&width=200&height=200&seq=avencal_card&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Cascata%20do%20Avencal%20%28Parque%20Mundo%20Novo%29%20Urubici%20SC",
      tags: [
        { label: "Cachoeira", type: "location", color: "blue" },
        { label: "Mirantes", type: "feature", color: "green" },
        { label: "Tirolesa", type: "amenity", color: "orange" },
        { label: "Estrutura", type: "feature", color: "purple" }
      ]
    },
    {
      id: 2,
      ...
      categoria: "Cachoeira",
      descricao: "Queda ~60m; passarela e trilha curta com fácil acesso; ingresso cobrado.",
      whatsapp: "",
      avaliacao: 4.7,
      imagem: "https://readdy.ai/api/search-image?query=Cascata%20V%C3%A9u%20de%20Noiva%20waterfall%2060%20meters%20with%20walkway%20short%20trail%20easy%20access%2C%20entrance%20fee%2C%20mountain%20waterfall&width=200&height=200&seq=veu_noiva_card&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Cascata%20V%C3%A9u%20de%20Noiva%20Urubici%20SC",
      tags: [
        { label: "Cachoeira", type: "location", color: "blue" },
        { label: "Passarela", type: "feature", color: "green" },
        { label: "Fácil acesso", type: "feature", color: "green" }
      ]
    },
    {
      id: 3,
      nome: "Cachoeira do Arroio do Engenho",
      categoria: "Cachoeira (propriedade privada)",
      descricao: "Quedas de 85m e 50m; propriedade particular aberta à visitação; camping no local.",
      whatsapp: "",
      avaliacao: 4.6,
      imagem: "https://readdy.ai/api/search-image?query=Cachoeira%20do%20Arroio%20do%20Engenho%20waterfalls%2085m%20and%2050m%20private%20property%20open%20for%20visitation%2C%20camping%20on%20site&width=200&height=200&seq=arroio_engenho_card&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Cachoeira%20do%20Arroio%20do%20Engenho%20Urubici%20SC",
      tags: [
        { label: "Cachoeira", type: "location", color: "blue" },
        { label: "Propriedade privada", type: "feature", color: "amber" },
      ...
      <div className="relative z-10 max-w-md mx-auto">
        ...
        <div className="px-4 mb-6">
          <div className="text-center">
            <h2 className="text-white font-bold text-xl mb-2 flex items-center justify-center gap-2">
              <i className="ri-water-flash-line text-green-400"></i>
              Cachoeiras
              <i className="ri-water-flash-line text-green-400"></i>
            </h2>
            <p className="text-white/70 text-sm">Quedas d'água cristalinas em meio à natureza exuberante</p>
          </div>
        </div>
        ...
        <div className="px-4 mb-8">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20 shadow-lg">
            ...
            <div className="flex flex-wrap gap-2 justify-center">
              <button
                onClick={() => {
                  const element = document.getElementById('cachoeiras');
        ...
        <div className="px-4 mb-6">
          ...
          >
            ...
            <p className="text-white/70 text-sm">
              {atrativos.length} {atrativos.length === 1 ? 'cachoeira disponível' : 'cachoeiras disponíveis'}
            </p>
          </div>
        ...
        <div className="px-4 mb-6">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg text-center">
            <div className="mb-4">
              <i className="ri-compass-3-line text-green-400 text-4xl mb-3"></i>
              <h3 className="text-white font-bold text-lg mb-2">Precisa de um Guia?</h3>
              <p className="text-white/80 text-sm leading-relaxed mb-4">
                Explore as cachoeiras com segurança e conhecimento local!
              </p>
            </div>

            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <a
                href="https://wa.me/5551986859236?text=Olá! Gostaria de contratar um guia para as cachoeiras de Urubici"
                target="_blank"
                rel="noopener noreferrer"
        ...
        <div className="w-full mb-6">
          <div className="px-4 mb-4">
            <h3 className="text-white font-bold text-sm uppercase tracking-wider text-center flex items-center justify-center gap-2">
              ...
              Parceiros Turísticos
              <i className="ri-star-line text-yellow-400"></i>
            </h3>
            <p className="text-white/70 text-xs text-center mt-1">
              Conheça nossos parceiros especializados em ecoturismo
            </p>
          </div>
