...
export default function OQueFazer() {
  ...
  const featuredAds = [
    {
      ...
      subtitle: "Turismo de Aventura & Ecoturismo",
      image: "https://readdy.ai/api/search-image?query=Adventure%20tourism%20company%20in%20Urubici%20Santa%20Catarina%20Brazil%20with%20mountain%20trekking%20guides%2C%20outdoor%20activities%20and%20adventure%20sports%2C%20professional%20adventure%20tourism%20services%20in%20serra%20catarinense&width=300&height=200&seq=adventure1&orientation=landscape",
      link: "#",
      isAd: true
    },
    {
      title: "Rapel Pedra Furada",
      subtitle: "Rapel & Escalada",
      image: "https://readdy.ai/api/search-image?query=Rock%20climbing%20and%20rappelling%20at%20Pedra%20Furada%20in%20Urubici%20Santa%20Catarina%20Brazil%2C%20adventure%20sports%20with%20professional%20guides%2C%20extreme%20sports%20in%20mountain%20landscape&width=300&height=200&seq=rapel1&orientation=landscape",
      link: "#",
      isAd: true
    },
    {
      title: "Enoturismo Serra Azul",
      subtitle: "Vinícolas & Degustação",
      image: "https://readdy.ai/api/search-image?query=Wine%20tourism%20experience%20in%20Serra%20Azul%20vineyard%20Urubici%20Santa%20Catarina%20Brazil%2C%20wine%20tasting%20and%20vineyard%20tours%2C%20enotourism%20in%20high%20altitude%20mountain%20winery&width=300&height=200&seq=wine1&orientation=landscape",
      link: "#",
      isAd: true
    }
  ];
  ...
  const partners = [
    ...
    {
      name: "Rapel Extremo",
      description: "Rapel, canyoning e escalada profissional",
      image:
        "https://readdy.ai/api/search-image?query=Extreme%20sports%20logo%20Rapel%20Extremo%20Urubici%20Santa%20Catarina%20Brazil%2C%20rock%20climbing%20and%20rappelling%20brand%20identity&width=100&height=100&seq=logo8&orientation=squarish"
    },
    {
    ...
    {
      name: "Quadriciclo Adventures",
      description: "Passeios de quadriciclo e off-road",
      image:
        "https://readdy.ai/api/search-image?query=ATV%20quad%20bike%20tours%20logo%20Quadriciclo%20Adventures%20Urubici%20Santa%20Catarina%20Brazil%2C%20off-road%20adventure%20brand%20identity&width=100&height=100&seq=logo9&orientation=squarish"
    },
    {
      name: "Fazenda Experiência",
      description: "Turismo rural e vivências autênticas",
      image:
        "https://readdy.ai/api/search-image?query=Rural%20tourism%20farm%20logo%20Fazenda%20Experi%C3%AAncia%20Urubici%20Santa%20Catarina%20Brazil%2C%20agrotourism%20brand%20identity&width=100&height=100&seq=logo10&orientation=squarish"
    },
    {
      name: "Observatório Céu Azul",
      description: "Observação astronômica e fotografia",
      image:
        "https://readdy.ai/api/search-image?query=Astronomical%20observatory%20logo%20Observat%C3%B3rio%20C%C3%A9u%20Azul%20Urubici%20Santa%20Catarina%20Brazil%2C%20stargazing%20and%20astronomy%20brand%20identity&width=100&height=100&seq=logo11&orientation=squarish"
    },
    {
      name: "Spa Montanha",
      description: "Bem-estar e relaxamento na natureza",
      image:
        "https://readdy.ai/api/search-image?query=Mountain%20spa%20wellness%20logo%20Spa%20Montanha%20Urubici%20Santa%20Catarina%20Brazil%2C%20wellness%20and%20relaxation%20brand%20identity&width=100&height=100&seq=logo12&orientation=squarish"
    },
    {
      name: "Cavalgadas do Vale",
      description: "Passeios a cavalo pela serra",
      image:
        "https://readdy.ai/api/search-image?query=Horse%20riding%20tours%20logo%20Cavalgadas%20do%20Vale%20Urubici%20Santa%20Catarina%20Brazil%2C%20equestrian%20tourism%20brand%20identity&width=100&height=100&seq=logo13&orientation=squarish"
    }
  ];

  const activityCategories = [
    {
      title: "Aventura & Parques",
      description: "Parques de aventura e atividades radicais",
      icon: "ri-rocket-line",
      color: "red",
      items: ["Parque Aventura", "Tirolesa", "Arvorismo", "Paintball"]
    },
    {
      title: "Bem-estar & Natureza",
      description: "Relaxamento e conexão com a natureza",
      icon: "ri-leaf-line",
      color: "green",
      items: ["Spa Natural", "Yoga ao Ar Livre", "Meditação", "Terapias Naturais"]
    },
    {
      title: "Cachoeiras & Banhos de Rio",
      description: "Refrescantes banhos em cachoeiras cristalinas",
      icon: "ri-water-flash-line",
      color: "blue",
      items: ["Cachoeira do Avencal", "Cachoeira Véu de Noiva", "Poços Naturais", "Banhos Termais"]
    },
    {
      title: "Cânions & Estradas Cênicas",
      description: "Paisagens deslumbrantes e rotas panorâmicas",
      icon: "ri-road-map-line",
      color: "orange",
      items: ["Cânion Fortaleza", "Serra do Rio do Rastro", "Estrada da Neve", "Mirantes Panorâmicos"]
    },
    {
      title: "Cavalgadas",
      description: "Passeios a cavalo pela serra catarinense",
      icon: "ri-riding-line",
      color: "indigo",
      items: ["Cavalgada Tradicional", "Passeio Romântico", "Trilha Histórica", "Cavalgada Aventura"]
    },
    {
      title: "Cultura & Cidade",
      description: "Patrimônio histórico e cultural da região",
      icon: "ri-building-2-line",
      color: "purple",
      items: ["Centro Histórico", "Museus", "Igreja Matriz", "Arquitetura Colonial"]
    },
    {
      title: "Enoturismo & Gastronomia",
      description: "Vinícolas e experiências gastronômicas únicas",
      icon: "ri-goblet-line",
      color: "red",
      items: ["Vinícola Altitude", "Degustação de Vinhos", "Harmonização", "Tour Gastronômico"]
    },
    {
      title: "Mirantes & Nascer/Pôr do Sol",
      description: "Os melhores pontos para contemplar a natureza",
      icon: "ri-sun-line",
      color: "orange",
      items: ["Morro da Igreja", "Pedra Furada", "Mirante do Vale", "Nascer do Sol"]
    },
    {
      title: "Observação & Fotografia",
      description: "Observação da fauna e fotografia da natureza",
      icon: "ri-camera-line",
      color: "teal",
      items: ["Observação de Aves", "Fotografia Noturna", "Safari Fotográfico", "Astronomia"]
    },
    {
      title: "Off-road 4x4 & Quadriciclo",
      description: "Aventuras sobre rodas em terrenos desafiadores",
      icon: "ri-car-line",
      color: "green",
      items: ["Trilha 4x4", "Quadriciclo Adventure", "Off-road Extremo", "Rally da Serra"]
    },
    {
      title: "Rapel, Canyoning & Escalada",
      description: "Esportes radicais para os mais aventureiros",
      icon: "ri-anchor-line",
      color: "red",
      items: ["Rapel Pedra Furada", "Canyoning", "Escalada em Rocha", "Via Ferrata"]
    },
    {
      title: "Trilhas & Trekking",
      description: "Caminhadas e trilhas pela serra catarinense",
      icon: "ri-footprint-line",
      color: "green",
      items: ["Trilha do Morro da Igreja", "Trekking Pedra Furada", "Caminhada Ecológica", "Trilha Histórica"]
    },
    {
      title: "Turismo Rural & Vivências",
      description: "Experiências autênticas na vida rural",
      icon: "ri-plant-line",
      color: "orange",
      items: ["Fazenda Experiência", "Ordenha de Vacas", "Colheita de Frutas", "Vida no Campo"]
    }
  ];
      ...
      <div className="relative z-10 max-w-md mx-auto">
        ...
        <div className="px-4 mb-6">
          <div className="text-center">
            <h2 className="text-white font-bold text-xl mb-2 flex items-center justify-center gap-2">
              <i className="ri-compass-3-line text-blue-400"></i>
              O que fazer
              <i className="ri-compass-3-line text-blue-400"></i>
            </h2>
            <p className="text-white/70 text-sm">Descubra experiências únicas e atividades imperdíveis na serra</p>
          </div>
        </div>
        ...
        <div className="px-4 mb-6">
          <div className="mb-4">
            ...
            <p className="text-white/70 text-xs text-center mt-1">Escolha sua próxima aventura na serra catarinense</p>
          </div>
            ...
            {activityCategories.map((category, index) => (
              <button
                ...
                onClick={() => {
                  ...
                  if (category.title === "Aventura & Parques") {
                    navigate('/o-que-fazer/aventura-parques');
                  } else if (category.title === "Bem-estar & Natureza") {
                    navigate('/o-que-fazer/bem-estar-natureza');
                  } else if (category.title === "Cachoeiras & Banhos de Rio") {
                    navigate('/o-que-fazer/cachoeiras-banhos-rio');
                  } else {
                    console.log(`Página em desenvolvimento: ${category.title}`);
                  }
                }}
