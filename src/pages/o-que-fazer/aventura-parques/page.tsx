...
export default function AventuraParques() {
  ...
  const featuredAds = [
    {
      title: "Tirolesa da Cascata do Avencal",
      subtitle: "Tirolesa que cruza o cânion e sobrevoa a Cascata do Avencal — experiência icônica na serra catarinense",
      image: "https://readdy.ai/api/search-image?query=Tirolesa%20da%20Cascata%20do%20Avencal%20zipline%20crossing%20canyon%20over%20waterfall%2C%20iconic%20experience%20serra%20catarinense%2C%20adventure%20park%2C%20extreme%20sports&width=300&height=200&seq=tirolesa_avencal&orientation=landscape",
      link: "#",
      isAd: true
    },
    {
      title: "Parque Mundo Novo",
      subtitle: "Parque com mirantes da cachoeira, arvorismo, tirolesa, cavalgada, pedalinho, arco e flecha, trilhas e camping",
      image: "https://readdy.ai/api/search-image?query=Parque%20Mundo%20Novo%20adventure%20park%20with%20waterfall%20viewpoints%2C%20tree%20climbing%2C%20zipline%2C%20horseback%20riding%2C%20pedal%20boat%2C%20archery%2C%20trails%20and%20camping&width=300&height=200&seq=mundo_novo&orientation=landscape",
      link: "#",
      isAd: true
    }
  ];
  ...
  const partners = [
    {
      name: "Natural Extremo",
      description: "Operadora especializada em tirolesa e atividades radicais",
      image: "https://readdy.ai/api/search-image?query=Natural%20Extremo%20logo%20adventure%20operator%20specialized%20in%20zipline%20and%20extreme%20activities%2C%20adventure%20tourism&width=100&height=100&seq=natural_extremo_logo&orientation=squarish"
    },
    {
      name: "Parque Mundo Novo",
      description: "Estrutura completa para atividades de aventura",
      image: "https://readdy.ai/api/search-image?query=Parque%20Mundo%20Novo%20logo%20complete%20structure%20for%20adventure%20activities%2C%20adventure%20park&width=100&height=100&seq=mundo_novo_logo&orientation=squarish"
    },
    {
      name: "Aventura Radical",
      description: "Equipamentos e guias para esportes radicais",
      image: "https://readdy.ai/api/search-image?query=Aventura%20Radical%20logo%20equipment%20and%20guides%20for%20extreme%20sports%2C%20adventure%20tourism&width=100&height=100&seq=aventura_radical_logo&orientation=squarish"
    }
  ];

  // Dados das atividades de aventura e parques
  const atrativos = [
    {
      id: 1,
      nome: "Tirolesa da Cascata do Avencal (Natural Extremo)",
      categoria: "Tirolesa",
      descricao: "Tirolesa que cruza o cânion e sobrevoa a Cascata do Avencal — experiência icônica na serra catarinense.",
      whatsapp: "",
      avaliacao: 4.9,
      imagem: "https://readdy.ai/api/search-image?query=Tirolesa%20da%20Cascata%20do%20Avencal%20zipline%20crossing%20canyon%20over%20waterfall%2C%20extreme%20adventure%2C%20adrenaline%20experience&width=200&height=200&seq=tirolesa_card&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Tirolesa%20da%20Cascata%20do%20Avencal%20%28Natural%20Extremo%29%20Urubici%20SC",
      tags: [
        { label: "Tirolesa", type: "amenity", color: "orange" },
        { label: "Adrenalina", type: "feature", color: "red" },
        { label: "Vista da cachoeira", type: "feature", color: "blue" },
        { label: "Cânion", type: "location", color: "green" }
      ]
    },
    {
      id: 2,
      nome: "Parque Mundo Novo – Cascata do Avencal (Atividades)",
      categoria: "Parque de aventura",
      descricao: "Parque com mirantes da cachoeira (~100 m), arvorismo, tirolesa, cavalgada, pedalinho, arco e flecha, trilhas e camping.",
      whatsapp: "",
      avaliacao: 4.8,
      imagem: "https://readdy.ai/api/search-image?query=Parque%20Mundo%20Novo%20adventure%20park%20with%20waterfall%20viewpoints%2C%20tree%20climbing%2C%20multiple%20activities%2C%20family%20friendly&width=200&height=200&seq=mundo_novo_card&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Parque%20Mundo%20Novo%20%E2%80%93%20Cascata%20do%20Avencal%20%28Atividades%29%20Urubici%20SC",
      tags: [
        { label: "Mirantes", type: "feature", color: "green" },
        { label: "Arvorismo", type: "amenity", color: "orange" },
        { label: "Tirolesa", type: "amenity", color: "orange" },
        { label: "Cavalgada", type: "amenity", color: "purple" },
        { label: "Camping", type: "amenity", color: "green" },
        { label: "Familiar", type: "feature", color: "blue" }
      ]
    },
    {
      id: 3,
      nome: "Parque Véu de Noiva – Passarelas e Mirantes",
      categoria: "Parque de visitação",
      descricao: "Estrutura com passarelas, mirantes e serviços para visita à cascata Véu de Noiva.",
      whatsapp: "",
      avaliacao: 4.6,
      imagem: "https://readdy.ai/api/search-image?query=Parque%20V%C3%A9u%20de%20Noiva%20walkways%20and%20viewpoints%20structure%2C%20waterfall%20visit%20services%2C%20accessible%20tourism&width=200&height=200&seq=veu_noiva_park_card&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Parque%20V%C3%A9u%20de%20Noiva%20%E2%80%93%20Passarelas%20e%20Mirantes%20Urubici%20SC",
      tags: [
        { label: "Passarelas", type: "feature", color: "green" },
        { label: "Mirantes", type: "feature", color: "green" },
        { label: "Serviços", type: "amenity", color: "blue" }
      ]
    }
  ];
      ...
      <div className="relative z-10 max-w-md mx-auto">
        ...
        <div className="px-4 mb-6">
          <div className="text-center">
            ...
            <p className="text-white/70 text-sm">Parques de aventura e atividades radicais</p>
          </div>
        </div>
        ...
        <div className="px-4 mb-8">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20 shadow-lg">
            ...
            <div className="flex flex-wrap gap-2 justify-center">
              <button
                onClick={() => {
                  const element = document.getElementById('aventura-parques');
        ...
        <div className="px-4 mb-6">
          ...
          >
            ...
            <p className="text-white/70 text-sm">
              {atrativos.length} {atrativos.length === 1 ? 'atividade disponível' : 'atividades disponíveis'}
            </p>
          </div>
        ...
        <div className="px-4 mb-6">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg text-center">
            <div className="mb-4">
              <i className="ri-compass-3-line text-blue-400 text-4xl mb-3"></i>
              <h3 className="text-white font-bold text-lg mb-2">Precisa de um Guia?</h3>
              <p className="text-white/80 text-sm leading-relaxed mb-4">
                Explore as atividades de aventura com segurança e equipamentos adequados!
              </p>
            </div>

            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <a
                href="https://wa.me/5551986859236?text=Olá! Gostaria de contratar um guia para atividades de aventura em Urubici"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <button
                onClick={() => navigate('/o-que-fazer')}
                className="inline-flex items-center gap-2 px-4 py-3 bg-blue-600 hover:bg-blue-700 rounded-lg text-white text-sm font-medium transition-all duration-200 hover:scale-105 whitespace-nowrap"
              >
                <i className="ri-arrow-left-line text-lg"></i>
                <span>Voltar a O que fazer</span>
              </button>
            </div>
          </div>
        </div>
        ...
        <div className="w-full mb-6">
          <div className="px-4 mb-4">
            ...
            <p className="text-white/70 text-xs text-center mt-1">
              Conheça nossos parceiros especializados em turismo de aventura
            </p>
          </div>
