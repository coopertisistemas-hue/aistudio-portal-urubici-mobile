...
export default function CachoeirasRio() {
  ...
  const featuredAds = [
    {
      title: "Cascata do Avencal – Base",
      subtitle: "Acesso à base da queda para fotos e contemplação; trilha curta",
      image: "https://readdy.ai/api/search-image?query=Cascata%20do%20Avencal%20base%20waterfall%20access%20for%20photos%20and%20contemplation%2C%20short%20trail%2C%20crystal%20clear%20water%2C%20mountain%20waterfall&width=300&height=200&seq=avencal_base&orientation=landscape",
      link: "#",
      isAd: true
    },
    {
      title: "Poços do Rio Canoas",
      subtitle: "Trechos do rio com poços para banho e contemplação; atenção a correnteza",
      image: "https://readdy.ai/api/search-image?query=Rio%20Canoas%20river%20pools%20for%20bathing%20and%20contemplation%2C%20natural%20swimming%20pools%2C%20mountain%20river%2C%20crystal%20clear%20water&width=300&height=200&seq=pocos_canoas&orientation=landscape",
      link: "#",
      isAd: true
    }
  ];
  ...
  const partners = [
    {
      name: "Ecoturismo Cachoeiras",
      description: "Guias especializados em trilhas para cachoeiras",
      image: "https://readdy.ai/api/search-image?query=Ecoturismo%20Cachoeiras%20logo%20specialized%20guides%20for%20waterfall%20trails%2C%20waterfall%20tourism&width=100&height=100&seq=eco_cachoeiras_logo&orientation=squarish"
    },
    {
      name: "Aventura Aquática",
      description: "Atividades aquáticas em rios e cachoeiras",
      image: "https://readdy.ai/api/search-image?query=Aventura%20Aqu%C3%A1tica%20logo%20water%20activities%20in%20rivers%20and%20waterfalls%2C%20aquatic%20adventure%20tourism&width=100&height=100&seq=aventura_aquatica_logo&orientation=squarish"
    },
    {
      name: "Natureza Pura",
      description: "Experiências autênticas em contato com a natureza",
      image: "https://readdy.ai/api/search-image?query=Natureza%20Pura%20logo%20authentic%20experiences%20in%20contact%20with%20nature%2C%20nature%20tourism&width=100&height=100&seq=natureza_pura_logo&orientation=squarish"
    }
  ];

  // Dados das cachoeiras e banhos de rio
  const atrativos = [
    {
      id: 1,
      nome: "Cascata do Avencal – Base (lado inferior)",
      categoria: "Cachoeira/Base",
      descricao: "Acesso à base da queda para fotos e contemplação; trilha curta.",
      whatsapp: "",
      avaliacao: 4.7,
      imagem: "https://readdy.ai/api/search-image?query=Cascata%20do%20Avencal%20base%20waterfall%20access%20photos%20contemplation%2C%20short%20trail%2C%20crystal%20water%2C%20mountain%20scenery&width=200&height=200&seq=avencal_base_card&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Cascata%20do%20Avencal%20%E2%80%93%20Base%20%28lado%20inferior%29%20Urubici%20SC",
      tags: [
        { label: "Cachoeira", type: "location", color: "blue" },
        { label: "Trilha curta", type: "feature", color: "green" },
        { label: "Fotografia", type: "feature", color: "purple" },
        { label: "Poços", type: "feature", color: "cyan" }
      ]
    },
    {
      id: 2,
      nome: "Cachoeira Papuã (região)",
      categoria: "Cachoeira",
      descricao: "Queda em propriedade particular com poço; acesso controlado.",
      whatsapp: "",
      avaliacao: 4.5,
      imagem: "https://readdy.ai/api/search-image?query=Cachoeira%20Papu%C3%A3%20waterfall%20private%20property%20with%20natural%20pool%2C%20controlled%20access%2C%20mountain%20waterfall&width=200&height=200&seq=papua_card&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Cachoeira%20Papu%C3%A3%20%28regi%C3%A3o%29%20Urubici%20SC",
      tags: [
        { label: "Cachoeira", type: "location", color: "blue" },
        { label: "Poço", type: "feature", color: "cyan" },
        { label: "Propriedade privada", type: "service", color: "amber" }
      ]
    },
    {
      id: 3,
      nome: "Poços do Rio Canoas (trechos)",
      categoria: "Poço/Rio",
      descricao: "Trechos do rio com poços para banho e contemplação; atenção a correnteza.",
      whatsapp: "",
      avaliacao: 4.6,
      imagem: "https://readdy.ai/api/search-image?query=Rio%20Canoas%20natural%20pools%20for%20bathing%20contemplation%2C%20river%20sections%2C%20crystal%20clear%20water%2C%20mountain%20river&width=200&height=200&seq=canoas_pocos_card&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Po%C3%A7os%20do%20Rio%20Canoas%20%28trechos%29%20Urubici%20SC",
      tags: [
        { label: "Poços", type: "feature", color: "cyan" },
        { label: "Rio", type: "location", color: "blue" },
        ...
        <div className="px-4 mb-6">
          <div className="text-center">
            <h2 className="text-white font-bold text-xl mb-2 flex items-center justify-center gap-2">
              <i className="ri-water-flash-line text-blue-400"></i>
              Cachoeiras & Banhos de Rio
              <i className="ri-water-flash-line text-blue-400"></i>
            </h2>
            <p className="text-white/70 text-sm">Refrescantes banhos em cachoeiras cristalinas</p>
          </div>
        </div>
        ...
        <div className="px-4 mb-8">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20 shadow-lg">
            ...
            <div className="flex flex-wrap gap-2 justify-center">
              <button
                onClick={() => {
                  const element = document.getElementById('cachoeiras-banhos-rio');
        ...
        <div className="px-4 mb-6">
          ...
          >
            ...
            <p className="text-white/70 text-sm">
              {atrativos.length} {atrativos.length === 1 ? 'local disponível' : 'locais disponíveis'}
            </p>
          </div>
        ...
        <div className="px-4 mb-6">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg text-center">
            <div className="mb-4">
              ...
              <p className="text-white/80 text-sm leading-relaxed mb-4">
                Explore as cachoeiras e rios com segurança e conhecimento local!
              </p>
            </div>

            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <a
                href="https://wa.me/5551986859236?text=Olá! Gostaria de contratar um guia para cachoeiras e banhos de rio em Urubici"
                target="_blank"
                rel="noopener noreferrer"
        ...
        <div className="w-full mb-6">
          <div className="px-4 mb-4">
            ...
            <p className="text-white/70 text-xs text-center mt-1">
              Conheça nossos parceiros especializados em turismo aquático
            </p>
          </div>
