...
export default function BemEstarNatureza() {
  ...
  const featuredAds = [
    {
      title: "Banho de Floresta (Forest Bathing)",
      subtitle: "Caminhada contemplativa guiada para reduzir estresse e reconectar-se à natureza",
      image: "https://readdy.ai/api/search-image?query=Forest%20bathing%20contemplative%20guided%20walk%20to%20reduce%20stress%20and%20reconnect%20with%20nature%2C%20mindfulness%20in%20forest%2C%20peaceful%20nature%20experience&width=300&height=200&seq=banho_floresta&orientation=landscape",
      link: "#",
      isAd: true
    },
    {
      title: "Yoga ao amanhecer",
      subtitle: "Sessões de yoga e respiração em mirantes e jardins; levar tapete",
      image: "https://readdy.ai/api/search-image?query=Sunrise%20yoga%20sessions%20and%20breathing%20in%20viewpoints%20and%20gardens%2C%20peaceful%20morning%20yoga%2C%20mountain%20sunrise%20meditation&width=300&height=200&seq=yoga_amanhecer&orientation=landscape",
      link: "#",
      isAd: true
    }
  ];
  ...
  const partners = [
    {
      name: "Bem-estar Serra",
      description: "Especialistas em atividades de bem-estar na natureza",
      image: "https://readdy.ai/api/search-image?query=Bem-estar%20Serra%20logo%20wellness%20specialists%20in%20nature%20activities%2C%20mountain%20wellness%20tourism&width=100&height=100&seq=bem_estar_logo&orientation=squarish"
    },
    {
      name: "Yoga Montanha",
      description: "Instrutores certificados para yoga ao ar livre",
      image: "https://readdy.ai/api/search-image?query=Yoga%20Montanha%20logo%20certified%20instructors%20for%20outdoor%20yoga%2C%20mountain%20yoga%20classes&width=100&height=100&seq=yoga_logo&orientation=squarish"
    },
    {
      name: "Natureza Zen",
      description: "Experiências de mindfulness e conexão com a natureza",
      image: "https://readdy.ai/api/search-image?query=Natureza%20Zen%20logo%20mindfulness%20experiences%20and%20nature%20connection%2C%20zen%20nature%20tourism&width=100&height=100&seq=zen_logo&orientation=squarish"
    }
  ];

  // Dados das atividades de bem-estar e natureza
  const atrativos = [
    {
      id: 1,
      nome: "Banho de Floresta (Forest Bathing)",
      categoria: "Banho de floresta",
      descricao: "Caminhada contemplativa guiada para reduzir estresse e reconectar-se à natureza.",
      whatsapp: "",
      avaliacao: 4.8,
      imagem: "https://readdy.ai/api/search-image?query=Forest%20bathing%20contemplative%20guided%20walk%2C%20stress%20reduction%2C%20nature%20reconnection%2C%20mindfulness%20forest%20experience&width=200&height=200&seq=banho_floresta_card&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Banho%20de%20Floresta%20%28Forest%20Bathing%29%20Urubici%20SC",
      tags: [
        { label: "Mindfulness", type: "feature", color: "green" },
        { label: "Natureza", type: "location", color: "green" },
        { label: "Caminhada leve", type: "feature", color: "blue" }
      ]
    },
    {
      id: 2,
      nome: "Yoga ao amanhecer (locais cênicos)",
      categoria: "Yoga ao ar livre",
      descricao: "Sessões de yoga e respiração em mirantes e jardins; levar tapete.",
      whatsapp: "",
      avaliacao: 4.7,
      imagem: "https://readdy.ai/api/search-image?query=Sunrise%20yoga%20sessions%20breathing%20in%20scenic%20viewpoints%20gardens%2C%20outdoor%20yoga%2C%20mountain%20sunrise%20meditation&width=200&height=200&seq=yoga_amanhecer_card&orientation=squarish",
      maps: "https://www.google.com/maps/search/?api=1&query=Yoga%20ao%20amanhecer%20%28locais%20c%C3%AAnicos%29%20Urubici%20SC",
      tags: [
        { label: "Yoga", type: "amenity", color: "purple" },
        { label: "Nascer do sol", type: "feature", color: "orange" },
        { label: "Bem-estar", type: "feature", color: "green" },
        { label: "Mirante", type: "location", color: "blue" }
      ]
    }
  ];
        ...
        <div className="px-4 mb-6">
          <div className="text-center">
            <h2 className="text-white font-bold text-xl mb-2 flex items-center justify-center gap-2">
              <i className="ri-leaf-line text-blue-400"></i>
              Bem-estar & Natureza
              <i className="ri-leaf-line text-blue-400"></i>
            </h2>
            <p className="text-white/70 text-sm">Relaxamento e conexão com a natureza</p>
          </div>
        </div>
        ...
        <div className="px-4 mb-8">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20 shadow-lg">
            ...
            <div className="flex flex-wrap gap-2 justify-center">
              <button
                onClick={() => {
                  const element = document.getElementById('bem-estar-natureza');
        ...
        <div className="px-4 mb-6">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg text-center">
            <div className="mb-4">
              ...
              <h3 className="text-white font-bold text-lg mb-2">Precisa de um Instrutor?</h3>
              <p className="text-white/80 text-sm leading-relaxed mb-4">
                Experimente atividades de bem-estar com instrutores qualificados!
              </p>
            </div>

            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <a
                href="https://wa.me/5551986859236?text=Olá! Gostaria de contratar um instrutor para atividades de bem-estar em Urubici"
                target="_blank"
                rel="noopener noreferrer"
        ...
        <div className="w-full mb-6">
          <div className="px-4 mb-4">
            ...
            <p className="text-white/70 text-xs text-center mt-1">
              Conheça nossos parceiros especializados em bem-estar e natureza
            </p>
          </div>
