...
export default function AtendimentoOnline() {
  ...
  const featuredAds = [
    {
      title: "Telemedicina Urubici",
      subtitle: "Consultas Online Seguras",
      image: "https://readdy.ai/api/search-image?query=Modern%20telemedicine%20online%20consultation%20setup%20in%20Urubici%20Santa%20Catarina%20Brazil%2C%20digital%20healthcare%20technology%2C%20virtual%20medical%20appointment&width=300&height=200&seq=tele1&orientation=landscape",
      link: "#",
      isAd: true
    },
    {
      title: "Psicoterapia Online",
      subtitle: "Atendimento Psicológico Virtual",
      image: "https://readdy.ai/api/search-image?query=Professional%20online%20psychotherapy%20session%20setup%2C%20virtual%20mental%20health%20consultation%2C%20digital%20therapy%20environment%20in%20Urubici%20Santa%20Catarina%20Brazil&width=300&height=200&seq=psico_online1&orientation=landscape",
      link: "#",
      isAd: true
    }
  ];
  ...
  const onlineProfessionals = [
    {
      ...
      description: "Especialista em terapia cognitivo-comportamental e atendimento online. Experiência em ansiedade, depressão e relacionamentos.",
      whatsapp: "5549999123456",
      tags: [
        { text: "Atendimento Online", color: "indigo", icon: "ri-video-line" },
        { text: "TCC", color: "purple", icon: "ri-brain-line" },
        { text: "Ansiedade", color: "blue", icon: "ri-heart-pulse-line" },
        { text: "Disponível", color: "green", icon: "ri-check-line" }
      ],
      image: "https://readdy.ai/api/search-image?query=Professional%20female%20psychologist%20therapist%20online%20consultation%2C%20virtual%20therapy%20session%2C%20mental%20health%20professional%20in%20modern%20office%20setup&width=200&height=200&seq=psico_online2&orientation=squarish"
    },
    {
      name: "Dr. Roberto Silva",
      specialty: "Psiquiatra",
      description: "Psiquiatra com foco em teleconsulta e acompanhamento de transtornos mentais. Prescrição de medicamentos via telemedicina.",
      whatsapp: "5549999234567",
      tags: [
        { text: "Teleconsulta", color: "indigo", icon: "ri-video-line" },
        { text: "Prescrição Online", color: "green", icon: "ri-prescription-line" },
        { text: "Transtornos Mentais", color: "purple", icon: "ri-brain-line" },
        { text: "Disponível", color: "green", icon: "ri-check-line" }
      ],
      image: "https://readdy.ai/api/search-image?query=Professional%20male%20psychiatrist%20doctor%20online%20consultation%2C%20telemedicine%20specialist%2C%20virtual%20medical%20appointment%20setup%20with%20modern%20technology&width=200&height=200&seq=psiquiatra_online1&orientation=squarish"
    },
    {
      name: "Dra. Mariana Costa",
      specialty: "Nutricionista",
      description: "Nutricionista especializada em consultas online e planejamento alimentar personalizado. Acompanhamento nutricional virtual.",
      whatsapp: "5549999345678",
      tags: [
        { text: "Consulta Online", color: "indigo", icon: "ri-video-line" },
        { text: "Plano Alimentar", color: "orange", icon: "ri-restaurant-line" },
        { text: "Acompanhamento", color: "blue", icon: "ri-calendar-check-line" },
        { text: "Disponível", color: "green", icon: "ri-check-line" }
      ],
      image: "https://readdy.ai/api/search-image?query=Professional%20female%20nutritionist%20online%20consultation%2C%20virtual%20nutrition%20appointment%2C%20healthy%20lifestyle%20specialist%20in%20modern%20office&width=200&height=200&seq=nutri_online1&orientation=squarish"
    },
    {
      name: "Dr. Carlos Oliveira",
      specialty: "Clínico Geral",
      description: "Médico clínico geral com experiência em telemedicina. Consultas de rotina, orientações médicas e acompanhamento de pacientes.",
      whatsapp: "5549999456789",
      tags: [
        { text: "Telemedicina", color: "indigo", icon: "ri-video-line" },
        { text: "Consulta Geral", color: "blue", icon: "ri-stethoscope-line" },
        { text: "Orientação Médica", color: "cyan", icon: "ri-question-answer-line" },
        { text: "Disponível", color: "green", icon: "ri-check-line" }
      ],
      image: "https://readdy.ai/api/search-image?query=Professional%20male%20general%20practitioner%20doctor%20online%20consultation%2C%20telemedicine%20specialist%2C%20virtual%20medical%20appointment%20with%20stethoscope&width=200&height=200&seq=clinico_online1&orientation=squarish"
    },
    {
      name: "Dra. Fernanda Lima",
      specialty: "Dermatologista",
      description: "Dermatologista especializada em teleconsulta dermatológica. Avaliação de lesões de pele e orientações via videoconferência.",
      whatsapp: "5549999567890",
      tags: [
        { text: "Teleconsulta", color: "indigo", icon: "ri-video-line" },
        { text: "Dermatologia", color: "pink", icon: "ri-heart-pulse-line" },
        { text: "Avaliação Online", color: "cyan", icon: "ri-search-eye-line" },
        { text: "Disponível", color: "green", icon: "ri-check-line" }
      ],
      image: "https://readdy.ai/api/search-image?query=Professional%20female%20dermatologist%20online%20consultation%2C%20virtual%20skin%20examination%2C%20telemedicine%20specialist%20in%20modern%20medical%20office&width=200&height=200&seq=dermato_online1&orientation=squarish"
    },
    {
      name: "Dr. Paulo Santos",
      specialty: "Cardiologista",
      description: "Cardiologista com experiência em teleconsulta cardiológica. Acompanhamento de pacientes cardíacos e orientações preventivas.",
      whatsapp: "5549999678901",
      tags: [
        { text: "Teleconsulta", color: "indigo", icon: "ri-video-line" },
        { text: "Cardiologia", color: "red", icon: "ri-heart-line" },
        { text: "Prevenção", color: "blue", icon: "ri-shield-check-line" },
        { text: "Disponível", color: "green", icon: "ri-check-line" }
      ],
      image: "https://readdy.ai/api/search-image?query=Professional%20male%20cardiologist%20doctor%20online%20consultation%2C%20virtual%20cardiology%20appointment%2C%20telemedicine%20specialist%20with%20heart%20monitor&width=200&height=200&seq=cardio_online1&orientation=squarish"
    }
  ];
      ...
      <div className="relative z-10 max-w-md mx-auto">
        ...
        <div className="px-4 mb-6">
          <div className="text-center">
            <h2 className="text-white font-bold text-xl mb-2 flex items-center justify-center gap-2">
              <i className="ri-video-line text-indigo-400"></i>
              Atendimento Online
              <i className="ri-video-line text-indigo-400"></i>
            </h2>
            <p className="text-white/70 text-sm">Psicoterapia online e teleatendimento</p>
          </div>
        </div>
        ...
        <div className="px-4 mb-8">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20 shadow-lg">
            ...
            <div className="flex flex-wrap gap-2 justify-center">
              <button className="bg-indigo-500/90 hover:bg-indigo-400 hover:scale-105 active:scale-95 text-white font-medium px-4 py-2.5 rounded-full shadow-sm transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-indigo-300/50 min-h-[44px] text-sm whitespace-nowrap">
                Teleconsulta
              </button>
        ...
        <div className="px-4 mb-6">
          <div className="mb-4">
            ...
            <p className="text-white/70 text-xs text-center mt-1">Atendimento especializado via teleconsulta</p>
          </div>

          <div className="space-y-4">
            {onlineProfessionals.map((professional, index) => (
                ...
                <div className="flex gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex gap-2">
                      <a
                        href={`https://wa.me/${professional.whatsapp}?text=Olá! Gostaria de agendar uma consulta online com ${professional.name} - ${professional.specialty}`}
                        target="_blank"
                        rel="noopener noreferrer"
        ...
        <div className="px-4 mb-6">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg text-center">
            <div className="mb-4">
              ...
              <p className="text-white/80 text-sm leading-relaxed mb-4">
                Você é profissional da saúde e oferece atendimento online? Cadastre-se em nossa plataforma!
              </p>
            </div>

            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <a
                href="https://wa.me/5551986859236?text=Olá! Gostaria de cadastrar meu serviço de atendimento online no Portal Urubici"
                target="_blank"
                rel="noopener noreferrer"
