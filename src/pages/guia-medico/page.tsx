...
export default function GuiaMedico() {
  ...
  const medicalCategories = [
    {
      title: "Emergências & Serviços Públicos",
      description: "Atendimento 24h, SAMU, Bombeiros",
      icon: "ri-alarm-warning-line",
      color: "red",
      items: ["Hospital Municipal", "SAMU 192", "Bombeiros 193", "Polícia Militar 190", "Pronto Socorro"]
    },
    {
      title: "Especialidades & Diagnósticos",
      description: "Médicos, clínicas, exames, laboratórios e terapia",
    ...
    },
    {
      ...
      color: "blue",
      items: ["Farmácia Central", "Drogaria Popular", "Farmácia São José", "Drogaria Urubici"]
    },
    {
      title: "Planos de Saúde & Convênios",
      description: "Convênios médicos e planos de saúde",
      icon: "ri-shield-cross-line",
      color: "purple",
      items: ["Unimed", "Bradesco Saúde", "SulAmérica", "Amil", "Golden Cross"]
    },
    {
      title: "Bem-Estar & Estética",
      description: "Cuidados estéticos e bem-estar",
      icon: "ri-heart-pulse-line",
      color: "pink",
      items: ["Clínica de Estética", "Spa Wellness", "Massoterapia", "Acupuntura"]
    },
    {
      title: "Academias & Fitness",
      description: "Exercícios, fitness e atividades físicas",
      icon: "ri-run-line",
      color: "orange",
      items: ["Academia Forma", "Studio Pilates", "CrossFit Serra", "Personal Trainer"]
    }
  ];
  ...
  const navigateToCategory = (categoryTitle: string) => {
    const slug = categoryTitle.toLowerCase()
      .replace(/[^a-z0-9\\s]/g, '')
      .replace(/\\s+/g, '-');
    
    // Navegação específica para cada categoria
    if (categoryTitle === "Emergências & Serviços Públicos") {
      navigate('/guia-medico/emergencias-servicos-publicos');
    } else if (categoryTitle === "Especialidades & Diagnósticos") {
      navigate('/guia-medico/especialidades-diagnosticos');
    } else if (categoryTitle === "Farmácias & Drogarias") {
      navigate('/guia-medico/farmacias-drogarias');
    } else if (categoryTitle === "Planos de Saúde & Convênios") {
      navigate('/guia-medico/planos-saude-convenios');
    } else if (categoryTitle === "Bem-Estar & Estética") {
      navigate('/guia-medico/bem-estar-estetica');
    } else if (categoryTitle === "Academias & Fitness") {
      navigate('/guia-medico/academias-fitness');
    } else {
      navigate(`/guia-medico/${slug}`);
    }
  };

  const navigateToEmergencias = () => {
    navigate('/guia-medico/emergencias-servicos-publicos');
  };

  const getColorClasses = (color: string) => {
    const colorMap = {
      red: 'bg-red-500/50 text-red-200 border-red-400/40',
      ...
      <div className="relative z-10 max-w-md mx-auto">
        ...
        <div className="px-4 mb-6">
          <div className="text-center">
            ...
            <p className="text-white/70 text-sm">O guia da saúde de Urubici em um só lugar</p>
          </div>
        </div>
        ...
        <div className="px-4 mb-6">
          <div className="mb-4">
            ...
            <p className="text-white/70 text-xs text-center mt-1">Explore todos os serviços de saúde disponíveis</p>
          </div>
