...
export default function FisioterapiaReabilitacao() {
  ...
  const featuredAds = [
    {
      title: "Clínica de Fisioterapia Urubici",
      subtitle: "Reabilitação & Tratamentos",
      image: "https://readdy.ai/api/search-image?query=Modern%20physiotherapy%20clinic%20exterior%20building%20in%20Urubici%20Santa%20Catarina%20Brazil%2C%20rehabilitation%20facility%2C%20physical%20therapy%20center%20with%20mountain%20background&width=300&height=200&seq=fisio1&orientation=landscape",
      link: "#",
      isAd: true
    },
    {
      title: "Centro de Reabilitação",
      subtitle: "Fisioterapia Especializada",
      image: "https://readdy.ai/api/search-image?query=Professional%20rehabilitation%20center%20in%20Urubici%20Santa%20Catarina%20Brazil%2C%20physical%20therapy%20facility%2C%20physiotherapy%20clinic%20building&width=300&height=200&seq=rehab1&orientation=landscape",
      link: "#",
      isAd: true
    }
  ];
  ...
  const fisioterapiaData = {
    "FISIOTERAPIA NEUROLÓGICA": [
      {
        name: "Dr. Roberto Silva",
        specialty: "Fisioterapia Neurológica",
        crefito: "CREFITO-10 23456-F", 
        description: "Especialista em fisioterapia neurológica com foco em reabilitação de pacientes com AVC, lesões medulares e doenças neurodegenerativas. Métodos inovadores de recuperação.",
        phone: "5549327856789",
        image: "https://readdy.ai/api/search-image?query=Professional%20male%20physiotherapist%20orthopedic%20specialist%2C%20sports%20rehabilitation%20expert%2C%20physical%20therapy%20professional%20in%20Urubici%20Santa%20Catarina%20Brazil&width=200&height=200&seq=fisio_roberto&orientation=squarish",
        tags: ["Fisioterapia Neurológica", "Reabilitação AVC", "Métodos Inovadores", "Recuperação Funcional"]
      }
    ],
    "FISIOTERAPIA ORTOPÉDICA": [
      {
        ...
        crefito: "CREFITO-10 12345-F",
        description: "Fisioterapeuta especializada em reabilitação ortopédica e traumato-ortopédica. Atendimento personalizado com técnicas modernas para recuperação de lesões musculoesqueléticas.",
        phone: "5549327845123",
        image: "https://readdy.ai/api/search-image?query=Professional%20female%20physiotherapist%20in%20clinic%2C%20physical%20therapy%20specialist%20portrait%2C%20rehabilitation%20professional%20in%20Urubici%20Santa%20Catarina%20Brazil&width=200&height=200&seq=fisio_carla&orientation=squarish",
        tags: ["Fisioterapia Ortopédica", "Reabilitação", "Lesões Esportivas", "Técnicas Modernas"]
      }
    ],
    "FISIOTERAPIA RESPIRATÓRIA": [
      {
        ...
        crefito: "CREFITO-10 34567-F",
        description: "Fisioterapeuta respiratória especializada em reabilitação pulmonar e cuidados intensivos. Atendimento domiciliar e hospitalar para pacientes com problemas respiratórios.",
        phone: "5549327867890", 
        image: "https://readdy.ai/api/search-image?query=Professional%20female%20neurological%20physiotherapist%2C%20neuro%20rehabilitation%20specialist%2C%20physical%20therapy%20expert%20in%20Urubici%20Santa%20Catarina%20Brazil&width=200&height=200&seq=fisio_ana&orientation=squarish",
        tags: ["Fisioterapia Respiratória", "Reabilitação Pulmonar", "Atendimento Domiciliar", "Cuidados Intensivos"]
      }
    ],
    "OSTEOPATIA": [
      {
        ...
        crefito: "CREFITO-10 67890-F",
        description: "Fisioterapeuta osteopata com formação internacional. Especializado em terapia manual e tratamento de disfunções musculoesqueléticas através de técnicas osteopáticas.",
        phone: "5549327890123",
        image: "https://readdy.ai/api/search-image?query=Professional%20male%20respiratory%20physiotherapist%2C%20pulmonary%20rehabilitation%20specialist%2C%20physical%20therapy%20expert%20in%20Urubici%20Santa%20Catarina%20Brazil&width=200&height=200&seq=fisio_pedro&orientation=squarish",
        tags: ["Osteopatia", "Terapia Manual", "Formação Internacional", "Técnicas Osteopáticas"]
      }
    ],
    "PILATES CLÍNICO": [
      {
        ...
        crefito: "CREFITO-10 45678-F",
        description: "Fisioterapeuta especializado em Pilates clínico e reeducação postural. Tratamentos personalizados para correção postural e fortalecimento do core.",
        phone: "5549327878901",
        image: "https://readdy.ai/api/search-image?query=Professional%20male%20pilates%20clinical%20instructor%20physiotherapist%2C%20postular%20rehabilitation%20specialist%20in%20Urubici%20Santa%20Catarina%20Brazil&width=200&height=200&seq=fisio_lucas&orientation=squarish",
        tags: ["Pilates Clínico", "Reeducação Postural", "Fortalecimento Core", "Correção Postural"]
      }
    ],
    "RPG": [
      {
        ...
        specialty: "RPG",
        crefito: "CREFITO-10 56789-F",
        description: "Especialista em RPG (Reeducação Postural Global) e fisioterapia pélvica. Tratamento de disfunções posturais e do assoalho pélvico com abordagem holística.",
        phone: "5549327889012",
        image: "https://readdy.ai/api/search-image?query=Professional%20female%20RPG%20physiotherapist%20postural%20reeducation%20specialist%2C%20physical%20therapy%20expert%20in%20Urubici%20Santa%20Catarina%20Brazil&width=200&height=200&seq=fisio_fernanda&orientation=squarish",
        tags: ["RPG", "Fisioterapia Pélvica", "Abordagem Holística", "Disfunções Posturais"]
      }
    ]
  };

  const specialtyHeaders = Object.keys(fisioterapiaData).sort();
  ...
  const getTagColorClasses = (tag: string) => {
    const tagColorMap: { [key: string]: string } = {
      // Fisioterapia Ortopédica - Azul
      'Fisioterapia Ortopédica': 'bg-blue-500/20 text-blue-200 border-blue-400/30',
      'Reabilitação': 'bg-blue-500/20 text-blue-200 border-blue-400/30',
      'Lesões Esportivas': 'bg-blue-500/20 text-blue-200 border-blue-400/30',
      'Técnicas Modernas': 'bg-blue-500/20 text-blue-200 border-blue-400/30',
      
      // Fisioterapia Neurológica - Roxo
      'Fisioterapia Neurológica': 'bg-purple-500/20 text-purple-200 border-purple-400/30',
      'Reabilitação AVC': 'bg-purple-500/20 text-purple-200 border-purple-400/30',
      'Métodos Inovadores': 'bg-purple-500/20 text-purple-200 border-purple-400/30',
      'Recuperação Funcional': 'bg-purple-500/20 text-purple-200 border-purple-400/30',
      
      // Fisioterapia Respiratória - Verde
      'Fisioterapia Respiratória': 'bg-green-500/20 text-green-200 border-green-400/30',
      'Reabilitação Pulmonar': 'bg-green-500/20 text-green-200 border-green-400/30',
      'Atendimento Domiciliar': 'bg-green-500/20 text-green-200 border-green-400/30',
      'Cuidados Intensivos': 'bg-green-500/20 text-green-200 border-green-400/30',
      
      // Pilates Clínico - Laranja
      'Pilates Clínico': 'bg-orange-500/20 text-orange-200 border-orange-400/30',
      'Reeducação Postural': 'bg-orange-500/20 text-orange-200 border-orange-400/30',
      'Fortalecimento Core': 'bg-orange-500/20 text-orange-200 border-orange-400/30',
      'Correção Postural': 'bg-orange-500/20 text-orange-200 border-orange-400/30',
      
      // RPG e Fisioterapia Pélvica - Rosa
      'RPG': 'bg-pink-500/20 text-pink-200 border-pink-400/30',
      'Fisioterapia Pélvica': 'bg-pink-500/20 text-pink-200 border-pink-400/30',
      'Abordagem Holística': 'bg-pink-500/20 text-pink-200 border-pink-400/30',
      'Disfunções Posturais': 'bg-pink-500/20 text-pink-200 border-pink-400/30',
      
      // Osteopatia - Ciano
      'Osteopatia': 'bg-cyan-500/20 text-cyan-200 border-cyan-400/30',
      'Terapia Manual': 'bg-cyan-500/20 text-cyan-200 border-cyan-400/30',
      'Formação Internacional': 'bg-cyan-500/20 text-cyan-200 border-cyan-400/30',
      'Técnicas Osteopáticas': 'bg-cyan-500/20 text-cyan-200 border-cyan-400/30'
    };
  ...
  const getTagIcon = (tag: string) => {
    const iconMap: { [key: string]: string } = {
      'Fisioterapia Ortopédica': 'ri-bone-line',
      'Fisioterapia Neurológica': 'ri-brain-line', 
      'Fisioterapia Respiratória': 'ri-lungs-line',
      'Fisioterapia Pélvica': 'ri-heart-line',
      'Pilates Clínico': 'ri-run-line',
      'RPG': 'ri-body-scan-line',
      'Osteopatia': 'ri-hand-heart-line',
      'Reabilitação': 'ri-refresh-line',
      'Lesões Esportivas': 'ri-football-line',
      'Técnicas Modernas': 'ri-star-line',
      'Reabilitação AVC': 'ri-heart-pulse-line',
      'Métodos Inovadores': 'ri-lightbulb-line',
      'Recuperação Funcional': 'ri-arrow-up-line',
      'Reabilitação Pulmonar': 'ri-lungs-line',
      'Atendimento Domiciliar': 'ri-home-heart-line',
      'Cuidados Intensivos': 'ri-shield-cross-line',
      'Reeducação Postural': 'ri-user-line',
      'Fortalecimento Core': 'ri-fitness-line',
      'Correção Postural': 'ri-straighten-line',
      'Abordagem Holística': 'ri-leaf-line',
      'Disfunções Posturais': 'ri-user-settings-line',
      'Terapia Manual': 'ri-hand-heart-line',
      'Formação Internacional': 'ri-global-line',
      'Técnicas Osteopáticas': 'ri-hand-heart-fill'
    };
    
    return iconMap[tag] || 'ri-heart-line';
  };
      ...
      <div className="relative z-10 max-w-md mx-auto">
        ...
        <div className="px-4 mb-6">
          <div className="text-center">
            ...
            <p className="text-white/70 text-sm">Fisioterapeutas, pilates e reabilitação motora</p>
          </div>
        </div>
        ...
        <div className="px-4 mb-8">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20 shadow-lg">
            ...
            <div className="flex flex-wrap gap-2 justify-center">
              {specialtyHeaders.map((specialty, index) => (
                <button
                  key={index}
        ...
        <div className="px-4 mb-6">
          {specialtyHeaders.map((specialty) => {
            const specialtyProfessionals = fisioterapiaData[specialty];
            ...
            return (
              <div key={specialty} id={specialty.toLowerCase().replace(/\s+/g, '-')} className="mb-8">
                <div className="mb-4">
                  ...
                  <div className="h-1 bg-gradient-to-r from-orange-500 to-transparent rounded-full"></div>
                </div>
                        ...
                        <div className="flex-1">
                          <div className="flex items-start justify-between mb-2">
                            <div>
                              ...
                              <p className="text-orange-200 text-xs font-medium">{professional.crefito}</p>
                            </div>
                            <div className="bg-orange-500/20 text-orange-200 border border-orange-400/30 px-2 py-1 rounded-full text-xs font-medium">
                          ...
                          <div className="flex gap-2">
                            <a
                              href={`https://wa.me/${professional.phone}?text=Olá! Gostaria de agendar uma sessão com ${professional.name} - ${professional.specialty}`}
                              target="_blank"
                              rel="noopener noreferrer"
                              className="inline-flex items-center gap-1 px-3 py-2 bg-green-600 hover:bg-green-7
00 rounded-lg text-white text-xs font-medium transition-all duration-200 hover:scale-105 whitespace-nowrap"
                            >
        ...
        <div className="px-4 mb-6">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg text-center">
            <div className="mb-4">
              ...
              <p className="text-white/80 text-sm leading-relaxed mb-4">
                Você é fisioterapeuta ou possui clínica de reabilitação? Cadastre-se em nossa plataforma!
              </p>
            </div>

            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <a
                href="https://wa.me/5551986859236?text=Olá! Gostaria de cadastrar meu serviço de fisioterapia no Portal Urubici"
                target="_blank"
                rel="noopener noreferrer"
